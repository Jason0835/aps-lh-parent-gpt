...
import com.zlt.aps.dp.api.domain.entity.DpStockVersion;
import com.zlt.aps.dp.common.utils.BatchInsertProcessor;
...
public class DpStockVersionServiceImpl extends AbstractDocService<DpStockVersion>  implements IDpStockVersionService {
    ...
    @Override
    public void insertBatchData(DpDemandPlan createCondition, String dpVersion, Map<String, List<MdmProductStock>> finishedProductStockMap) {
        ...
        finishedProductStocks.forEach(finishedProductStock -> {
            DpStockVersion requireStock = this.buildRequireStock(createCondition,dpVersion,finishedProductStock);
    ...
    private DpStockVersion buildRequireStock(DpDemandPlan createCondition, String dpVersion, MdmProductStock finishedProductStock) {
        ...
        requireStock.setRequireVersion(dpVersion);
