...
@TableName("T_TC_AUTO_SCHEDULE_TASK")
@ApiModel(value = "胎侧自动排程异步任务对象", description = "胎侧自动排程异步任务对象")
public class TcAutoScheduleTask extends BaseEntity implements Serializable {
    ...
    @ApiModelProperty(value = "输入幂等键", name = "idempotencyKey")
    private String idempotencyKey;

    /** 自动滚动目标班次。 */
    @TableField("TARGET_SHIFT_ORDER")
    @ApiModelProperty(value = "自动滚动目标班次", name = "targetShiftOrder")
    private Integer targetShiftOrder;

    /** 输入版本或稳定指纹。 */
    @TableField("INPUT_VERSION")
    @ApiModelProperty(value = "输入版本或稳定指纹", name = "inputVersion")
    private String inputVersion;

    /** MES发布数据版本。 */
    @TableField("MES_DATA_VERSION")
    @ApiModelProperty(value = "MES发布数据版本", name = "mesDataVersion")
    ...
    /** 本次排程命中参数快照 JSON */
    @TableField("PARAM_SNAPSHOT_JSON")
    @ApiModelProperty(value = "参数快照JSON", name = "paramSnapshotJson")
    private String paramSnapshotJson;

    /** 本次排程质量指标摘要 JSON */
    @TableField("SUMMARY_JSON")
    @ApiModelProperty(value = "质量指标摘要JSON", name = "summaryJson")
    private String summaryJson;

    /** 失败错误摘要 */
    @TableField("ERROR_SUMMARY")
    @ApiModelProperty(value = "失败错误摘要", name = "errorSummary")
