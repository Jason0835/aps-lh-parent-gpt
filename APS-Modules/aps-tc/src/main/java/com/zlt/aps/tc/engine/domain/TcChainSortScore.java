 ...
 */
public class TcChainSortScore implements Comparable<TcChainSortScore> {

    /** 无连续性命中的默认排序分 */
    public static final TcChainSortScore ZERO = new TcChainSortScore(0, 0, 0, BigDecimal.ZERO,
     ...
     */
    public TcChainSortScore(int mainGlueMatched, int baseGlueMatched, int mouthPlateMatched,
     ...
     */
    @Override
    public int compareTo(TcChainSortScore other) {
        if (other == null) {
            return 1;
        }
