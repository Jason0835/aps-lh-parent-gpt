 ...
 * @date 2021-06-28
 */
public interface TcQuotaSettingMapper {
    /**
     * 查询胎侧定额设定
     *
     * @param id 胎侧定额设定ID
     ...
     * 校验唯一性
     */
    public List<TcQuotaSetting> checkTcQuotaSettingUnique(TcQuotaSetting tcQuotaSetting);


    /**
     * 合并操作，存在则更新，否则新增
     */
    public void mergeSql(List<TcQuotaSetting> list);
}
