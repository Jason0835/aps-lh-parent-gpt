 ...
 */
@Data
public class TcMachineCandidate {
    ...
    /** 当前工厂候选机台存在定点允许配置的胎侧集合，用于判断未配置胎侧是否不限制机台 */
    private Set<String> configuredFixedAllowSidewallCodes;

    /** 指定生产的胎侧集合 */
    private Set<String> fixedAllowSidewallCodes;

    /** 禁排生产的胎侧集合 */
    private Set<String> fixedForbidSidewallCodes;

    /** 是否为胎侧与垫胶共用机台 */
    private Boolean tcDjSharedMachine;

    /** 共用机台允许生产胎侧的班次编码集合 */
    private Set<String> allowedTcShiftCodes;

    /** 共用机台对应的垫胶班次编码集合，仅用于解释证据 */
    private Set<String> sharedDjShiftCodes;
