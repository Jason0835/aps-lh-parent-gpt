...
public class TcExportLogManagementController extends BaseController {
    @Autowired
    private TcExportLogManagementService eportLogManagementService;
    ...
    public TableDataInfo list(@RequestBody TcExportLogManagementDto dto) {
        ...
        List<TcExportLogManagementDto> list = eportLogManagementService.selectExportLogManagementList(dto);
    ...
    public TcExportLogManagementDto getExportLogManagement(@PathVariable("id") Long id) {
        TcExportLogManagementDto dto = new TcExportLogManagementDto();
