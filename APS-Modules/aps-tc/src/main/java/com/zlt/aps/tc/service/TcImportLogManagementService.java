 ...
 * @date 2021-06-07
 */
public interface TcImportLogManagementService extends IService<TcImportLogManagement>
{
    /**
     * 查询工序导入日志管理列表
     * 
     ...
     */
     List<TcImportLogManagementDto> selectImportLogManagementList(TcImportLogManagementDto dto);
}
