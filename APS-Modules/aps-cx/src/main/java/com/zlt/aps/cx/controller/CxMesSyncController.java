...
public class CxMesSyncController implements ICxMesSyncRemoteService {
    ...
    public AjaxResult logicDeleteAndSaveMachineOnlineInfo(@RequestParam("factoryCode") String factoryCode, @RequestParam("onlineDate") String onlineDateStr, @RequestParam("updateBy") String updateBy, @RequestBody List<CxMachineOnlineInfo> list) {
    ...
    public AjaxResult logicDeleteAndSaveCxStockByDataSource(@RequestParam("factoryCode") String factoryCode,
        ...
        Date stockDate = DateUtil.parse(stockDateStr);
