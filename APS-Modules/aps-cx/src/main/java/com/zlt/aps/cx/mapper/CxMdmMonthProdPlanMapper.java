 ...
 * @date 2021-09-15
 */
public interface CxMdmMonthProdPlanMapper
{
    /**
     * 查询主计划月度生产计划
     * 
     ...
     * 下发主计划列表
     */
    public List<MdmMonthProdPlan> issuePlan(MdmMonthProdPlan mdmMonthProdPlan);
     ...
     * 查询月计划柱状图数据
     */
    public List<MdmMonthProdPlan> dailyChart(MdmMonthProdPlan mdmMonthProdPlan);
