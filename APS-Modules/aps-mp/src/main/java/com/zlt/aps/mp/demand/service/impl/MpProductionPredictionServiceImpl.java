...
public class MpProductionPredictionServiceImpl extends AbstractDocService<MpProductionPrediction>  implements IMpProductionPredictionService {
    ...
    public void createMonthPrediction(MpProductionPrediction createCondition){
        ...
        redisService.setCacheObject(keyForPrediction, ApsConstant.TRUE, ApsConstant.EXPIRE_ONE, TimeUnit.HOURS);
        ...
        asyncService.executeAsyncTaskForPredictionProduction(finalVersion,monthRange,requestAttributes, SecurityUtils.getUsername());
    }
