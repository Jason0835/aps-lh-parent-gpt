...
import com.zlt.aps.mp.api.domain.vo.AreaConvertVo;
import com.zlt.aps.mp.common.utils.CycleStockUpService;
import com.zlt.aps.mp.common.utils.PrecedentStockUpService;
import com.zlt.aps.mp.demand.mapper.SupplyOrderPoolEntityMapper;
import com.zlt.aps.mp.demand.service.ISupplyOrderPoolService;
import com.zlt.aps.mp.enums.SupplyOrderTypeEnum;
...
public class SupplyOrderPoolController extends AbstractDocBizController<SupplyOrderPool> {
    ...
    public AjaxResult save(@RequestBody SupplyOrderPool billVO){
        ...
        if(SupplyOrderTypeEnum.CYCLE_PRODUCTION_STOCK.getCode().equals(billVO.getOrderType())){
            this.cycleStockUpService.validateEnableCreate(billVO);
        }else{
            this.precedentStockUpService.validateEnableCreate(billVO);
        }
