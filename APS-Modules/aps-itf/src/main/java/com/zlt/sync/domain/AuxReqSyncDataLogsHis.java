...
@Getter
@Setter
@ApiModel(value = "同步请求状态日志历史")
public class AuxReqSyncDataLogsHis extends SyncBaseEntity {
	private static final long serialVersionUID = 922873686226084978L;
    ...
    private Integer companyCode; //分公司编号
