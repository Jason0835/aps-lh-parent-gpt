...
public interface NcScheduleResultService extends IBillService<NcScheduleResult> {
     ...
     * @param newSchedule
     */
    void insertDispatcherLog(String operType, NcScheduleResult newSchedule);
     ...
     */
    void insertDispatcherLogInsertOrder(String operType, List<NcScheduleResult> scheduleResults,
    ...
    int checkNcCodeExist(NcScheduleResult djScheduleResult);
     ...
     * @param scheduleDate 排程日期
     */
    void fillPrevDayClass3Plan(List<NcScheduleResult> list, Date scheduleDate);
     ...
     * @param list 排程结果列表
     */
    void fillMachineName(List<NcScheduleResult> list);
}
