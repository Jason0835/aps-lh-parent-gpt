 ...
 * @date 2026-07-08
 */
public interface GsqSteelRingStockMapper extends BaseMapper<GsqSteelRingStock> {
     ...
     */
    int checkUnique(GsqSteelRingStock entity);
     ...
     * @param list 待保存数据集合
     */
    void mergeSql(List<GsqSteelRingStock> list);
}
