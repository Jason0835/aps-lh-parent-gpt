 ...
 * @since 2021-06-04
 */
public interface GsqSpecifyMachineService extends IService<GsqSpecifyMachine> {
     ...
     * @param entity
     */
    void saveSpecifyMachine(GsqSpecifyMachine entity);
     ...
     * @return 导入后提示信息
     */
    AjaxResult importData(List<GsqSpecifyMachineDto> list, boolean updateSupport, Long importLogId);
