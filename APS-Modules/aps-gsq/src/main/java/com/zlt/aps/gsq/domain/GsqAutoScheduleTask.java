package com.zlt.aps.gsq.domain;
 ...
 * 钢丝圈自动滚动异步任务对象
 *
 * <p>用于记录一次自动滚动后台任务的状态、进度、最终响应和异常明细，
...
@TableName("T_GSQ_AUTO_SCHEDULE_TASK")
@ApiModel(value = "钢丝圈自动滚动异步任务对象", description = "钢丝圈自动滚动异步任务对象")
public class GsqAutoScheduleTask extends BaseEntity implements Serializable {
