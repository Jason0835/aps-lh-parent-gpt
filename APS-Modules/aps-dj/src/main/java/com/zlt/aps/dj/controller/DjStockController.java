...
@Api(tags = "垫胶库存信息维护接口")
public class DjStockController extends AbstractDocBizController<DjStock> {
    @Autowired
    ...
    @Override
    public byte[] exportData(@RequestBody DjStock queryVO, @PathVariable("fileName") String fileName,
