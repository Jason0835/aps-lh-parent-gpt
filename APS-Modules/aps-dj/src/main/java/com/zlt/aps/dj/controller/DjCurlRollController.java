...
public class DjCurlRollController extends AbstractDocBizController<DjCurlRoll> {
    @Autowired
    private DjCurlRollService curlRollService;
    ...
    public TableDataInfo list(@RequestBody DjCurlRoll queryVO) {
     ...
     * 删除信息
     */
    @Log(title = "ui.dj.curlRoll.column.modalName", businessType = BusinessType.DELETE)
     ...
     * 导出列表
     */
    @Log(title = "ui.dj.curlRoll.column.modalName", businessType = BusinessType.EXPORT)
    @ApiOperation("导出数据")
    @PostMapping("/exportData/{fileName}")
    @Override
    public byte[] exportData(@RequestBody DjCurlRoll queryVO, @PathVariable("fileName") String fileName,
