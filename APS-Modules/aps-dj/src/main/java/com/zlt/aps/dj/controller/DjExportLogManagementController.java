 ...
 */
@RestController
@RequestMapping("/dj/exportLogManagement")
@Api(tags = {"工序导出日志管理维护接口"})
public class DjExportLogManagementController extends BaseController {
    @Autowired
    private DjExportLogManagementService eportLogManagementService;
    ...
    public TableDataInfo list(@RequestBody DjExportLogManagementDto dto) {
        ...
        List<DjExportLogManagementDto> list = eportLogManagementService.selectExportLogManagementList(dto);
    ...
    public DjExportLogManagementDto getExportLogManagement(@PathVariable("id") Long id) {
        DjExportLogManagementDto dto = new DjExportLogManagementDto();
