...
public class Cd90ScheduleResultLogController extends AbstractDocBizController<Cd90ScheduleResultLog> {
    ...
    @Resource
    private ICd90ScheduleResultLogService service;
    @Resource
    private Cd90ScheduleResultLogMapper mapper;

    @ApiOperation("查询列表")
    @PostMapping("/list")
    @Override
    public TableDataInfo list(@RequestBody Cd90ScheduleResultLog query) {
    ...
    @Override
    public Cd90ScheduleResultLog getInfo(@PathVariable("id") Long id) {
    ...
    @Override
    public byte[] exportData(@RequestBody Cd90ScheduleResultLog query, @PathVariable("fileName") String fileName, HttpServletResponse r) throws IOException {
        return super.exportData(query, fileName, r);
    }

    @Override
    protected List<Cd90ScheduleResultLog> listExportData(Cd90ScheduleResultLog obj) {
        QueryWrapper<Cd90ScheduleResultLog> w = new QueryWrapper<>();
        builderCondition(w, obj);
        List<Cd90ScheduleResultLog> list = mapper.selectList(w);
    ...
    @Override
    protected void builderCondition(QueryWrapper<Cd90ScheduleResultLog> qw, Cd90ScheduleResultLog vo) {
    ...
    protected String getTypeCode() {
        return "CD90_SCHEDULE_RESULT_LOG";
    }
