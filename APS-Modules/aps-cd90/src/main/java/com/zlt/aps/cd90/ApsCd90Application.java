...
public class ApsCd90Application {
    ...
    public static void main(String[] args) throws Exception {
        ConfigurableApplicationContext application = SpringApplication.run(ApsCd90Application.class, args);
        String ip = InetAddress.getLocalHost().getHostAddress();
        Environment env = application.getEnvironment();
        String port = env.getProperty("server.port");

        log.info("\n----------------------------------------------------------\n\t" +
                "Application APS-CD90 is running!\n\t" +
                "APS-CD90接口文档 URLs:\n\t" +
                "APS-CD90接口文档1: \thttp://" + ip + ":" + port + "/swagger-ui/index.html\n\t" +
                "APS-CD90接口文档1: \thttp://" + ip + ":" + port + "/doc.html\n" +
                "----------------------------------------------------------\n\t"
        );
    }
}
