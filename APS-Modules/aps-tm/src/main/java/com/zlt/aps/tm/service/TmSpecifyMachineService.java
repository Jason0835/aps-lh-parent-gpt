 ...
 * @since 2021-06-04
 */
public interface TmSpecifyMachineService extends IService<TmSpecifyMachine> {
     ...
     * @param entity
     */
    void saveSpecifyMachine(TmSpecifyMachine entity);
     ...
     * @return 导入后提示信息
     */
    AjaxResult importData(List<TmSpecifyMachineDto> list, boolean updateSupport, Long importLogId);
