...
@TableName("T_GDYY_SPECIFY_MACHINE")
@ApiModel(value = "GdyySpecifyMachine对象", description = "定点机台表")
//@KeySequence(value = "SEQ_PUBLIC",dbType = DbType.ORACLE)
public class GdyySpecifyMachine extends ApsBaseEntity implements Serializable {
