...
public class TbrProductionLogUtils {
     ...
     */
    public static void addProductionLog(TbrProductionContext productionContext, ProductionPlanLogDto productionPlanInfo, TbrMouldProductionLogType logType, String detailContent) {
