...
public class FormalProductionHandler {
     ...
     * @param type             续作类型
     */
    private static void productionContinueByType(Context context, Map<String, ProductionPlanGroupInfo> allGroupPlanInfo, String groupName, CxContinueInfoHelper cxContinueInfo, ContinueTypeEnum type) {
        TbrProductionContext productionContext = (TbrProductionContext) context;
