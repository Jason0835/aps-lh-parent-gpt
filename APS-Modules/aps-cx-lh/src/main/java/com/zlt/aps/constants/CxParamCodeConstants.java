...
public class CxParamCodeConstants {
     ...
     * 默认大规格模数设定参数code
     */
    public static final String DEFAULT_LH_MAX_SPEC_QTY = "DEFAULT_LH_MAX_SPEC_QTY";

    /**
     * 班制参数code
     */
    public static final String DEFAULT_SHIFT_SYSTEM = "DEFAULT_SHIFT_SYSTEM";

    /**
     * 每日排程的小时段参数code 【1-24】只能设置整数
     */
    public static final String DEFAULT_SHIFT_HOURS = "DEFAULT_SHIFT_HOURS";

    /**
     * 硫化可等待时间
     */
    public static final String DEFAULT_SULFURIZATION_WAIT_TIME="DEFAULT_SULFURIZATION_WAIT_TIME";

    /**
     * 同一个班次最大换工装次数参数code
     */
    public static final String DEFAULT_MAX_CHANGE_SPEC_SHIFTS="DEFAULT_MAX_CHANGE_SPEC_SHIFTS";

    /**
     * 培训档系数参数code
     */
    public static final String TRAINING_COEFFICIENT="TRAINING_COEFFICIENT";
     ...
     * 跳过培训的成型机编号参数code
     */
    public static final String SKIP_TRAINING_MACHINE_NO="SKIP_TRAINING_MACHINE_NO";

    /**
     * 前后规格允许的断面宽差额参数code
     */
    public static final String SECTION_WIDTH_DIFF="SECTION_WIDTH_DIFF";
     ...
     * 胎胚冷却时间
     */
    public static final String EMBRYO_COOL_TIME = "EMBRYO_COOL_TIME";

    /**
     * 特殊允许手贴的轻卡规格
     */
    public static final String SPECIAL_ALLOW_HAND="SPECIAL_ALLOW_HAND";
     ...
     * 计算成型机允许的扁平比差额
     */
    public static final String FLAT_RATE_DIFF="FLAT_RATE_DIFF";
     ...
     * 限制任务未排时是否抢占机台Code
     */
    public static final String IS_PREEMPT_MACHINE="IS_PREEMPT_MACHINE";
     ...
     * 是否开启平衡算法
     */
    public static final String IS_OPEN_BALANCE_ALGORITHM="IS_OPEN_BALANCE_ALGORITHM";

    /**
     * 是否开启机台拉满算法
     */
    public static final String IS_OPEN_MACHINE_FULL_ALGORITHM="IS_OPEN_MACHINE_FULL_ALGORITHM";

    /**
     * 是否预排明日任务
     */
    public static final String IS_PLAN_TOMORROW="IS_PLAN_TOMORROW";

    /**
     * 胎胚备库上限
     */
    public static final String EMBRYO_STOCK_MAX="EMBRYO_STOCK_MAX";

    /**
     * 胎胚备库下限
     */
    public static final String EMBRYO_STOCK_MIN="EMBRYO_STOCK_MIN";

    /**
     * 胎胚备库比例
     */
    public static final String EMBRYO_STOCK_RATIO="EMBRYO_STOCK_RATIO";
     ...
     * 允许期初库存是负数
     */
    public static final String IS_ALLOW_NEGATIVE_STOCK="IS_ALLOW_NEGATIVE_STOCK";
}
