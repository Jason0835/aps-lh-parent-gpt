...
{
    @Autowired
    private TqImportLogManagementService importLogManagementService;
    @Autowired
    private TqImportErrorLogManagementService importErrorLogManagementService;
    ...
    public TableDataInfo list(@RequestBody TqImportLogManagementDto dto)
    {
        ...
        List<TqImportLogManagementDto> list = importLogManagementService.selectImportLogManagementList(dto);
    ...
    public TableDataInfo errorView(@RequestBody TqImportErrorLogManagementDto dto) {
        startPage();
        List<TqImportErrorLogManagementDto> list = importErrorLogManagementService.selectImportErrorLogManagementList(dto);
        return getDataTable(list);
    }
    ...
    public TqImportLogManagementDto getImportLogManagement(@PathVariable("id") Long id) {
        TqImportLogManagementDto dto = new TqImportLogManagementDto();
