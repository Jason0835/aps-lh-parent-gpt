...
import com.zlt.aps.mdm.api.domain.vo.MdmModelInfoExportVo;
...
//        mdmModelInfoService.setProSize(list);
    ...
    protected void builderCondition(QueryWrapper<MdmModelInfo> queryWrapper, MdmModelInfo queryVO) {
        ...
        queryWrapper.like(PubUtil.isNotEmpty(queryVO.getFieldValueByFieldName("shellStandard")), "SHELL_STANDARD", queryVO.getFieldValueByFieldName("shellStandard"));
