...
import com.zlt.aps.mdm.mapper.MdmStructureLhRatioEntityMapper;
import com.zlt.aps.mdm.service.IMdmStructureLhRatioService;
...
* 文件名称：MdmStructureLhRatioController.java
* 描    述：成型结构硫化配比 控制层类：....
*@author zlt
*@date 2025-12-08
*@version 1.0
...
@Api(tags = "成型结构硫化配比")
@RestController
@RequestMapping("/mdmStructureLhRatio")
public class MdmStructureLhRatioController extends AbstractDocBizController<MdmStructureLhRatio> {

    @Autowired
    private IMdmStructureLhRatioService mdmStructureLhRatioService;

    @Autowired
    private MdmStructureLhRatioEntityMapper entityMapper;
    ...
    @PostMapping("/list")
    @Override
    public TableDataInfo list(@RequestBody MdmStructureLhRatio queryVO) {
    ...
    @PostMapping("/save")
    @Override
    public AjaxResult save(@RequestBody MdmStructureLhRatio billVO){
    ...
    @Override
    public MdmStructureLhRatio getInfo(@PathVariable("billId") Long billId) {
    ...
    @Override
    public byte[] exportData(@RequestBody MdmStructureLhRatio queryVO, @PathVariable("fileName") String fileName,
                             HttpServletResponse response) throws IOException {
        return super.exportData(queryVO, fileName, response);
    }

    @Override
    protected List<MdmStructureLhRatio> listExportData(MdmStructureLhRatio obj) {
        QueryWrapper<MdmStructureLhRatio> wrapper = new QueryWrapper<>();
    ...
    protected IDocService getDocService(){
        return mdmStructureLhRatioService;
    }
