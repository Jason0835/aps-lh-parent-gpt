...
import com.zlt.aps.mdm.mapper.MdmBomInfoEntityMapper;
...
public class MdmBomInfoController extends AbstractDocBizController<MdmBomInfo> {
    ...
    protected void builderCondition(QueryWrapper<MdmBomInfo> queryWrapper, MdmBomInfo queryVO) {
        ...
        queryWrapper.like(PubUtil.isNotEmpty(queryVO.getFieldValueByFieldName("childCode")), "CHILD_CODE", queryVO.getFieldValueByFieldName("childCode"));
        ...
        queryWrapper.like(PubUtil.isNotEmpty(queryVO.getFieldValueByFieldName("parentCode")), "PARENT_CODE", queryVO.getFieldValueByFieldName("parentCode"));
        ...
        queryWrapper.like(PubUtil.isNotEmpty(queryVO.getFieldValueByFieldName("bomVersion")), "BOM_VERSION", queryVO.getFieldValueByFieldName("bomVersion"));
