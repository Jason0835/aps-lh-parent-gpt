 ...
 * 班次配置业务接口。
 */
public interface ICd15ShiftConfigService extends IDocService<Cd15ShiftConfig> {
     ...
     */
    String checkUnique(Cd15ShiftConfig shiftConfig);
     ...
     * @return 导入结果
     */
    AjaxResult importData(List<Cd15ShiftConfig> list, boolean updateSupport, Long importLogId);
}