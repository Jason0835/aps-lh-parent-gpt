...
import com.zlt.aps.mps.domain.CxEngineAutoScheduleRecord;
 ...
 * @date 2021-07-14
 */
public interface CxEngineAutoScheduleRecordMapper 
{
    /**
     * 查询成型自动排程记录
     * 
    ...
    CxEngineAutoScheduleRecord selectOneByCxBatch(@Param("cxBatchNo") String cxBatchNo);
    /**
     * 新增成型自动排程记录
     * 
     * @param cxEngineAutoScheduleRecord 成型自动排程记录
     ...
     * @return
     */
    public CxEngineAutoScheduleRecord selectAutoScheduleRecordByScheduleDate(@Param("scheduleDate") String scheduleDate);
}
