 ...
 * @author Gim
 */
@FeignClient(contextId = "IRequestMesService", value = "aps-mps")
public interface IRequestMesService {
     ...
     * @return
     */
    @PostMapping(value = prefix + "/kettleSync/{syncKey}")
    AjaxResult kettleSync(@PathVariable("syncKey") String syncKey);
