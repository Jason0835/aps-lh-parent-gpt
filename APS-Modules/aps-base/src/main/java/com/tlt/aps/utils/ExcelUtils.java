...
import com.tlt.aps.baseVo.ExcelCellRangeAddress;
import com.tlt.aps.baseVo.ExcelImg;
import com.tlt.aps.baseVo.ExcelStyleVo;
import com.tlt.aps.baseVo.excelVo.BorderStyleVo;
...
//                    }
            ...
            if(context.containsKey(CELL_STYLE)){
                List<com.tlt.aps.baseVo.excelVo.CellStyle> cellStyleList = (List<com.tlt.aps.baseVo.excelVo.CellStyle>) context.get(CELL_STYLE);
                for (com.tlt.aps.baseVo.excelVo.CellStyle cs : cellStyleList) {
