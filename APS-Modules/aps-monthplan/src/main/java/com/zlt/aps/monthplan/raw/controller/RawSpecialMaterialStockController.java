...
* 文件名称：RawSpecialMaterialStockController.java
* 描    述：特殊材料库存 控制层类：....
*@author zlt
*@date 2025-12-08
*@version 1.0
...
@Api(tags = "特殊材料库存")
@RestController
@RequestMapping("/rawSpecialMaterialStock")
public class RawSpecialMaterialStockController extends AbstractDocBizController<RawSpecialMaterialStock> {

    @Autowired
    private IRawSpecialMaterialStockService rawSpecialMaterialStockService;

    @Autowired
    private RawSpecialMaterialStockEntityMapper entityMapper;
    ...
    @PostMapping("/list")
    @Override
    public TableDataInfo list(@RequestBody RawSpecialMaterialStock queryVO) {
    ...
    @PostMapping("/save")
    @Override
    public AjaxResult save(@RequestBody RawSpecialMaterialStock billVO){
    ...
    @Override
    public RawSpecialMaterialStock getInfo(@PathVariable("billId") Long billId) {
    ...
    @Override
    public byte[] exportData(@RequestBody RawSpecialMaterialStock queryVO, @PathVariable("fileName") String fileName,
                             HttpServletResponse response) throws IOException {
        return super.exportData(queryVO, fileName, response);
    }

    @Override
    protected List<RawSpecialMaterialStock> listExportData(RawSpecialMaterialStock obj) {
        QueryWrapper<RawSpecialMaterialStock> wrapper = new QueryWrapper<>();
    ...
    protected IDocService getDocService(){
        return rawSpecialMaterialStockService;
    }
