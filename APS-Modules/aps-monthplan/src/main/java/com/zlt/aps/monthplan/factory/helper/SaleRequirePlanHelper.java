...
public class SaleRequirePlanHelper {
     ...
     * 计算各库位的备货量
     *
     * @param isAddShort                是否包含超欠产
     * @param groupKey                  分厂+物料编码
     * @param domesticStockUpType       内销备货类型：Y 表示走内销自己的备货方式
     * @param locationType              库位类型
     * @param needProductQtyMap         净需求量
     * @param locationStockUpQtyMap     库位备货量
     * @param locationExceedShortQtyMap 库位欠产量
     * @param leftOverQty               分厂+物料剩余的总库存
     * @return
     */
     ...
     * 根据分厂+物料编码的键值，获取总备货量
     *
     * @param locationStockUpQtyMap 备货计划集合
     * @param groupKey              分厂 + 物料编码 键值
     * @return
     */
     ...
     * @param require          分厂规格基础信息
     * @param locationTypeEnum 库位类型
     * @param shortQty         超欠产量
     * @return
     */
     ...
     * @param monthPlanVersion 销售生产需求计划版本
     * @param require          分厂规格基础信息
     * @param locationTypeEnum 库位信息
     * @param stockUpQty       备货量
     * @return
     */
     ...
     * @param monthPlanVersion 销售生产需求计划版本
     * @param require          分厂规格基础信息
     * @param differenceQty    上调到最小批量需要增加的差值量
     * @return
     */
     ...
     * 并加入到销售生产需求计划中
     *
     * @param saleOrderRequireList 销售订单的销售生产需求计划-合并前
     * @param requireList          合并后加入的销售生产需求集合集合，最终
     */
     ...
     * 构建需求计划版本库存信息对象
     *
     * @param productStockInfo SAP库存信息
     * @return
     */
