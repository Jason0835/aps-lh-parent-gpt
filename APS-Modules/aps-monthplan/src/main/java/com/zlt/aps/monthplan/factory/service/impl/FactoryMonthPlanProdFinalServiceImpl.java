...
import com.zlt.aps.monthplan.factory.helper.MonthPlanSpecificationHelper;
...
public class FactoryMonthPlanProdFinalServiceImpl implements IFactoryMonthPlanProdFinalService {
   ...
   *     错误日志集合对象
   * @param buildErrorInfo
   *     错误信息集合
   * @param duplicateGroupMap
   *     重复数据集合
   * @param duplicateKeyFunction
   *     重复键集合
   * @param productConstructionMap
   *     SAP与施工关系配置
   * @return
   */
   ...
   * @param index
   *     流水号
   * @param importFinalPlan
   *     计划
   * @param informalConstructionStageList
   *     构建SAP与施工关系的数据集合
   * @return
   */
