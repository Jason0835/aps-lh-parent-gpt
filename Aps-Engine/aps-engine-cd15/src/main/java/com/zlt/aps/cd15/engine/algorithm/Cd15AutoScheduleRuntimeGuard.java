...
/** 检查斜裁自动排程运行时间是否超过参数阈值。 */
@Slf4j
@Component
public class Cd15AutoScheduleRuntimeGuard {
     ...
     * @param stage 当前检查阶段
     */
    public void checkNotTimedOut(Cd15AutoScheduleContext context, String stage) {
        ...
        if (!now.isBefore(deadline)) {
            ...
            log.error("[斜裁自动排程] 任务主动超时中止, factoryCode={}, scheduleDate={}, "
