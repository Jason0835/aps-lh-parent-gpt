 ...
 * 小车卷取能力与直裁排程量换算器。
 *
 * <p>小车沿单片胎体长度方向卷取，排程量沿直裁宽度方向累计。</p>
 */
@Component
public class Cd90VehiclePlanQuantityCalculator {
     ...
     * @param craftWidthMillimeter 单片直裁宽度，单位毫米/片
    ...
    public BigDecimal calculate(BigDecimal unitLengthMillimeter,
        ...
        this.requirePositive(craftWidthMillimeter, "单片直裁宽度");
