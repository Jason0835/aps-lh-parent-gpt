 ...
 */
@Component
public class Cd90BigRollMeterCalculator {

    /**
     * 计算大卷消耗米数。
     *
     * @param curlLength 卷曲总长度，即N个单片直裁长度的累计值
     * @param craftWidth 当前层位单片直裁宽度
     * @param cordWidth 大卷幅宽，同时作为单片直裁长度
     * @return 大卷消耗米数
     */
    public BigDecimal calculate(BigDecimal curlLength,
        ...
        requirePositive(craftWidth, "直裁宽度");
