...
/** 窗口结束未排结果内存汇总测试。 */
public class Cd90UnscheduledResultAggregatorTest {

    private final Cd90UnscheduledResultAggregator aggregator =
    ...
    public void shouldKeepReasonOrderDeduplicateAndAppendWindowLimit() {
        List<Cd90UnscheduledResultModel> result = aggregator.aggregate(Arrays.asList(
    ...
    public void shouldMapConstructionMissingToStableDataReason() {
        List<Cd90UnscheduledResultModel> result = aggregator.aggregate(Collections.singletonList(
    ...
    private Cd90ScheduleAttemptTrace trace(String classField, String clothCode,
