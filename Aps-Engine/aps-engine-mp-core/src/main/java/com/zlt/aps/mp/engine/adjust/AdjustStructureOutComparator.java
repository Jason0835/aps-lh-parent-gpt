 ...
 */
public class AdjustStructureOutComparator implements Comparator<MpAdjustStructureOut> {

    @Override
    public int compare(MpAdjustStructureOut o1, MpAdjustStructureOut o2) {
     ...
     * 3 - 其他
     */
    private int getDemandGroup(MpAdjustStructureOut obj) {
     ...
     * 有 HEIGHT_QTY 的排序规则
     */
    private int compareHeightQtyGroup(MpAdjustStructureOut o1, MpAdjustStructureOut o2) {
     ...
     */
    private int compareCurrentNetQtyGroup(MpAdjustStructureOut o1, MpAdjustStructureOut o2) {
        // 2.2.1 物料优先优先
        boolean scm1 = isScmPriority(o1);
        boolean scm2 = isScmPriority(o2);
        if (scm1 != scm2) {
    ...
    private boolean isScmPriority(MpAdjustStructureOut obj) {
