...
import com.zlt.aps.mp.engine.scheduling.cxcapacity.AdjustContinueSkuProductionQtyHandler;
import com.zlt.aps.mp.engine.scheduling.cxcapacity.ProductionCxMachineCalculationHandler;
import com.zlt.aps.mp.engine.scheduling.cxcapacity.SimulateProductionHandler;
...
public class TbrStructureNameCapacityProductionService extends AbstractDataLoaderService {
    ...
    private void setProductionCycleInfo(Context context) {
        ...
        context.setStartDay(DateUtils.getDaysByMonth(productionStartDate));
     ...
     *
     * @param context         排产上下文
     * @param previousVersion 前一个月定稿版本
     * @param lastDay         最后一天
     * @return
     */
