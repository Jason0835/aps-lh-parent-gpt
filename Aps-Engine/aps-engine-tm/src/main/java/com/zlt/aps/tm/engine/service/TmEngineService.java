...
public interface TmEngineService {

    /**
     * 胎面胶自动排程
     * @param scheduleDate 排程日期，格式：yyyy-MM-dd
     */
    void autoTmSchedule(String scheduleDate);

    /**
     * 胎面插单
     * @param scheduleVo
     */
    int inertTmOrder(TmScheduleResultVo scheduleVo);
     ...
     */
    int batchSaveTmSchedule(String scheduleDate, List<TmScheduleResultVo> scheduleList);
...
//     */
//    void changeTmMachine(String oldMachineIds, TmScheduleResult scheduleResult);

    /**
     * 确认自动排程机台
     * @param scheduleResult  排程信息
     */
    void confirmTmMachine(TmScheduleResult scheduleResult);
