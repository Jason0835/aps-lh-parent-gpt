...
public class TmTaskChainScheduleService {
    ...
    private void recalculateChainTimes(TmScheduleContext context, ScheduleTaskLinkedList<TmTaskDraft> chain,
        ...
        for (ScheduleTaskNode<TmTaskDraft> node : chain.toList()) {
            ...
            log.info("[TM_TASK_SWITCH] batchNo={}, traceId={}, machineCode={}, shiftOrder={}, taskId={}, previousGlueCode={}, currentGlueCode={}, specSwitchHours={}, glueSwitchHours={}, glueSwitchCapacityDeduct={}, switchCapacityDeduct={}",
                    context.getBatchNo(), context.getTraceId(), machineCode, shiftOrder, node.getTaskId(),
     ...
     * @return 主胶料切换固定产能扣减量
     */
    private BigDecimal resolveGlueSwitchCapacityDeduct(TmScheduleContext context, TmTaskDraft previousTask,
                                                       TmTaskPredecessor externalPredecessor,
                                                       TmTaskDraft currentTask) {
        String previousGlueCode = previousTask == null
                ? (externalPredecessor == null ? null : externalPredecessor.getGlueCode())
                : previousTask.getGlueCode();
        ...
        TmParamValue paramValue = context.getParamMap().get(TmScheduleConstants.PARAM_GLUE_CHANGE_CAPACITY_DEDUCT);
