...
public class DjEngineStockServiceImpl implements DjEngineStockService {
    ...
    public Map<String, Double> getPlanStockMap(String batchNo, String scheduleDate, Double stockLossRate) {
        ...
        List<DjStockVo> list = ncEngineStockMapper.listNcStock(scheduleDate);  //询指定日期的垫胶库存量
...
//            consum = (consum < 0 ? 0 : consum);
    ...
    private Map<String, Double> getNcConsume(String batchNo, String scheduleDate) {
        ...
        List<DjStockConsumeVo> list = ncEngineStockMapper.listCxPlanAndConsume(scheduleDate);  //查询垫胶胶对应的成型三班计划消耗量，以及8-12点实际消耗量
        ...
        List<DjStockConsumeVo> consumeVos = ncEngineStockMapper.listLastDayMidPlan(scheduleDate);
