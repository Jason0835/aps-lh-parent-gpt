...
public class DjEngineMonthSurplusServiceImpl implements DjEngineMonthSurplusService {
    ...
    @Resource
    private DjEngineMonthSurplusMapper NcEngineMonthSurplusMapper;
    ...
    public Map<String, DjMonthSurplusVo> getMonthSurplus(String scheduleDate) {
        ...
        List<DjMonthSurplusVo> list = NcEngineMonthSurplusMapper.listNcMonthPlanSurplus(dateArray[0], dateArray[1]);
