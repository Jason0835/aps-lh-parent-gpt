...
public interface Cd90EngineMapper {
	...
	int insertTempTable(@Param("scheduleResultList") List<Cd90ScheduleResultVo> scheduleResultList);
	 ...
	 * @param scheduleResultList
	 */
	int updateCd90ScheduleResultPlanQty(@Param("scheduleDate") String scheduleDate, @Param("scheduleResultList") List<Cd90ScheduleResultVo> scheduleResultList);
    ...
    void batchUpdateBatchNoAndOrderNo(@Param("list") List<Cd90ScheduleResultVo> scheduleResultVoList);
}
