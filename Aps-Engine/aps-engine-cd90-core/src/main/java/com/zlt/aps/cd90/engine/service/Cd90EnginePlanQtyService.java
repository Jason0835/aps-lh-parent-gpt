 ...
 * @Version 1.0
 */
public interface Cd90EnginePlanQtyService {
	/**
	 * 计算计划量
	 * 
	 * @Author hakimryan
	 ...
	 * @return
	 */
	BigDecimal caculateSuppliyTime(Cd90ScheduleResultVo resultVo, Cd90StockVo stockVo);
	 ...
	 * @param stockQty 库存量
	 */
	void handleSecondaryProduct(Cd90ScheduleResultVo resultVo, BigDecimal stockQty);
	 ...
	 */
	Map<String, Cd90StockVo> getStockMap(Date scheduleDate, BigDecimal stockLossRate, boolean isProductionStage);
}
