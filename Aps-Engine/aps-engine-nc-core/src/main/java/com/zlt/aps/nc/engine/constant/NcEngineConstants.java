...
public class NcEngineConstants {
    ...
    // 编码规则：SYS + 工序号(10) + 分组号(01) + 3位流水号
    /** SYS1001001 卷曲标准长度 */
    public static final String PARAM_STANDARD_CRIMP_LENGTH = "SYS1001001";
    /** SYS1001002 工装（台车）总数 */
    public static final String PARAM_TOOL_TOTAL_NUM = "SYS1001002";
    /** SYS1001003 整车率 */
    public static final String PARAM_TROLLEY_FULL_RATE = "SYS1001003";
    /** SYS1001005 安全水位线 */
    public static final String PARAM_SAFETY_STOCK_LEVEL = "SYS1001005";
    /** SYS1001006 停产天数阈值 */
    public static final String PARAM_SHUTDOWN_DAYS_THRESHOLD = "SYS1001006";
    /** SYS1001007 全局默认损耗率 */
    public static final String PARAM_LOSS_RATE = "SYS1001007";
    /** SYS1001008 切换口型时长 */
    public static final String PARAM_MOUTH_PLATE_SWITCH_TIME = "SYS1001008";
    /** SYS1001009 切换胶料时长 */
    public static final String PARAM_GLUE_SWITCH_TIME = "SYS1001009";
    /** SYS1001010 排产触发阈值（个班次），当前库存可覆盖的成型班次数 ≤ 此值时触发排产 */
    public static final String PARAM_SCHEDULE_THRESHOLD = "SYS1001010";

    /** SYS1001011 成型原因分析收尾关键字 */
    public static final String PARAM_CX_ANALYSIS_CLOSEOUT_KEYWORD = "SYS1001011";

    /** SYS1001012 新规格判定天数阈值（天），连续N天未排产则视为新规格 */
    public static final String PARAM_NEW_SPEC_DAYS_THRESHOLD = "SYS1001012";

    /** SYS1001013 单规格每班最大排产量（米），默认3000 */
    public static final String PARAM_MAX_SHIFT_PRODUCE_QTY = "SYS1001013";

    /** SYS1001014 每班平均（免费）切换次数，不超过此次数不计算切换产能损失，默认3 */
    public static final String PARAM_AVG_SWITCH_COUNT = "SYS1001014";

    /** SYS1001015 实验量试提前排产班次数，量试/试制规格的成型班次需求提前N个内衬班次排产，默认3 */
    public static final String PARAM_TRIAL_ADVANCE_SHIFTS = "SYS1001015";

    /** SYS1001016 实验量试生产阶段编码集合（逗号分隔），匹配 MdmConstructionInfo.productionStage，默认 T,X */
    public static final String PARAM_TRIAL_PRODUCTION_STAGES = "SYS1001016";

    /** SYS1001017 新规格提前备料天数，成型第一次使用这个新规格的前N天排产，默认1；大于2时按2处理 */
    public static final String PARAM_NEW_SPEC_ADVANCE_DAYS = "SYS1001017";
