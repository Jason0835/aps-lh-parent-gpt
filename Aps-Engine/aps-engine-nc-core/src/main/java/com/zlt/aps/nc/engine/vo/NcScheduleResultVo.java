...
public class NcScheduleResultVo extends NcScheduleResult {
     ...
     * 上一天最后一个班的计划量
     */
    @ApiModelProperty(value = "上一天最后一个班的计划量")
    private BigDecimal LastMidPlanQty;
    
    /**
     * 1班的接班库存
     */
    @ApiModelProperty(value = "1班的接班库存")
    @TableField(exist = false)
    private BigDecimal class1StockQty;
    
    /**
     * 2班的接班库存
     */
    @ApiModelProperty(value = "2班的接班库存")
    @TableField(exist = false)
    private BigDecimal class2StockQty;
    
    /**
     * 3班的接班库存
     */
    @ApiModelProperty(value = "3班的接班库存")
    @TableField(exist = false)
    private BigDecimal class3StockQty;
    
    /**
     * 4班的接班库存
     */
    @ApiModelProperty(value = "4班的接班库存")
    @TableField(exist = false)
    private BigDecimal class4StockQty;
    
    /**
     * 5班的接班库存
     */
    @ApiModelProperty(value = "5班的接班库存")
    @TableField(exist = false)
    private BigDecimal class5StockQty;
    
    /**
     * 6班的接班库存
     */
    @ApiModelProperty(value = "6班的接班库存")
    @TableField(exist = false)
    private BigDecimal class6StockQty;
    
    /**
     * 对应成型1班的计划量
     */
    @ApiModelProperty(value = "对应成型1班的计划量")
    @TableField(exist = false)
     ...
     * 对应成型2班的计划量
     */
    @ApiModelProperty(value = "对应成型2班的计划量")
    @TableField(exist = false)
     ...
     * 对应成型三班的计划量
     */
    @ApiModelProperty(value = "对应成型3班的计划量")
    @TableField(exist = false)
     ...
     * 对应成型4班的计划量
     */
    @ApiModelProperty(value = "对应成型4班的计划量")
    @TableField(exist = false)
     ...
     * 对应成型5的计划量
     */
    @ApiModelProperty(value = "对应成型5班的计划量")
    @TableField(exist = false)
     ...
     * 对应成型6的计划量
     */
    @ApiModelProperty(value = "对应成型6班的计划量")
    @TableField(exist = false)
    private BigDecimal cxClass6Plan;

    /**
     * 对应成型7的计划量
     */
    @ApiModelProperty(value = "对应成型7班的计划量")
    @TableField(exist = false)
    private BigDecimal cxClass7Plan;
