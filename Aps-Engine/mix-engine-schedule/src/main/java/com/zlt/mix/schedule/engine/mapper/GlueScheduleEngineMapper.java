 ...
 *
 */
public interface GlueScheduleEngineMapper {
	/**
	 * 查询胶料分解数据
	 * 
	 ...
	 * 查询昨日早班的最后一个排程计划
	 *
	 * @param scheduleDate 昨日
	 * @param mixArea 密炼区
	 * @return 昨日早班的最后一个排程计划
	 */
	List<GlueScheduleResultVo> selectLatestScheduleList(@Param("scheduleDate") Date scheduleDate, @Param("mixArea") String mixArea);
}
