...
public interface DjEngineMapper {
     ...
     */
    void batchCreateScheduleResult(@Param("scheduleResultList") List<DjScheduleResultVo> scheduleResultList);

    /**
     * 批量新增外协排程结果数据
     * @param scheduleResultList
     */
    void batchCreateAssistScheduleResult(@Param("scheduleResultList") List<DjScheduleResultVo> scheduleResultList);

    /**
     * 返回垫胶参数计划
     * @return
     */
    List<DjParamsVo> listNcParams();
...
//    int insertDjScheduleResult(NcScheduleResultVo scheduleResultVo);
     ...
     */
    void batchUpdateProduceOrder(@Param("scheduleDate") String scheduleDate, @Param("list") List<DjScheduleResultVo> scheduleResultList);

    int createTempTable();

    int dropTempTable();

    int insertTempTable(@Param("scheduleResultList") List<DjScheduleResultVo> scheduleResultList);
     ...
     * @param scheduleResultList 排程列表
     */
    void batchUpdatePlanQty(@Param("scheduleDate") String scheduleDate, @Param("list") List<DjScheduleResultVo> scheduleResultList);
    ...
    int batchUpdateBatchNoAndOrderNo(@Param("list") List<DjScheduleResultVo> scheduleResultVoList);
