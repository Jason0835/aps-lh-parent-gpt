...
/**
 * 模具变动单生成记录对象 t_mold_auto_generage_record
 * 
 * @author Joran.zhang
 * @date 2021-07-28
 */
@ApiModel(value = "模具变动单生成记录对象", description = "模具变动单生成记录对象 ")
@Data
public class MoldEngineAutoGenerageRecord extends ApsBaseEntity{
    ...
    /** 模具变动单批次号 */
    @Excel(name = "ui.data.column.record.moldBatchNo")
    @ApiModelProperty(value = "模具变动单批次号")
    ...
    @Excel(name = "ui.data.column.record.generageDate", width = 30, dateFormat = "yyyy-MM-dd")
    @ApiModelProperty(value = "排程时间")
    private Date generageDate;
