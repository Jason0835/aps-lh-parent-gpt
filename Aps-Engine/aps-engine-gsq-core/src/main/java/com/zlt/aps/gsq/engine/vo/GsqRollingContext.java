 ...
 */
@Data
public class GsqRollingContext {
     ...
     */
    private Map<String, LinkedList<GsqRollingTaskNode>> taskChainMap = new HashMap<>();

    /**
     * 生产速度缓存：key=machineCode:steelRingCode，value=速度（个/小时）
     * <p>避免单次滚动更新内重复查询 T_GSQ_MACHINE_SPEC_SPEED</p>
     */
