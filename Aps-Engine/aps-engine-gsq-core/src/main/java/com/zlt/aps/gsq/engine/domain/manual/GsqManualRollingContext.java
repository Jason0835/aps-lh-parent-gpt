 ...
 */
@Data
public class GsqManualRollingContext {
    ...
    /** 机台班次有效基础产能，key=机台编码|班次顺序（钢丝圈无单独班次产能时与 machineCapacity 一致） */
