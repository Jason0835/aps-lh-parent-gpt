 ...
 * 钢丝圈人工滚动任务草稿。
 *
 * <p>与数据库实体 GsqScheduleResult 解耦的运行态任务片段。
 * 计划量使用 BigDecimal 便于滚动计算，持久化时由 Service 层转 Integer。</p>
 */
@Data
public class GsqManualTaskDraft {
     ...
     * @return 任务副本
     */
    public GsqManualTaskDraft copy() {
        GsqManualTaskDraft target = new GsqManualTaskDraft();
        ...
        target.setSteelRingCode(this.steelRingCode);
