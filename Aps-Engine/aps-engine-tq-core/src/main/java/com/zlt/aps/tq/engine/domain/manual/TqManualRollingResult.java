 ...
 */
@Data
public class TqManualRollingResult {

    /** 最终已排任务 */
    private List<TqManualTaskDraft> scheduledTaskList = new ArrayList<>();

    /** 第6班后仍未承接的任务 */
    private List<TqManualTaskDraft> unplannedTaskList = new ArrayList<>();
