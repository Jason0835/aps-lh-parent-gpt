...
public interface Cd15EngineMapper {
	 ...
	 * @return
	 */
	List<Cd15ScheduleResultVo> listInsertOrderBaseInfo1(
			@Param("scheduleResultList") List<Cd15ScheduleResult> scheduleResultList);
	...
	int insertTempTable(@Param("scheduleResultList") List<Cd15ScheduleResultVo> scheduleResultList);
	 ...
	 * @param scheduleResultList
	 */
	int updateCd15ScheduleResultPlanQty(@Param("scheduleDate") String scheduleDate, @Param("scheduleResultList") List<Cd15ScheduleResultVo> scheduleResultList);
    ...
    int batchUpdateBatchNoAndOrderNo(@Param("list") List<Cd15ScheduleResultVo> scheduleResultVoList);
}
