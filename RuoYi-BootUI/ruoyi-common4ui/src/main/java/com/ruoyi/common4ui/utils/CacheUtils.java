...
public class CacheUtils
{
    ...
    public static void removeAll(String cacheName)
    {
        ...
        logger.info(I18nUtil.getMessage("ui.cache.removeAll"), cacheName, keys);
    }
    ...
    public static Cache<String, Object> getCache(String cacheName)
    {
        ...
        if (cache == null)
        {
            throw new RuntimeException(StringUtils.format(I18nUtil.getMessage("ui.cache.noCacheName.fail"),cacheName));
        }
        return cache;
    }
