package com.ruoyi.common4ui.utils.security;
...
import com.ruoyi.common4ui.constant.PermissionConstants;
...
public class PermissionUtils {
    ...
    public static String getMsg(String permissionsStr) {
        ...
        String msg = I18nUtil.getMessage(PERMISSION, permissionArr);
        if (StringUtils.endsWithIgnoreCase(permission, PermissionConstants.ADD_PERMISSION)) {
            msg = I18nUtil.getMessage(CREATE_PERMISSION, permissionArr);
        } else if (StringUtils.endsWithIgnoreCase(permission, PermissionConstants.EDIT_PERMISSION)) {
            msg = I18nUtil.getMessage(UPDATE_PERMISSION, permissionArr);
        } else if (StringUtils.endsWithIgnoreCase(permission, PermissionConstants.REMOVE_PERMISSION)) {
            msg = I18nUtil.getMessage(DELETE_PERMISSION, permissionArr);
        } else if (StringUtils.endsWithIgnoreCase(permission, PermissionConstants.EXPORT_PERMISSION)) {
            msg = I18nUtil.getMessage(EXPORT_PERMISSION, permissionArr);
            ...
            msg = I18nUtil.getMessage(VIEW_PERMISSION, permissionArr);
        }
        return msg;
    }
