...
;(function ($, window, document, undefined) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      filterTextClear: bootstrapDualListbox.filterTextClear,
      filterPlaceHolder: bootstrapDualListbox.filterPlaceHolder,
      moveSelectedLabel: bootstrapDualListbox.moveSelectedLabel,
      moveAllLabel: bootstrapDualListbox.moveAllLabel,
      removeSelectedLabel: bootstrapDualListbox.removeSelectedLabel,
      removeAllLabel: bootstrapDualListbox.removeAllLabel,
      ...
      infoText: bootstrapDualListbox.infoText,                                                        // text when all options are visible / false for no info text
      infoTextFiltered: bootstrapDualListbox.infoTextFiltered, // when not all of the options are visible due to the filter
      infoTextEmpty: bootstrapDualListbox.infoTextEmpty,                                                        // when there are no options present in the list
