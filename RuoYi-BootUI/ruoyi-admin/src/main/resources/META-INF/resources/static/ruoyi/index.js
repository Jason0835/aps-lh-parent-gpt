...
$(function() {
    ...
    $.contextMenu({
        ...
        items: {
            "close_current": {
                name: frame.contextMenu.close_current,
                icon: "fa-close",
            ...
            "close_other": {
                name: frame.contextMenu.close_other,
            ...
            "close_left": {
                name: frame.contextMenu.close_left,
                icon: "fa-reply",
                callback: function(key, opt) {
                    setActiveTab(this);
            ...
            "close_right": {
                name: frame.contextMenu.close_right,
                icon: "fa-share",
                callback: function(key, opt) {
                    setActiveTab(this);
            ...
            "close_all": {
                name: frame.contextMenu.close_all,
            ...
            "refresh": {
                name: frame.contextMenu.refresh,
                icon: "fa-refresh",
                callback: function(key, opt) {
                	setActiveTab(this);
                	var target = $('.RuoYi_iframe[data-id="' + this.data('id') + '"]');
