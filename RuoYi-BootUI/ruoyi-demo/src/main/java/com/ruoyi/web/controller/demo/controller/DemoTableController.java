...
public class DemoTableController extends BaseController
{
     ...
     */
    @GetMapping("/params")
    public String params(ModelMap mmap)
    {
//        mmap.put("queryParams", Collections.singletonList(users.get(0)));
//        mmap.put("from", Collections.singletonList(users.get(5)));
    ...
    public TableDataInfo list(UserTableModel userModel)
    {
        ...
        return getDataTable(userList.subList(pageNum, pageSize));
    }
}
