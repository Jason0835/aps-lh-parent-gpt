 ...
 */
@Controller
@RequestMapping("/setting/lhflImportLogManagement")
@Api(tags = {"导入日志管理接口"})
public class LhflImportLogManagementController extends BaseController {
    private final String prefix = "setting/lhflImportLogManagement";
    ...
    @RequiresPermissions("setting:lhflImportLogManagement:view")
    @GetMapping()
     ...
     * 查询工序导入日志管理列表
     */
    @RequiresPermissions("setting:lhflImportLogManagement:list")
     ...
     * 错误日志详情列表
     */
    @RequiresPermissions("setting:lhflImportLogManagement:errorView")
