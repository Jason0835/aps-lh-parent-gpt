...
public class SettingExportLogManagementController extends BaseController {
    private final String prefix = "setting/exportLogManagement";
    ...
    @RequiresPermissions("setting:exportLogManagement:view")
    @GetMapping()
     ...
     * 查询工序导出日志管理列表
     */
    @RequiresPermissions("setting:exportLogManagement:list")
