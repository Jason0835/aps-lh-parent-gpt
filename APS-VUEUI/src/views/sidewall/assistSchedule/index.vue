...
<template>
  <basic-container>
    <page-table
      tableRef="sidewallAssistScheduleMainTable"
      :calcHeight="true"
      v-loading="loading"
      :columns="columns"
...
//interface
import { listAssistSchedule } from "@/api/tc/assistSchedule.js";
//components
// import TltUploadForm from "@/views/components/tltUploadForm.vue";

export default {
  name: "SidewallAssistSchedule",
  components: {
    // TltUploadForm,
  },
  dicts: ["TASK_TYPE"],
