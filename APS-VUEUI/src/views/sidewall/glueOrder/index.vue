...
<template>
  <basic-container>
    <page-table
      tableRef="sidewallGlueOrderMainTable"
      :calcHeight="true"
      v-loading="loading"
      :columns="columns"
    ...
    >
      <template slot="header">
        <el-button
          type="primary"
          v-hasPermi="['tc:glueOrder:add']"
          @click="handleAdd"
          >{{ $t("ui.frame.btn.add") }}</el-button
        >
        <!-- <el-button
          type="warning"
          v-hasPermi="['tc:glueOrder:edit']"
          @click="handleEdit(selection[0])"
          >{{ $t("ui.frame.btn.modify") }}</el-button
        > -->
        <el-button
          v-hasPermi="['tc:glueOrder:import']"
          @click="$refs.tltUpload.handleImport()"
          >{{ $t("ui.frame.btn.import") }}</el-button
        >
        <el-button @click="handleExport" v-hasPermi="['tc:glueOrder:export']">{{
    ...
    <tlt-upload
      ref="tltUpload"
      downloadUrl="/tc/glueOrder/importTemplate"
      uploadUrl="/tc/glueOrder/importData"
...
//interface
import { listGlueGroupOrder } from "@/api/tc/glueGroupOrder";
import { listGlueOrder, removeGlueOrder } from "@/api/tc/glueOrder";
//components
...
export default {
  ...
  methods: {
    ...
    handleExport() {
      downloadLink("/tc/glueOrder/export", this.formatParams(false));
    },
