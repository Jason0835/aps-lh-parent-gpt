  ...
  <basic-container>
    ...
    >
      <template slot="header">
        <el-button
          type="warning"
          v-hasPermi="['fac:docVulcanizingLimit:add']"
          @click="handleAdd"
          >{{ $t("ui.frame.btn.add") }}</el-button
        >
        <!-- <el-button
          type="warning"
          v-hasPermi="['fac:docVulcanizingLimit:edit']"
        ...
        <el-button
          type="warning"
          v-hasPermi="['fac:docVulcanizingLimit:import']"
        ...
        <el-button
          type="primary"
          @click="handleExport"
          v-hasPermi="['fac:docVulcanizingLimit:export']"
    ...
    <tlt-upload
      ref="tltUpload"
      downloadUrl="/fac/docVulcanizingLimit/importTemplate"
      uploadUrl="/fac/docVulcanizingLimit/importData"
...
export default {
 name: "Machine",
  ...
  computed: {
    columns() {
      let columns = [
        ...
        {
          prop: "productCode",
          label: this.$t("ui.data.column.docVulcanizingLimit.productCode"),
        },
        {
          prop: "productDescription",
          label: this.$t(
            "ui.data.column.docVulcanizingLimit.productDescription"
          ),
        },
        {
          prop: "companyCode",
          label: this.$t("ui.data.column.docVulcanizingLimit.companyCode"),
        },
        {
          prop: "factoryCode",
          label: this.$t("ui.data.column.docVulcanizingLimit.factoryCode"),
        },
        {
          prop: "productTypeCode",
          label: this.$t("ui.data.column.docVulcanizingLimit.productName"),
        ...
        {
          prop: "vulcanizingMachineCode",
          label: this.$t(
            "ui.data.column.docVulcanizingLimit.vulcanizingMachineCode"
          ),
        },
        {
          prop: "limitType",
          label: this.$t("ui.data.column.docVulcanizingLimit.limitTypeName"),
          formatter: function (value, row, index) {
        ...
        {
          prop: "remark",
          label: this.$t("ui.data.column.docProductALevel.remark"),
          minWidth: 100,
        },
        {
          align: "center",
  ...
  methods: {
    ...
    handleExport() {
      downloadLink("/fac/docVulcanizingLimit/export", this.formatParams(false));
    },
