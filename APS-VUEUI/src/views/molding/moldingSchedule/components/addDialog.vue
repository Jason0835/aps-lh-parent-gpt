    ...
    <div class="content" v-loading="loading">
      ...
      >
        <el-row type="flex" style="flex-wrap: wrap">
          ...
          <el-col :span="12">
            <el-form-item :label="$t('ui.data.column.scheduleResult.materialCode')" prop="materialCode">
              <materialCodeSelect
          ...
          <el-col :span="12">
            <el-form-item :label="$t('ui.data.column.scheduleResult.materialDesc')" prop="materialDesc">
          ...
          <el-col :span="12">
            <el-form-item :label="$t('ui.data.column.scheduleResult.embryoDesc')" prop="mainMaterialDesc">
              <el-input v-model="form.mainMaterialDesc" disabled></el-input>
            </el-form-item>
          </el-col>

          <el-col :span="12">
            <el-form-item :label="$t('ui.data.column.cxScheduleResult.totalSurplusQty')" prop="mouldSurplusQty">
              <el-input v-model="form.mouldSurplusQty"></el-input>
            </el-form-item>
          </el-col>

          <el-col :span="12">
            <el-form-item :label="$t('ui.data.column.scheduleResult.embryoStock')" prop="totalStock">
              <el-input v-model="form.totalStock"></el-input>
            </el-form-item>
          </el-col>

          <el-col :span="12">
            <el-form-item :label="$t('ui.data.column.cxScheduleResult.lhClassQty')" prop="lhClassQty">
...
export default {
  ...
  methods: {
    ...
    handleRecipeNoChange(shift, val, row) {
      ...
      if (val && row) {
        this.$set(this.form, recipeTypeField, row.mouldMethod || "");
      } else {
