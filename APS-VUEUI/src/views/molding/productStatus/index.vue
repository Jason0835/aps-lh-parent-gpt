  ...
  <basic-container>
    ...
    >
      <template slot="header">
        <el-button
          v-hasPermi="['cx:productStatus:modifyQty']"
          type="warning"
          :disabled="selection.length !== 1"
          @click="handleModifyQty"
          >{{ $t("ui.data.column.productStatus.modifyQty") }}</el-button
        >
        <el-button
          v-hasPermi="['cx:productStatus:export']"
           @click="handleExport"
        ...
        >
        <el-button
          v-hasPermi="['cx:productStatus:markUnProduct']"
          type="primary"
          :disabled="selection.length == 0"
          @click="handleMarkUnProduct"
          >{{ $t("ui.data.column.productStatus.markUnProduct") }}</el-button
        >
...
export default {
  ...
  dicts: ["MARK_UN_PRODUCT", "PRODUCT_STATUS", "STORAGE_LOCATION"],
  provide() {
    return {
      ...
      let columns = [
        ...
        },
        {
          ...
          formatter: (row, column, value, index) => {
            return this.selectDictLabel(this.dict.type.PRODUCT_STATUS, value);
          },
        },
        {
          prop: "markUnProduct",
          ...
          // sortable: "custom",
          formatter: (row, column, value, index) => {
            return this.selectDictLabel(this.dict.type.MARK_UN_PRODUCT, value);
          },
        },
        {
          prop: "remark",
    ...
    searchColumns() {
      return [
        ...
        },
        {
          ...
          prop: "productStatus",
          type: "select",
          dictData: this.dict.type.PRODUCT_STATUS, // "PRODUCT_STATUS",
        },
        {
          label: this.$t("ui.data.column.productStatus.markUnProduct"),
          prop: "markUnProduct",
          type: "select",
          dictData: this.dict.type.MARK_UN_PRODUCT, // "MARK_UN_PRODUCT",
        },
      ];
    },
  },
