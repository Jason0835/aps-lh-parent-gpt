...
<template>
  <basic-container>
    ...
    <!-- <tlt-upload
      ref="tltUpload"
      downloadUrl="/cd15/params/importTemplate"
      uploadUrl="/cd15/params/importData"
...
//interface
import { listParams, removeParams } from "@/api/cd15/params";
//components
...
export default {
 name: "Cut15Params",
  ...
  methods: {
    ...
    handleExport() {
      downloadLink("/cd15/params/export", this.formatParams(false));
    },
