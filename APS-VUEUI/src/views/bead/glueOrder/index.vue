...
<template>
  <basic-container>
    <page-table
      tableRef="beadGlueOrderMainTable"
      :calcHeight="true"
      v-loading="loading"
      :columns="columns"
    ...
    >
      <template slot="header">
        <el-button
          type="primary"
          v-hasPermi="['tq:glueOrder:add']"
          @click="handleAdd"
          >{{ $t("ui.frame.btn.add") }}</el-button
        >
        <!-- <el-button
          type="warning"
          v-hasPermi="['tq:glueOrder:edit']"
          @click="handleEdit(selection[0])"
          >{{ $t("ui.frame.btn.modify") }}</el-button
        > -->
        <el-button
          v-hasPermi="['tq:glueOrder:import']"
          @click="$refs.tltUpload.handleImport()"
          >{{ $t("ui.frame.btn.import") }}</el-button
        >
        <el-button @click="handleExport" v-hasPermi="['tq:glueOrder:export']">{{
    ...
    <tlt-upload
      ref="tltUpload"
      downloadUrl="/tq/glueOrder/importTemplate"
      uploadUrl="/tq/glueOrder/importData"
...
//interface
import { listGlueGroupOrder } from "@/api/tq/glueGroupOrder";
import { listGlueOrder, removeGlueOrder } from "@/api/tq/glueOrder";
//components
...
export default {
  ...
  methods: {
    ...
    handleExport() {
      downloadLink("/tq/glueOrder/export", this.formatParams(false));
    },
