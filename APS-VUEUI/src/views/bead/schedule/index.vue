 ...
 *
 * 废弃说明：
 *   本页面为旧版4班次制胎圈排程页面，已由新版6班次制页面替代。
 *   新版页面路径：src/views/tq/newScheduleResult/index.vue
 *   新版接口前缀：/tq/newScheduleResult/*
 *   新版算法依据：胎圈自动排程_v5.xmind（6班次制）
 *
 *   旧版4班次字段（midPlanQty/nightPlanQty/dayPlanQty/nextMidPlanQty）将逐步废弃，
 *   请勿在此页面新增功能，所有新需求请到新版页面实现。
 *
 *   计划在阶段3后端旧版代码清理完成后，本页面将一并删除。
 * ============================================================================
-->
<template>
  <basic-container>
