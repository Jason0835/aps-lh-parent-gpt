  ...
  <basic-container>
    ...
    >
      <template slot="header">
        ...
        >
        <el-button @click="handleExport" v-hasPermi="['tq:loss:export']">{{
...
//interface
import { listLoss, removeLoss } from "@/api/tq/loss";
//components
...
export default {
  ...
  methods: {
    ...
    handleExport() {
      downloadLink("/tq/loss/export", this.formatParams(false));
    },
