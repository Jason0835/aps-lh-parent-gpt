  ...
  <basic-container>
    ...
    >
      <template slot="header">
        <el-button v-hasPermi="['setting:mixingTime:add']" @click="handleAdd">{{
          $t("ui.frame.btn.add")
        }}</el-button>
        <el-button
          v-hasPermi="['setting:mixingTime:edit']"
        ...
        > -->
        <el-button
          v-hasPermi="['setting:mixingTime:import']"
          @click="() => $refs.tltUploadForm.handleImport(importDefaultValue)"
          >{{ $t("ui.frame.btn.import") }}</el-button
        >
        <el-button
          v-hasPermi="['setting:mixingTime:export']"
          @click="handleExport"
    ...
    <tlt-upload-form
      ref="tltUploadForm"
      title="导入信息数据"
      downloadUrl="/setting/mixingTime/importTemplate"
      uploadUrl="/setting/mixingTime/importData"
...
import {exportData, listMixingTime, removeMixingTime} from "@/api/setting/mixingTime";
    ...
    return {
      ...
      columns: [
        ...
        },
        {
          ...
          halign: "center",
          align: "center",
          label: this.$t("setting.mixingTime.machineCode"),
        },
        {
          prop: "machineName",
          // sortable: "custom",
  ...
  methods: {
    ...
    handleDelete(row) {
      this.$confirm(this.$t("common.confirm.delete"), {
        ...
        const ids = row.id;
        removeMixingTime({ ids }).then((data) => {
    ...
    async getList() {
      try {
        this.loading = true;
        const data = await listMixingTime(this.formatParams());
