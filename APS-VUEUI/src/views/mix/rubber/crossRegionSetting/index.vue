  ...
  <basic-container>
    ...
    >
      <template slot="header">
        <el-button v-hasPermi="['setting:glueSpanSetting:add']" @click="handleAdd">{{
          $t("ui.frame.btn.add")
        }}</el-button>
        <el-button
          v-hasPermi="['setting:glueSpanSetting:edit']"
        ...
        > -->
        <el-button
          v-hasPermi="['setting:glueSpanSetting:import']"
          @click="() => $refs.tltUploadForm.handleImport(importDefaultValue)"
          >{{ $t("ui.frame.btn.import") }}</el-button
        >
        <el-button
          v-hasPermi="['setting:glueSpanSetting:export']"
           @click="handleExport"
    ...
    <tlt-upload-form
      ref="tltUploadForm"
      title="导入信息数据"
      downloadUrl="/setting/glueSpanSetting/importTemplate"
      uploadUrl="/setting/glueSpanSetting/importData"
...
import {exportData, listGlueSpanSetting, removeGlueSpanSetting} from "@/api/setting/glueSpanSetting";
...
export default {
  ...
  data() {
    ...
    return {
      ...
      searchColumns: [
        {
          label: this.$t("setting.glueSpanSetting.entrustMixArea"),
          prop: "entrustMixArea",
          render: (form) => {
            return (
              <dict-select
                v-model={form.entrustMixArea}
        ...
        {
          label: this.$t("setting.glueSpanSetting.entrustedMixArea"),
          prop: "entrustedMixArea",
          render: (form) => {
            return (
              <dict-select
                v-model={form.entrustedMixArea}
                options={this.dict.type.MIX_AREA}
              />
            );
          },
        ...
        {
          label: this.$t("setting.glueSpanSetting.glue"),
          prop: "glue",
        },
      ],
      columns: [
