...
<template>
  <basic-container>
    <page-table
      tableRef="beadRingScheduleMainTable"
      :calcHeight="true"
      v-loading="loading"
      :columns="columns"
    ...
    >
      <template slot="header">
        ...
        >
        <!-- <el-button
          v-hasPermi="['gsq:scheduleResult:balance']"
          type="primary"
          @click="handleBalance"
          >{{ $t("ui.data.column.scheduleResult.balance") }}</el-button
        > -->
        <!-- <el-button
          v-hasPermi="['gsq:scheduleResult:mergeProduct']"
          type="primary"
          >{{ $t("ui.data.column.scheduleResult.mergeProduct") }}</el-button
        > -->
        <!-- <el-button
          v-hasPermi="['gsq:scheduleResult:combinationMiddleAndNight']"
          type="primary"
    ...
    <tlt-upload-form
      ...
      uploadUrl="/gsq/scheduleResult/importScheduleData"
    ...
    <tlt-upload-form
      ref="tltUploadForm2"
      title="导入钢丝圈排程结果数据"
      uploadUrl="/gsq/scheduleResult/importScheduleData2"
      @uploadSuccess="getList"
      :columns="[
        {
          label: '排程日期',
    ...
    <tlt-upload-form
      ref="tltUploadForm3"
      title="导入钢丝圈排程结果数据"
      uploadUrl="/gsq/scheduleResult/importFinishQty"
      downloadUrl="/gsq/scheduleResult/importFinishQtyTemplate"
      @uploadSuccess="getList"
      :columns="[
        {
          label: '排程日期',
...
export default {
  ...
  computed: {
    ...
    columns() {
      let columns = [
        { type: "selection", fixed: "left" },
        {
          ...
          children: [
            ...
            },
            {
              ...
              render: ({ row }) => {
                if (row.colorType == "0") {
                  return <font color={row.colorCode}>{row.steelType}</font>;
                }
                return row.steelType;
              },
            },
            {
              prop: "steelRingCode",
            ...
            },
            {
              ...
              align: "center",
              //  sortable: "custom",
              label: this.$t("ui.data.column.gsq.scheduleResult.dimension"),
            },
            {
              prop: "rank",
              valign: "middle",
              ...
              align: "center",
              //  sortable: "custom",
              label: this.$t("ui.data.column.gsq.scheduleResult.rank"),
              width: 120,
            },
            {
              prop: "machineId",
        ...
        },
        {
          ...
          width: 150,
            ...
            },
            {
              ...
              formatter: (row, column, value, index) => {
                var reasion = "";
                var HandAnaly = row.midSysAnalysis;
                if (value != null) {
        ...
        // },
        {
          label: this.$t("ui.data.column.scheduleResult.gsqPlan2"),
          children: [
            {
              prop: "cxClass2Plan",
              valign: "middle",
              ...
              //  sortable: "custom",
              label:
                this.$t("ui.data.column.scheduleResult.br.class1Plan") +
                "(" +
                this.$t("ui.data.column.scheduleResult.unit.individual1") +
                ")",
            },
            {
              ...
              //  sortable: "custom",
              label:
                this.$t("ui.data.column.scheduleResult.br.class2Plan") +
                "(" +
                this.$t("ui.data.column.scheduleResult.unit.individual1") +
                ")",
            },
            ...
            },
            {
              ...
              //  sortable: "custom",
              label:
                this.$t("ui.data.column.scheduleResult.br.class3Plan") +
                "(" +
                this.$t("ui.data.column.scheduleResult.unit.individual1") +
                ")",
            },
            {
              ...
              //  sortable: "custom",
              label:
                this.$t("ui.data.column.scheduleResult.br.cxClass4Plan") +
                "(" +
                this.$t("ui.data.column.scheduleResult.unit.individual1") +
                ")",
            },
            ...
            //   sortable: "custom",
            //   label:
            //     this.$t("ui.data.column.scheduleResult.br.cxClass5Plan") +
            //     "(" +
            //     this.$t("ui.data.column.scheduleResult.unit.individual1") +
            //     ")",
            // },
  ...
  methods: {
    ...
    handleExportUiExcel() {
      downloadLink("/gsq/scheduleResult/export", this.formatParams(false));
    },
