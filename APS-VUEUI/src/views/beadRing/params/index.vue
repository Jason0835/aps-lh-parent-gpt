...
<template>
  <basic-container>
    <page-table
      tableRef="beadRingParamsMainTable"
      :calcHeight="true"
      v-loading="loading"
      :columns="columns"
    ...
    <!-- <tlt-upload
      ref="tltUpload"
      downloadUrl="/gsq/params/importTemplate"
      uploadUrl="/gsq/params/importData"
...
//interface
import { listParams, removeParams } from "@/api/gsq/params";
//components
