...
<template>
  <basic-container>
    <page-table
      tableRef="beadRingFixedPointMachineMainTable"
      :calcHeight="true"
      v-loading="loading"
      :columns="columns"
...
export default {
  name: "BeadRingFixedPointMachine",
  components: {
    tltUpload,
    infoDialog,
  },
    ...
    columns() {
      let columns = [
        { type: "selection", fixed: "left" },
        {
          ...
          align: "center",
          halign: "center",
          label: this.$t("ui.gsq.specifyMachine.column.steelRingCode"),
          // sortable: "custom",
        },
        {
          prop: "machineName",
  ...
  methods: {
    ...
    handleExport() {
      downloadLink("/gsq/specifyMachine/export", this.formatParams(false));
    },
