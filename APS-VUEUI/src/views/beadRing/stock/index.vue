...
<template>
  <basic-container>
    <page-table
      tableRef="beadRingStockMainTable"
      :calcHeight="true"
      v-loading="loading"
      :columns="columns"
    ...
    >
      <template slot="header">
        ...
        <!-- <el-button
          type="warning"
          v-hasPermi="['gsq:stock:stockRevise']"
          :disabled="selection.length !== 1"
        ...
        >
        <el-button @click="handleExport" v-hasPermi="['gsq:stock:export']">{{
...
//interface
import { listStock, removeStock, releaseStock } from "@/api/gsq/stock";
//components
...
export default {
  ...
  methods: {
    ...
    handleExport() {
      downloadLink("/gsq/stock/export", this.formatParams(false));
    },
