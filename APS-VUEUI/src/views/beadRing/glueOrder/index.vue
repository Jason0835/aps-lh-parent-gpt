...
<template>
  <basic-container>
    <page-table
      tableRef="beadRingGlueOrderMainTable"
      :calcHeight="true"
      v-loading="loading"
      :columns="columns"
    ...
    >
      <template slot="header">
        <el-button
          type="primary"
          v-hasPermi="['gsq:glueOrder:add']"
          @click="handleAdd"
          >{{ $t("ui.frame.btn.add") }}</el-button
        >
        <!-- <el-button
          type="warning"
          v-hasPermi="['gsq:glueOrder:edit']"
          @click="handleEdit(selection[0])"
          >{{ $t("ui.frame.btn.modify") }}</el-button
        > -->
        <el-button
          v-hasPermi="['gsq:glueOrder:import']"
          @click="$refs.tltUpload.handleImport()"
          >{{ $t("ui.frame.btn.import") }}</el-button
        >
        <el-button @click="handleExport" v-hasPermi="['gsq:glueOrder:export']">{{
    ...
    <tlt-upload
      ref="tltUpload"
      downloadUrl="/gsq/glueOrder/importTemplate"
      uploadUrl="/gsq/glueOrder/importData"
...
//interface
import { listGlueGroupOrder } from "@/api/gsq/glueGroupOrder";
import { listGlueOrder, removeGlueOrder } from "@/api/gsq/glueOrder";
//components
...
export default {
  ...
  methods: {
    ...
    handleExport() {
      downloadLink("/gsq/glueOrder/export", this.formatParams(false));
    },
