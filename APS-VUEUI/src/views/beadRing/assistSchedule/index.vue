...
<template>
  <basic-container>
    <page-table
      tableRef="beadRingAssistScheduleMainTable"
      :calcHeight="true"
      v-loading="loading"
      :columns="columns"
...
//interface
import { listAssistSchedule } from "@/api/gsq/assistSchedule.js";
//components
// import TltUploadForm from "@/views/components/tltUploadForm.vue";

export default {
  name: "BeadRingAssistSchedule",
  components: {
    // TltUploadForm,
  },
  dicts: ["TASK_TYPE"],
  ...
  data() {
    return {
      searchColumns: [
        ...
        {
          label: this.$t("ui.data.column.gsq.scheduleResult.beadRingCode"),
          prop: "steelRingCode",
        },
        {
