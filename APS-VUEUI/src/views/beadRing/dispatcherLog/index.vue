...
<template>
  <basic-container>
    <page-table
      tableRef="beadRingDispatcherLogMainTable"
      :calcHeight="true"
      v-loading="loading"
      :columns="columns"
    ...
    >
      <template slot="header">
        ...
        <!-- <el-button
          type="warning"
          v-hasPermi="['gsq:dispatcherLog:edit']"
          @click="handleEdit(selection[0])"
          >{{ $t("ui.frame.btn.modify") }}</el-button
        > -->
        <!-- <el-button
          v-hasPermi="['gsq:dispatcherLog:import']"
    ...
    <!-- <tlt-upload
      ref="tltUpload"
      downloadUrl="/gsq/dispatcherLog/importTemplate"
      uploadUrl="/gsq/dispatcherLog/importData"
