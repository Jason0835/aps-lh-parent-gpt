  ...
  <basic-container>
    ...
    >
      <template slot="header">
        <el-button
          v-hasPermi="['gsq:reserveStock:add']"
          type="primary"
          plain
          @click="handleAdd"
        ...
        >
        <!-- <el-button
          v-hasPermi="['gsq:reserveStock:edit']"
          type="primary"
        ...
        > -->
        <el-button
          v-hasPermi="['gsq:reserveStock:import']"
          @click="() => $refs.tltUploadForm.handleImport(importDefaultValue)"
          >{{ $t("ui.frame.btn.import") }}</el-button
        >
        <el-button
          v-hasPermi="['gsq:reserveStock:export']"
          @click="handleExport"
    ...
    <tlt-upload-form
      ref="tltUploadForm"
      title="导入预生产库存倍数配置数据"
      downloadUrl="/gsq/reserveStock/importTemplate"
      uploadUrl="/gsq/reserveStock/importData"
...
import {
  ...
  editReserveStock,
  removeReserveStock
} from "@/api/gsq/reserveStock";
import InfoDialog from "./components/infoDialog.vue";
import TltUploadForm from "@/views/components/tltUploadForm.vue";

export default {
  name: "BeadRingPreProductStockMultiple",
    ...
    columns() {
      let columns = [
        { type: "selection", fixed: "left" },
        {
          ...
          align: "center",
          halign: "center",
          label: this.$t("ui.data.column.gsq.dispatcherlog.materialCode"),
          // sortable: "custom",
        },
        {
          ...
          render: ({ row }) => {
            return (
              <div>
                ...
                <el-button
                  v-hasPermi={["gsq:reserveStock:remove"]}
                  class="minus"
                  type="danger"
