...
<template>
  <basic-container>
    <page-table
      tableRef="cut90DispatcherLogMainTable"
      :calcHeight="true"
      v-loading="loading"
      :columns="columns"
    ...
    >
      <template slot="header">
        <!-- <el-button
          type="primary"
          v-hasPermi="['cd90:dispatcherLog:add']"
          @click="handleAdd"
          >{{ $t("ui.frame.btn.add") }}</el-button
        > -->
        <!-- <el-button
          type="warning"
          v-hasPermi="['cd90:dispatcherLog:edit']"
          @click="handleEdit(selection[0])"
          >{{ $t("ui.frame.btn.modify") }}</el-button
        > -->
        <!-- <el-button
          v-hasPermi="['cd90:dispatcherLog:import']"
          @click="$refs.tltUpload.handleImport()"
          >{{ $t("ui.frame.btn.import") }}</el-button
        > -->
        <el-button
          @click="handleExport"
          v-hasPermi="['cd90:dispatcherLog:export']"
    ...
    <!-- <tlt-upload
      ref="tltUpload"
      downloadUrl="/cd90/dispatcherLog/importTemplate"
      uploadUrl="/cd90/dispatcherLog/importData"
...
//interface
import { listDispatcherLog } from "@/api/cd90/dispatcherLog";
...
export default {
  ...
  methods: {
    ...
    handleExport() {
      downloadLink("/cd90/dispatcherLog/export", this.formatParams(false));
    },
