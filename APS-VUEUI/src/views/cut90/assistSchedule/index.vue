...
<template>
  <basic-container>
    <page-table
      tableRef="cut90AssistScheduleMainTable"
      :calcHeight="true"
      v-loading="loading"
      :columns="columns"
    ...
    >
      <template slot="header">
        <el-button
          v-hasPermi="['cd90:assistSchedule:export']"
          type="primary"
          plain
...
//interface
import { listAssistSchedule } from "@/api/cd90/assistSchedule.js";
//components
// import TltUploadForm from "@/views/components/tltUploadForm.vue";

export default {
 name: "Cut90AssistSchedule",
  components: {
    // TltUploadForm,
  },
  dicts: ["TASK_TYPE"],
