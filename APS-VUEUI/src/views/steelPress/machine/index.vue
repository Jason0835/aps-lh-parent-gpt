...
<template>
  <basic-container>
    <page-table
      tableRef="steelPressMachineMainTable"
      :calcHeight="true"
      v-loading="loading"
      :columns="columns"
    ...
    >
      <template slot="header">
        ...
        > -->
        <el-button
          v-hasPermi="['gdyy:machine:import']"
          @click="() => $refs.tltUploadForm.handleImport(importDefaultValue)"
          >{{ $t("ui.frame.btn.import") }}</el-button
        >
        <el-button v-hasPermi="['gdyy:machine:export']" @click="handleExport">{{
    ...
    <tlt-upload-form
      ref="tltUploadForm"
      title="导入机台信息数据"
      downloadUrl="/gdyy/machine/importTemplate"
      uploadUrl="/gdyy/machine/importData"
...
} from "@/api/gdyy/machine";
import InfoDialog from "./components/infoDialog.vue";
import TltUploadForm from "@/views/components/tltUploadForm.vue";

export default {
  name: "SteelPressMachine",
