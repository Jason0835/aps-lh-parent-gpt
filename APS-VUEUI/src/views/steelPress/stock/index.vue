...
<template>
  <basic-container>
    <page-table
      tableRef="steelPressStockMainTable"
      :calcHeight="true"
      v-loading="loading"
      :columns="columns"
    ...
    >
      <template slot="header">
        ...
        <!-- <el-button
          type="warning"
          v-hasPermi="['gdyy:stock:stockRevise']"
          :disabled="selection.length !== 1"
        ...
        >
        <el-button @click="handleExport" v-hasPermi="['gdyy:stock:export']">{{
...
//interface
import { listStock, removeStock, releaseStock } from "@/api/gdyy/stock";
//components
...
export default {
  ...
  methods: {
    ...
    handleExport() {
      downloadLink("/gdyy/stock/export", this.formatParams(false));
    },
