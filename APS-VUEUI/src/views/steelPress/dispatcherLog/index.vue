...
<template>
  <basic-container>
    <page-table
      tableRef="steelPressDispatcherLogMainTable"
      :calcHeight="true"
      v-loading="loading"
      :columns="columns"
    ...
    >
      <template slot="header">
        <!-- <el-button
          type="primary"
          v-hasPermi="['gdyy:dispatcherLog:add']"
          @click="handleAdd"
          >{{ $t("ui.frame.btn.add") }}</el-button
        > -->
        <!-- <el-button
          type="warning"
          v-hasPermi="['gdyy:dispatcherLog:edit']"
          @click="handleEdit(selection[0])"
          >{{ $t("ui.frame.btn.modify") }}</el-button
        > -->
        <!-- <el-button
          v-hasPermi="['gdyy:dispatcherLog:import']"
          @click="$refs.tltUpload.handleImport()"
          >{{ $t("ui.frame.btn.import") }}</el-button
        > -->
        <el-button
          @click="handleExport"
          v-hasPermi="['gdyy:dispatcherLog:export']"
    ...
    <!-- <tlt-upload
      ref="tltUpload"
      downloadUrl="/gdyy/dispatcherLog/importTemplate"
      uploadUrl="/gdyy/dispatcherLog/importData"
...
//interface
import { listDispatcherLog } from "@/api/gdyy/dispatcherLog";
//components
...
export default {
      ...
      let columns = [
        { type: "selection", fixed: "left" },
        {
          ...
          children: [
            ...
            {
              prop: "materialCode",
              label: this.$t("ui.data.column.gdyy.dispatcherlog.materialCode"),
              valign: "middle",
              align: "center",
              halign: "center",
             //  sortable: "custom",
        ...
        },
        {
          ...
          children: [
            ...
            // {
            //   prop: "beforeDayPlan",
            //   label: this.$t("ui.data.column.dispatcherlog.dayPlan"),
            //   valign: "middle",
            //   align: "left",
            //   halign: "center",
            //   sortable: "custom",
  ...
  methods: {
    ...
    handleExport() {
      downloadLink("/gdyy/dispatcherLog/export", this.formatParams(false));
    },
