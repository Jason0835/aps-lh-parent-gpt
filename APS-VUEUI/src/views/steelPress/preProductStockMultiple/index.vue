...
<template>
  <basic-container>
    <page-table
      tableRef="steelPressPreProductStockMultipleMainTable"
      :calcHeight="true"
      v-loading="loading"
      :columns="columns"
    ...
    >
      <template slot="header">
        <el-button
          v-hasPermi="['gdyy:reserveStock:add']"
          type="primary"
          plain
          @click="handleAdd"
        ...
        >
        <!-- <el-button
          v-hasPermi="['gdyy:reserveStock:edit']"
          type="primary"
          plain
        ...
        > -->
        <el-button
          v-hasPermi="['gdyy:reserveStock:import']"
          @click="() => $refs.tltUploadForm.handleImport(importDefaultValue)"
          >{{ $t("ui.frame.btn.import") }}</el-button
        >
        <el-button
          v-hasPermi="['gdyy:reserveStock:export']"
          @click="handleExport"
    ...
    <tlt-upload-form
      ref="tltUploadForm"
      title="导入预生产库存倍数配置数据"
      downloadUrl="/gdyy/reserveStock/importTemplate"
      uploadUrl="/gdyy/reserveStock/importData"
...
import {
  ...
  editReserveStock,
  removeReserveStock,
} from "@/api/gdyy/reserveStock";
import InfoDialog from "./components/infoDialog.vue";
import TltUploadForm from "@/views/components/tltUploadForm.vue";

export default {
  name: "SteelPressPreProductStockMultiple",
          ...
          render: ({ row }) => {
            return (
              <div>
                ...
                <el-button
                  v-hasPermi={["gdyy:reserveStock:remove"]}
                  class="minus"
                  type="danger"
