...
<template>
  <basic-container>
    <page-table
      tableRef="steelPressGlueOrderMainTable"
      :calcHeight="true"
      v-loading="loading"
      :columns="columns"
    ...
    >
      <template slot="header">
        <el-button
          type="primary"
          v-hasPermi="['gdyy:glueOrder:add']"
          @click="handleAdd"
          >{{ $t("ui.frame.btn.add") }}</el-button
        >
        <!-- <el-button
          type="warning"
          v-hasPermi="['gdyy:glueOrder:edit']"
          @click="handleEdit(selection[0])"
          >{{ $t("ui.frame.btn.modify") }}</el-button
        > -->
        <el-button
          v-hasPermi="['gdyy:glueOrder:import']"
          @click="$refs.tltUpload.handleImport()"
          >{{ $t("ui.frame.btn.import") }}</el-button
        >
        <el-button @click="handleExport" v-hasPermi="['gdyy:glueOrder:export']">{{
    ...
    <tlt-upload
      ref="tltUpload"
      downloadUrl="/gdyy/glueOrder/importTemplate"
      uploadUrl="/gdyy/glueOrder/importData"
...
//interface
import { listGlueGroupOrder } from "@/api/gdyy/glueGroupOrder";
import { listGlueOrder, removeGlueOrder } from "@/api/gdyy/glueOrder";
//components
...
export default {
  ...
  methods: {
    ...
    handleExport() {
      downloadLink("/gdyy/glueOrder/export", this.formatParams(false));
    },
