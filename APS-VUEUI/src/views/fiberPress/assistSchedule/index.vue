...
<template>
  <basic-container>
    <page-table
      tableRef="fiberPressAssistScheduleMainTable"
      :calcHeight="true"
      v-loading="loading"
      :columns="columns"
    ...
    >
      <template slot="header">
        <el-button
          v-hasPermi="['xwyy:assistSchedule']"
          type="primary"
          plain
...
//interface
import { listAssistSchedule } from "@/api/xwyy/assistSchedule.js";
//components
// import TltUploadForm from "@/views/components/tltUploadForm.vue";

export default {
  name: "FiberPressAssistSchedule",
  components: {
    // TltUploadForm,
  },
  dicts: ["TASK_TYPE"],
  ...
  data() {
    return {
      searchColumns: [
        ...
        {
          label: this.$t("ui.data.column.xwyy.scheduleResult.fiberPressCode"),
          prop: "bigRollCode",
        },
        {
        ...
        { type: "selection", fixed: "left" },
        {
          ...
          children: [
            ...
            },
            {
              ...
              //  sortable: "custom",
              label: this.$t(
                "ui.data.column.xwyy.scheduleResult.fiberPressCode"
              ),
            },
            {
              prop: "wholeGlueCode",
