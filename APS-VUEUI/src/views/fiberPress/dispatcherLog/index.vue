...
<template>
  <basic-container>
    <page-table
      tableRef="fiberPressDispatcherLogMainTable"
      :calcHeight="true"
      v-loading="loading"
      :columns="columns"
    ...
    >
      <template slot="header">
        <!-- <el-button
          type="primary"
          v-hasPermi="['xwyy:dispatcherLog:add']"
          @click="handleAdd"
          >{{ $t("ui.frame.btn.add") }}</el-button
        > -->
        <!-- <el-button
          type="warning"
          v-hasPermi="['xwyy:dispatcherLog:edit']"
          @click="handleEdit(selection[0])"
          >{{ $t("ui.frame.btn.modify") }}</el-button
        > -->
        <!-- <el-button
          v-hasPermi="['xwyy:dispatcherLog:import']"
          @click="$refs.tltUpload.handleImport()"
          >{{ $t("ui.frame.btn.import") }}</el-button
        > -->
        <el-button
          @click="handleExport"
          v-hasPermi="['xwyy:dispatcherLog:export']"
    ...
    <!-- <tlt-upload
      ref="tltUpload"
      downloadUrl="/xwyy/dispatcherLog/importTemplate"
      uploadUrl="/xwyy/dispatcherLog/importData"
...
//interface
import { listDispatcherLog } from "@/api/xwyy/dispatcherLog";
//components
...
export default {
 name: "FiberPressDispatcherLog",
      ...
      let columns = [
        { type: "selection", fixed: "left" },
        {
          ...
          children: [
            ...
            {
              prop: "materialCode",
              label: this.$t("ui.data.column.xwyy.dispatcherlog.materialCode"),
              valign: "middle",
              align: "center",
              halign: "center",
             //  sortable: "custom",
  ...
  methods: {
    ...
    handleExport() {
      downloadLink("/xwyy/dispatcherLog/export", this.formatParams(false));
    },
