...
<template>
  <basic-container>
    <page-table
      tableRef="fiberPressGlueOrderMainTable"
      :calcHeight="true"
      v-loading="loading"
      :columns="columns"
    ...
    >
      <template slot="header">
        <el-button
          type="primary"
          v-hasPermi="['xwyy:glueOrder:add']"
          @click="handleAdd"
          >{{ $t("ui.frame.btn.add") }}</el-button
        >
        <!-- <el-button
          type="warning"
          v-hasPermi="['xwyy:glueOrder:edit']"
          @click="handleEdit(selection[0])"
          >{{ $t("ui.frame.btn.modify") }}</el-button
        > -->
        <el-button
          v-hasPermi="['xwyy:glueOrder:import']"
          @click="$refs.tltUpload.handleImport()"
          >{{ $t("ui.frame.btn.import") }}</el-button
        >
        <el-button @click="handleExport" v-hasPermi="['xwyy:glueOrder:export']">{{
    ...
    <tlt-upload
      ref="tltUpload"
      downloadUrl="/xwyy/glueOrder/importTemplate"
      uploadUrl="/xwyy/glueOrder/importData"
...
//interface
import { listGlueGroupOrder } from "@/api/xwyy/glueGroupOrder";
import { listGlueOrder, removeGlueOrder } from "@/api/xwyy/glueOrder";
//components
...
export default {
  ...
  methods: {
    ...
    handleExport() {
      downloadLink("/xwyy/glueOrder/export", this.formatParams(false));
    },
