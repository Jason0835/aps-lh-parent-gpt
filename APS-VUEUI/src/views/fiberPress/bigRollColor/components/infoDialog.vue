...
import { editBigRollColor,checkRollCodeUnique } from "@/api/xwyy/xwyyBigRollColor";
  ...
  computed: {
    title: function () {
      return (
        ...
        this.$t("ui.bigRollColor.column.modalName")
      );
    },
    columns() {
      return [
  ...
  methods: {
    ...
    async save(params) {
      try {
        ...
        const res = await editBigRollColor(params);
