...
<template>
  <basic-container>
    <page-table
      tableRef="fiberPressMouthPlateMainTable"
      :calcHeight="true"
      v-loading="loading"
      :columns="columns"
    ...
    >
      <template slot="header">
        <el-button
          type="primary"
          plain
          v-hasPermi="['xwyy:mouthPlate:add']"
          @click="handleAdd"
          >{{ $t("ui.frame.btn.add") }}</el-button
        >
        <!-- <el-button
          type="warning"
          v-hasPermi="['xwyy:mouthPlate:edit']"
          @click="handleEdit(selection[0])"
          >{{ $t("ui.frame.btn.modify") }}</el-button
        > -->
        <el-button
          v-hasPermi="['xwyy:mouthPlate:import']"
          @click="$refs.tltUpload.handleImport()"
          >{{ $t("ui.frame.btn.import") }}</el-button
        >
        <el-button
          @click="handleExport"
          v-hasPermi="['xwyy:mouthPlate:export']"
    ...
    <tlt-upload
      ref="tltUpload"
      downloadUrl="/xwyy/mouthPlate/importTemplate"
      uploadUrl="/xwyy/mouthPlate/importData"
...
export default {
          ...
          render: ({ row }) => {
            return (
              <div>
                ...
                <el-button
                  v-hasPermi={["xwyy:mouthPlate:remove"]}
                  class="minus"
                  type="danger"
  ...
  methods: {
    ...
    handleExport() {
      downloadLink("/xwyy/mouthPlate/export", this.formatParams(false));
    },
