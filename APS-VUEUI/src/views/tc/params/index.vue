  ...
  <basic-container>
    ...
    >
      <template slot="header">
        ...
        >
        <el-button
          v-hasPermi="['tc:tcParams:import']"
          @click="$refs.tltUpload.handleImport()"
          >{{ $t("ui.frame.btn.import") }}</el-button
        >
        <el-button
          v-hasPermi="['tc:tcParams:export']"
          @click="handleExport"
    ...
    <tlt-upload-form
      ...
      :updateSupport="true"
      downloadUrl="/tc/tcParams/importTemplate"
      labelWidth="0"
      uploadUrl="/tc/tcParams/importData"
...
//interface
import {listParams, removeParams, saveParams} from "@/api/tc/params";
//components
...
export default {
  ...
  methods: {
    ...
    handleExport() {
      downloadLink("/tc/tcParams/export", this.formatParams(false));
    },
