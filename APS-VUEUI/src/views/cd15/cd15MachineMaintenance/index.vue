  ...
  computed: {
    columns() {
      return [
        ...
        { prop: "downtimeStartTime", align: "center", halign: "center", label: this.$t("ui.data.column.cd15MachineMaintenancePlan.downtimeStartTime"), minWidth: 180 },
        { prop: "downtimeEndTime", align: "center", halign: "center", label: this.$t("ui.data.column.cd15MachineMaintenancePlan.downtimeEndTime"), minWidth: 180 },
