<template>
  <basic-container>
    ...
    <tlt-upload-form
      ref="tltUpload"
      :updateSupport="true"
      downloadUrl="/cd15/cd15Stock/importTemplate"
      uploadUrl="/cd15/cd15Stock/importData"
...
<script>
import { listStock, delStock, exportStock } from "@/api/cd15/stock";
      ...
      return [
        { type: "selection", fixed: "left" },
        {
          ...
          formatter: (row, column, value) =>
            this.selectDictLabel(this.dict.type.biz_factory_name, value),
        },
        {
          prop: "stockDate",
          align: "center",
