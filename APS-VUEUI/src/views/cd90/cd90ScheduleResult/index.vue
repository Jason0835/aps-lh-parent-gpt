  ...
  computed: {
    columns() {
      return [
        ...
        { prop: "stockQty", align: "center", halign: "center", label: this.$t("ui.data.column.cd90ScheduleResult.stockQty"), minWidth: 110 },
        { prop: "class1PlanQty", align: "center", halign: "center", label: this.$t("ui.data.column.cd90ScheduleResult.class1PlanQty"), minWidth: 110 },
        { prop: "class2PlanQty", align: "center", halign: "center", label: this.$t("ui.data.column.cd90ScheduleResult.class2PlanQty"), minWidth: 110 },
        { prop: "class3PlanQty", align: "center", halign: "center", label: this.$t("ui.data.column.cd90ScheduleResult.class3PlanQty"), minWidth: 110 },
        { prop: "isRelease", align: "center", halign: "center", label: this.$t("ui.data.column.cd90ScheduleResult.isRelease"), minWidth: 100 },
        { prop: "remark", halign: "center", label: this.$t("ui.common.column.remark"), minWidth: 120 },
      ];
    },
    searchColumns() {
      return [
        { label: this.$t("ui.data.column.cd90ScheduleResult.factoryCode"), prop: "factoryCode", type: "select", dictData: this.dict.type.biz_factory_name, filterable: true },
        { label: this.$t("ui.data.column.cd90ScheduleResult.scheduleDate"), prop: "scheduleDate" },
        { label: this.$t("ui.data.column.cd90ScheduleResult.clothCode"), prop: "clothCode", type: "select", dictData: this.clothOptions, filterable: true, clearable: true },
        { label: this.$t("ui.data.column.cd90ScheduleResult.machineCode"), prop: "machineCode", type: "select", dictData: this.machineOptions, filterable: true, clearable: true },
      ];
    },
  },
  methods: {
