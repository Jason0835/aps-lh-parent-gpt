  ...
  computed: {
    columns() {
      return [
        ...
        { prop: "factoryCode", align: "center", halign: "center", label: this.$t("ui.data.column.storageLaneLimit.factoryCode"), minWidth: 120, formatter: (row, column, value) => this.selectDictLabel(this.dict.type.biz_factory_name, value) },
        { prop: "laneDate", align: "center", halign: "center", label: this.$t("ui.data.column.storageLaneLimit.laneDate"), minWidth: 110 },
        { prop: "shiftCode", align: "center", halign: "center", label: this.$t("ui.data.column.storageLaneLimit.shiftCode"), minWidth: 90 },
        { prop: "storageLaneCode", align: "center", halign: "center", label: this.$t("ui.data.column.storageLaneLimit.storageLaneCode"), minWidth: 130 },
        { prop: "materialCode", align: "center", halign: "center", label: this.$t("ui.data.column.storageLaneLimit.materialCode"), minWidth: 150 },
        { prop: "carNum", align: "center", halign: "center", label: this.$t("ui.data.column.storageLaneLimit.carNum"), minWidth: 90 },
        { prop: "maxCarNum", align: "center", halign: "center", label: this.$t("ui.data.column.storageLaneLimit.maxCarNum"), minWidth: 90 },
        { prop: "availableCarNum", align: "center", halign: "center", label: this.$t("ui.data.column.storageLaneLimit.availableCarNum"), minWidth: 110 },
        { prop: "dataSource", align: "center", halign: "center", label: this.$t("ui.data.column.storageLaneLimit.dataSource"), minWidth: 100 },
    ...
    searchColumns() {
      return [
        { label: this.$t("ui.data.column.storageLaneLimit.factoryCode"), prop: "factoryCode", type: "select", dictData: this.dict.type.biz_factory_name, filterable: true },
        { label: this.$t("ui.data.column.storageLaneLimit.laneDate"), prop: "laneDate" },
        { label: this.$t("ui.data.column.storageLaneLimit.shiftCode"), prop: "shiftCode" },
        { label: this.$t("ui.data.column.storageLaneLimit.storageLaneCode"), prop: "storageLaneCode" },
      ];
    },
  },
  methods: {
