...
<script>
import { listCd90MachineInfo, delCd90MachineInfo, exportCd90MachineInfo } from "@/api/cd90/cd90MachineInfo";
    ...
    columns() {
      return [
        ...
        },
        {
          ...
          minWidth: 100,
          formatter: (row, column, value) => this.selectDictLabel(this.dict.type.sys_enable_disable, value),
        },
        {
          prop: "remark",
          halign: "center",
