...
<template>
  <basic-container>
    <page-table
      tableRef="ncDispatcherLogMainTable"
      :calcHeight="true"
      v-loading="loading"
      :columns="columns"
...
export default {
          ...
          children: [
            {
              ...
              label: this.$t("ui.data.column.nc.dispatcherlog.beforeMachineCode"),
              valign: "middle",
              align: "center",
              halign: "center",
            },
            {
              ...
              label: this.$t("ui.data.column.nc.dispatcherlog.beforeClass1PlanQty"),
              valign: "middle",
              align: "right",
              halign: "center",
              type: "number",
            },
            {
              ...
              label: this.$t("ui.data.column.nc.dispatcherlog.beforeClass2PlanQty"),
              valign: "middle",
              align: "right",
              halign: "center",
              type: "number",
            },
            {
              ...
              label: this.$t("ui.data.column.nc.dispatcherlog.beforeClass3PlanQty"),
              valign: "middle",
              align: "right",
              halign: "center",
              type: "number",
  ...
  created() {
    getConfigKey("sys.factory.code").then(response => {
      ...
      this.$store.dispatch("nc/getMachineList");
    }).catch(() => {
      this.$store.dispatch("nc/getMachineList");
    });
  },
