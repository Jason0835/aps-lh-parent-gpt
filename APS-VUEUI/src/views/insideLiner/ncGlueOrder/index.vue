...
<template>
  <basic-container>
    <page-table
      tableRef="insideLinerGroupOrderMainTable"
      :calcHeight="true"
      v-loading="loading"
      :columns="columns"
    ...
    >
      <template slot="header">
        <el-button
          type="primary"
          v-hasPermi="['nc:glueOrder:add']"
          @click="handleAdd"
          >{{ $t("ui.frame.btn.add") }}</el-button
        >
        <el-button
          v-hasPermi="['nc:glueOrder:remove']"
          type="danger"
        ...
        > -->
        <el-button
          v-hasPermi="['nc:glueOrder:import']"
          @click="$refs.tltUpload.handleImport()"
          >{{ $t("ui.frame.btn.import") }}</el-button
        >
        <el-button @click="handleExport" v-hasPermi="['nc:glueOrder:export']">{{
...
export default {
  ...
  methods: {
    ...
    handleExport() {
      downloadLink("/nc/glueOrder/export", this.formatParams(false));
    },
