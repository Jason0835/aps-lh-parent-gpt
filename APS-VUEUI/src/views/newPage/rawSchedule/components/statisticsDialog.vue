  ...
  data() {
    return {
      ...
      columns: [
        ...
        {
          label: this.$t("schedule.glueScheduleResult.totalPlanQty.statistics"),
        ...
        {
          label: this.$t("schedule.glueScheduleResult.totalSurplus.statistics"),
          prop: "totalSurplusStatistics",
          span: 24,
          type: "select",
        },
        {
          label: this.$t("schedule.glueScheduleResult.midPlanQty.statistics"),
          prop: "midPlanQtyStatistics",
          span: 24,
        },
        {
          label: this.$t("schedule.glueScheduleResult.nightPlanQty.statistics"),
          prop: "nightPlanQtyStatistics",
          span: 24,
        },
        {
          label: this.$t("schedule.glueScheduleResult.dayPlanQty.statistics"),
      ...
      searchColumns: [
        {
          label: this.$t("schedule.glueScheduleResult.machineName.short"),
          prop: "machineCode",
          type: "select"
        },
