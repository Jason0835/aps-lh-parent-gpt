...
<template>
  <basic-container>
    <page-table
      tableRef="treadMachineMainTable"
      :calcHeight="true"
      v-loading="loading"
      :columns="columns"
    ...
    >
      <template slot="header">
        ...
        > -->
        <el-button
          v-hasPermi="['tm:machine:import']"
          @click="() => $refs.tltUploadForm.handleImport(importDefaultValue)"
          >{{ $t("ui.frame.btn.import") }}</el-button
        >
        <el-button v-hasPermi="['tm:machine:export']" @click="handleExport">{{
    ...
    <tlt-upload-form
      ref="tltUploadForm"
      title="导入机台信息数据"
      downloadUrl="/tm/machine/importTemplate"
      uploadUrl="/tm/machine/importData"
...
import {editMachine, exportData, listMachine, removeApsMoldAdjustPlan,} from "@/api/tm/machine";
