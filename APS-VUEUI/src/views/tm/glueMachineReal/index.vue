<template>
  <basic-container>
    ...
    >
      <template slot="header">
        <el-button
          type="primary"
          plain
          v-hasPermi="['tm:tmGlueMachineReal:edit']"
          @click="handleAdd"
        >{{ $t("ui.frame.btn.add") }}</el-button>
        <el-button
          type="danger"
          v-hasPermi="['tm:tmGlueMachineReal:remove']"
          :disabled="selection.length == 0"
          @click="handleDeleteAll"
        >{{ $t("ui.frame.btn.delete") }}</el-button>
        <el-button
          v-hasPermi="['tm:tmGlueMachineReal:import']"
          @click="$refs.tltUpload.handleImport()"
        >{{ $t("ui.frame.btn.import") }}</el-button>
        <el-button
          @click="handleExport"
          v-hasPermi="['tm:tmGlueMachineReal:export']"
    ...
    <tlt-upload-form
      ref="tltUpload"
      :updateSupport="true"
      downloadUrl="/tm/tmGlueMachineReal/importTemplate"
      uploadUrl="/tm/tmGlueMachineReal/importData"
...
export default {
  ...
  methods: {
    ...
    handleExport() {
      downloadLink("/tm/tmGlueMachineReal/export", this.formatParams(false));
    },
