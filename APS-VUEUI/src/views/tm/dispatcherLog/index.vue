...
<template>
  <basic-container>
    <page-table
      tableRef="tmDispatcherLogMainTable"
      :calcHeight="true"
      v-loading="loading"
      :columns="columns"
    ...
    >
      <template slot="header">
        <el-button
          @click="handleExport"
          v-hasPermi="['tm:tmDispatcherLog:export']"
...
import {listDispatcherLog} from "@/api/tm/dispatcherLog";
...
export default {
  ...
  computed: {
    ...
    columns() {
      return [
        ...
        {
          align: "center",
          label: this.$t("ui.data.column.tm.dispatcherLog.baseInfo"),
          children: [
            {
              prop: "operType",
              label: this.$t("ui.data.column.tm.dispatcherLog.operType"),
              valign: "middle",
              align: "center",
              halign: "center",
            ...
            {
              prop: "scheduleDate",
              label: this.$t("ui.data.column.tm.dispatcherLog.scheduleDate"),
              valign: "middle",
              align: "center",
              halign: "center",
              minWidth: 120,
            ...
            {
              prop: "treadCode",
              label: this.$t("ui.data.column.tm.dispatcherLog.treadCode"),
              valign: "middle",
              align: "center",
              halign: "center",
              minWidth: 160,
        ...
        {
          align: "center",
          label: this.$t("ui.data.column.tm.dispatcherLog.beforeOper"),
          children: [
            {
              prop: "beforeMachineCode",
              label: this.$t("ui.data.column.tm.dispatcherLog.machineCode"),
              valign: "middle",
              align: "center",
              halign: "center",
              width: 200,
            ...
            },
            {
              ...
              label: this.$t("ui.data.column.tm.dispatcherLog.class1PlanQty"),
              valign: "middle",
              align: "center",
              halign: "center",
            },
            {
              ...
              label: this.$t("ui.data.column.tm.dispatcherLog.class2PlanQty"),
              valign: "middle",
              align: "center",
              halign: "center",
            },
            {
              ...
              label: this.$t("ui.data.column.tm.dispatcherLog.class3PlanQty"),
              valign: "middle",
              align: "center",
              halign: "center",
            },
            {
              ...
              label: this.$t("ui.data.column.tm.dispatcherLog.class4PlanQty"),
              valign: "middle",
              align: "center",
              halign: "center",
            },
            {
              ...
              label: this.$t("ui.data.column.tm.dispatcherLog.class5PlanQty"),
              valign: "middle",
              align: "center",
              halign: "center",
            },
            {
              ...
              label: this.$t("ui.data.column.tm.dispatcherLog.class6PlanQty"),
              valign: "middle",
              align: "center",
              halign: "center",
            },
        ...
        {
          align: "center",
          label: this.$t("ui.data.column.tm.dispatcherLog.afterOper"),
          children: [
            {
  ...
  methods: {
    ...
    handleExport() {
      downloadLink("/tm/tmDispatcherLog/export", this.formatParams(false));
    },
    ...
    async loadMachineList() {
      try {
        const data = await listTmMachineInfo({ pageSize: 9999, pageNum: 1 });
