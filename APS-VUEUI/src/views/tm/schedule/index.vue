...
<template>
  <basic-container>
      ...
      <template slot="header">
        ...
        <el-dropdown>
          ...
          <el-dropdown-menu slot="dropdown">
            ...
            <el-dropdown-item v-hasPermi="['tm:finishQty:import']">
              <el-button
                type="primary"
                class="more-btn"
            ...
            <el-dropdown-item v-hasPermi="['tm:halfYcImportBak:importData']">
              <el-button
                type="primary"
                class="more-btn"
                @click="$refs.tltUpload4.handleImport()"
              >
                {{ $t("导入线下排程") }}
              </el-button>
            </el-dropdown-item>
            <el-dropdown-item v-hasPermi="['tm:halfYcImportBak:importData']">
              <el-button
                type="primary"
                class="more-btn"
                @click="$refs.tltUpload5.handleImport()"
              >
                {{ $t("导出排程结果") }}
              </el-button>
            </el-dropdown-item>
    ...
    <tlt-upload-form
      ...
      uploadUrl="/tm/tmScheduleResult/importScheduleData"
    ...
    <tlt-upload-form
      ref="tltUploadForm2"
      title="导入胎面排程结果数据"
      uploadUrl="/tm/tmScheduleResult/importScheduleData2"
      @uploadSuccess="getList"
      :columns="[
        {
          label: '排程日期',
    ...
    <tlt-upload-form
      ref="tltUploadForm3"
      title="导入胎面排程结果数据"
      uploadUrl="/tm/tmScheduleResult/importFinishQty"
      downloadUrl="/tm/tmScheduleResult/importFinishQtyTemplate"
      @uploadSuccess="getList"
      :columns="[
        {
          label: '排程日期',
    ...
    <tlt-upload
      ref="tltUpload4"
      title="导入"
      uploadUrl="/tm/halfYcImportBak/importData"
      @uploadSuccess="getList"
    />
    <tlt-upload-download
      ref="tltUpload5"
      title="导入"
      uploadUrl="/tm/halfYcImportBak/importExcelToListAndExport"
      @uploadSuccess="getList"
    />
  </basic-container>
</template>
...
//interface
import {getSummaryVo, listTmScheduleResult, publishScheduleResult, removeTmScheduleResult, validateConstruction,} from "@/api/tm/tmScheduleResult";
//components
import TltUploadForm from "@/views/components/tltUploadForm.vue";
import tltUploadDownload from "@/views/components/tltUploadDownload.vue";
