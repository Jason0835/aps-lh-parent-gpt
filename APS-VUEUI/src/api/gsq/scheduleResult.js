...
export function listCandidateMachines(id) {
  return request({
    url: '/gsq/scheduleResult/listCandidateMachines/' + id,
    method: 'post'
  })
}
...
export function insertTask(data) {
  return request({
    url: '/gsq/scheduleResult/insertTask',
    method: 'post',
    data: data
  })
}
...
export function batchChangeMachine(data) {
  return request({
    url: '/gsq/scheduleResult/batchChangeMachine',
    method: 'post',
    data: data
  })
}
...
export function batchChangeQty(data) {
  return request({
    url: '/gsq/scheduleResult/batchChangeQty',
    method: 'post',
    data: data
  })
}
...
export function batchDelete(ids) {
  return request({
    url: '/gsq/scheduleResult/batchDelete',
    method: 'post',
    data: ids
  })
}
