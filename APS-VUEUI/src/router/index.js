    ...
    children: [
      {
        ...
        meta: { title: "单机班产额度配置", i18n: "ui.data.column.singleMachineQuota.title" },
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        meta: { title: "生成备货计划", i18n: "ui.data.column.stockPlan.generate" },
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        hidden: true,
        meta: { title: "硫化未排程结果", i18n: "ui.data.column.vulcanizationUnscheduled.title" },
      },
      {
        ...
        hidden: true,
        meta: { title: "未排结果", i18n: "ui.data.btn.scheduleResult.unscheduledResult" },
      },
      {
        ...
        hidden: true,
        meta: { title: "机台甘特图", i18n: "ui.data.column.scheduleResult.machine.gantt" },
      },
      {
        ...
        hidden: true,
        meta: { title: "规格甘特图", i18n: "ui.data.column.scheduleResult.specDesc.gantt" },
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        hidden: true,
        meta: { title: "成型未排程结果", i18n: "ui.data.column.moldingUnscheduled.title" },
      },
      {
        ...
        hidden: true,
        meta: { title: "成型排程顺位", i18n: "ui.frame.btn.moldingScheduleSequence" },
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        meta: { title: "排结构明细", i18n: "ui.data.column.productionMonthPlanInit.title" },
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        meta: { title: "明细", i18n: "ui.data.column.detail" },
      },
    ],
  },
  /** 月计划结构内调整、结构调整 */
    ...
    children: [
      {
        ...
        meta: { title: "排程明细", i18n: "ui.data.column.scheduleResult.detail" },
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        meta: { title: "未排产排程明细", i18n: "ui.data.column.monthPlanNoProduction.detail" },
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        name: "versionReport",
        meta: { title: "报表", i18n: "ui.data.column.report" },
      },
    ],
  },
  {
