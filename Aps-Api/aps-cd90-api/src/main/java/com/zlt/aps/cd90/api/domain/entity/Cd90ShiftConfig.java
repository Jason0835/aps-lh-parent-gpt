...
@TableName("t_cd90_shift_config")
public class Cd90ShiftConfig extends BaseEntity implements Serializable {
    ...
    @Excel(name = "ui.data.column.cd90ShiftConfig.factoryCode", dictType = "biz_factory_name")
    ...
    @Excel(name = "ui.data.column.cd90ShiftConfig.shiftCode")
    private String shiftCode;

    /** 班次名称 */
    @ApiModelProperty(value = "班次名称", name = "shiftName")
    @TableField("SHIFT_NAME")
    @Excel(name = "ui.data.column.cd90ShiftConfig.shiftName")
    private String shiftName;

    /** 班次序号 */
    @ApiModelProperty(value = "班次序号", name = "shiftOrder")
    @TableField("SHIFT_ORDER")
    @Excel(name = "ui.data.column.cd90ShiftConfig.shiftOrder")
    ...
    @Excel(name = "ui.data.column.cd90ShiftConfig.startTime")
    ...
    @ImportExcelValidated(required = true, maxLength = 32)
    @TableField("END_TIME")
    @Excel(name = "ui.data.column.cd90ShiftConfig.endTime")
