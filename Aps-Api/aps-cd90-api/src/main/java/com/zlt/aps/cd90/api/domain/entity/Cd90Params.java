...
public class Cd90Params extends BaseEntity implements Serializable {
    ...
    @Excel(name = "ui.data.column.params.factoryCode", dictType = "biz_factory_name")
    ...
    @Excel(name = "ui.data.column.params.paramCode")
    ...
    @Excel(name = "ui.data.column.params.paramName")
    ...
    @Excel(name = "ui.data.column.params.paramValue")
    ...
    @Excel(name = "ui.data.column.params.regularExpression")
    ...
    @Excel(name = "ui.data.column.params.errorTips")
