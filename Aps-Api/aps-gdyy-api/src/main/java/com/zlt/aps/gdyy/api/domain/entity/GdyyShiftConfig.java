 ...
 */
@Data
@ApiModel(value = "钢带压延班次配置", description = "钢带压延班次配置")
@TableName("t_gdyy_shift_config")
public class GdyyShiftConfig extends BaseEntity implements Serializable {
    ...
    @Excel(name = "ui.data.column.gdyyShiftConfig.factoryCode", dictType = "biz_factory_name")
    ...
    @Excel(name = "ui.data.column.gdyyShiftConfig.shiftCode")
    private String shiftCode;

    /** 班次名称 */
    @ApiModelProperty(value = "班次名称", name = "shiftName")
    @TableField("SHIFT_NAME")
    @Excel(name = "ui.data.column.gdyyShiftConfig.shiftName")
    private String shiftName;

    /** 班次序号 */
    @ApiModelProperty(value = "班次序号", name = "shiftOrder")
    @TableField("SHIFT_ORDER")
    @Excel(name = "ui.data.column.gdyyShiftConfig.shiftOrder")
    ...
    @Excel(name = "ui.data.column.gdyyShiftConfig.startTime")
    ...
    @ImportExcelValidated(required = true, maxLength = 32)
    @TableField("END_TIME")
    @Excel(name = "ui.data.column.gdyyShiftConfig.endTime")
    ...
    @Excel(name = "ui.data.column.gdyyShiftConfig.isActive", dictType = "sys_enable_disable")
