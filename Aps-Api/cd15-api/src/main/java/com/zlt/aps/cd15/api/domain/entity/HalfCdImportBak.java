...
@Data
@TableName(value = "HALF_CD_IMPORT_BAK")
public class HalfCdImportBak extends BaseEntity {
     ...
     * 角度
     */
    @Excel(name = "ui.data.column.halfCdImportBak.gd3_1")
    @ApiModelProperty(value = "角度", name = "gd3_1")
    @TableField(exist = false)
    private Double gd3_1;
