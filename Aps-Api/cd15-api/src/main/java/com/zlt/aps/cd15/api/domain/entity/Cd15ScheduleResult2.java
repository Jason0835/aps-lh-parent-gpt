...
public class Cd15ScheduleResult2 extends ApsBaseEntity{
    ...
    @Excel(name = "ui.data.column.scheduleResult.dayPlanQty.planMeter")
    ...
    /** 1#钢带中班(12点-24点)生产顺序 */
    //@Excel(name = "ui.data.column.cd15ScheduleResult.dayProduceOrder1")
