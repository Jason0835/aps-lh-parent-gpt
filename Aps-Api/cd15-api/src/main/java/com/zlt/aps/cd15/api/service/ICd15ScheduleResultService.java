...
public interface ICd15ScheduleResultService {
    ...
    */
     ...
     * @return 结果
     */
    @PostMapping("/cd15ScheduleResult/importFinishQty")
    @ApiOperation("导入完成量")
    AjaxResult importFinishQty(@RequestBody List<Cd15DayFinishQty> list, @RequestParam("importLogId") Long importLogId);
     ...
     * @return 结果
     */
    @PostMapping("/cd15ScheduleResult/getSummaryVo")
