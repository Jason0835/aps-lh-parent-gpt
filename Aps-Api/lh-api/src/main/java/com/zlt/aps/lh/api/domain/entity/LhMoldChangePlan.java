...
@Data
public class LhMoldChangePlan extends ApsBaseEntity {
    ...
    @Excel(name = "ui.data.column.moldChange.lhMachineName", importName = "ui.data.column.machine.machineCode")
    @ApiModelProperty(value = "硫化机台名称", position = 40)
    private String lhMachineName;

    /**
     * 前规格品号
     */
    @ImportValidated(maxLength = 333, isCode = true)
