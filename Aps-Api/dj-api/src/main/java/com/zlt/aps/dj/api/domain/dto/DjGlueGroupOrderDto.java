...
@ApiModel(value="NcGlueGroupOrder对象", description="垫胶胶料组别顺序维护")
public class DjGlueGroupOrderDto extends ApsBaseDto implements Serializable {
    ...
    @ImportValidated(name = "ui.glueGroup.column.orderNum", required = true, digits = true,min = 0, max = 999)
