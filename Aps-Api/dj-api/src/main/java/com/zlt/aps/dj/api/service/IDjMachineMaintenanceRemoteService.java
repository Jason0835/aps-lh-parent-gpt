 ...
 * 垫胶机台维修计划对外暴露接口
 */
@FeignClient(contextId = "iDjMachineMaintenanceRemoteService", value = ServiceNameConstants.GATEWAY_SERVICE, path = "${api.path.dj:dj}")
public interface IDjMachineMaintenanceRemoteService {
