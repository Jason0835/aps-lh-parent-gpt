 ...
 */
@Data
@ApiModel(value="NcSpecifyMachine对象", description="垫胶定点机台表")
public class DjSpecifyMachineDto extends ApsBaseDto implements Serializable {
    ...
    @ImportExcelValidated(name = "ui.data.column.stock.remark", maxLength = 300)
