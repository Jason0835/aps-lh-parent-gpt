 ...
 * @since 2021-06-01
 */
@FeignClient(contextId = "INcMouthPlateRemoteService", value = ServiceNameConstants.GATEWAY_SERVICE, path="${api.path.nc:nc}")
public interface INcMouthPlateRemoteService {
