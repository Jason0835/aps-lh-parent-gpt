 ...
 * @date 2022-02-25
 */
@FeignClient(contextId = "INcDispatcherLogRemoteService", value =ServiceNameConstants.GATEWAY_SERVICE, path="${api.path.nc:nc}")
public interface INcDispatcherLogRemoteService {
