...
public class NcScheduleResult2 extends ApsBaseEntity {
    ...
    @Excel(name = "ui.construction.lining")
   ...
   ////@Excel(name = "中班(12点-24点)系统原因分析")
    ...
    @Excel(name = "ui.construction.remark")
   ...
   ////@Excel(name = "夜班(0点-12点)系统原因分析")
     ...
     */
    @ImportValidated(maxLength = 100)
    @Excel(name = "ui.construction.remark2")
