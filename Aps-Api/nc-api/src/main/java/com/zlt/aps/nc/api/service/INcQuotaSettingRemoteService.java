 ...
 * @date 2021-06-29
 */
@FeignClient(contextId = "INcQuotaSettingRemoteService", value =ServiceNameConstants.GATEWAY_SERVICE, path = "${api.path.nc:nc}")
public interface INcQuotaSettingRemoteService {
