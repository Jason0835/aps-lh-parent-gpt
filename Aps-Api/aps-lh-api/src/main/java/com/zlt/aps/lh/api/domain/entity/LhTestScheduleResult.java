 ...
 * 文件名称：LhTestScheduleResult.java
...
@ApiModel(value = "TEST硫化排程结果对象", description = "硫化排程结果对象 ")
@Data
@TableName(value = "T_TEST_SCHEDULE_RESULT")
public class LhTestScheduleResult extends BaseEntity implements Serializable {
    ...
    @Excel(name = "ui.data.column.result.factoryCode")
    ...
    @Excel(name = "ui.data.column.result.productCode")
    ...
    @Excel(name = "ui.data.column.lhScheduleResult.isDelivery",dictType = "IS_HAVE")
    ...
    @ApiModelProperty(value = "单班单模产能", name = "singleMoldShiftLhQty")
