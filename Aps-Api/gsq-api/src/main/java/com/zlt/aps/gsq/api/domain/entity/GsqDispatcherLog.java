...
@KeySequence(value = "SEQ_T_GSQ_DISPATCHER_LOG", clazz = Long.class)
public class GsqDispatcherLog extends ApsBaseEntity{
    ...
    /** 钢丝圈代码 */
    @Excel(name = "ui.data.column.gsq.dispatcherlog.materialCode")
    @ApiModelProperty(value = "钢丝圈代码")
    private String materialCode;

    /** 操作前机台ID,多个逗号分割 */
    @Excel(name = "ui.data.column.gsq.dispatcherlog.beforeMachineId")
    @ApiModelProperty(value = "操作前机台ID,多个逗号分割")
    private String beforeMachineId;

    /** 操作前白班计划量 */
    @Excel(name = "ui.data.column.gsq.dispatcherlog.beforeMidPlan")
    @ApiModelProperty(value = "操作前中班计划量")
    private Double beforeMidPlan;

    /** 操作前白班计划量 */
    @Excel(name = "ui.data.column.gsq.dispatcherlog.beforeDayPlan")
    @ApiModelProperty(value = "操作前白班计划量")
    private Double beforeDayPlan;

    /** 操作前夜班计划量 */
    @Excel(name = "ui.data.column.gsq.dispatcherlog.beforeNightPlan")
    @ApiModelProperty(value = "操作前夜班计划量")
    private Double beforeNightPlan;

    /** 操作后机台ID,多个逗号分割 */
    @Excel(name = "ui.data.column.gsq.dispatcherlog.afterMachineId")
    @ApiModelProperty(value = "操作后机台ID,多个逗号分割")
    private String afterMachineId;

    /** 操作后中班计划量 */
    @Excel(name = "ui.data.column.gsq.dispatcherlog.afterMidPlan")
    @ApiModelProperty(value = "操作后中班计划量")
    private Double afterMidPlan;

    /** 操作后白班计划量 */
    @Excel(name = "ui.data.column.gsq.dispatcherlog.afterDayPlan")
    @ApiModelProperty(value = "操作后白班计划量")
    private Double afterDayPlan;

    /** 操作后夜班计划量 */
    @Excel(name = "ui.data.column.gsq.dispatcherlog.afterNightPlan")
