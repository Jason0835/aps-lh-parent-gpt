...
public interface IGsqQuotaSettingService {
    ...
    */
     ...
     * 校验钢丝圈定额设定唯一性
     */
    @PostMapping("/gsq/quota/checkGsqQuotaSettingUnique")
