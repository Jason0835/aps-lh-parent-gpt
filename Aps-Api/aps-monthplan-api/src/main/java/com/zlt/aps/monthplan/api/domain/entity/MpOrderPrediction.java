...
public class MpOrderPrediction extends BaseEntity {
     ...
     * 生产分厂编号
     */
    @Excel(name = "ui.data.column.mpOrderPrediction.factoryCode", dictType = "biz_factory_name")
     ...
     * 年份
     */
    @Excel(name = "ui.data.column.mpOrderPrediction.year")
     ...
     * 月份
     */
    @Excel(name = "ui.data.column.mpOrderPrediction.month")
     ...
     */
    @Excel(name = "ui.data.column.mpOrderPrediction.productTypeCode", dictType = "biz_product_type")
     ...
     * 库位类别 1 内销 2 外销 3 OE
     */
    @Excel(name = "ui.data.column.mpOrderPrediction.locationType", dictType = "biz_stor_type")
     ...
     * 品牌
     */
    @Excel(name = "ui.data.column.mpOrderPrediction.brand", dictType = "biz_brand_type")
     ...
     * MES物料编码
     */
    @Excel(name = "ui.data.column.mpOrderPrediction.mesMaterialCode")
     ...
     * 物料编码
     */
    @Excel(name = "ui.data.column.mpOrderPrediction.materialCode")
     ...
     * 物料描述
     */
    @Excel(name = "ui.data.column.mpOrderPrediction.materialDesc")
     ...
     * 第1个月排产量
     */
    @Excel(name = "ui.data.column.mpOrderPrediction.month1")
     ...
     * 第2个月排产量
     */
    @Excel(name = "ui.data.column.mpOrderPrediction.month2")
     ...
     * 第3个月排产量
     */
    @Excel(name = "ui.data.column.mpOrderPrediction.month3")
     ...
     * 预测版本号
     */
    @Excel(name = "ui.data.column.mpOrderPrediction.predictionVersion")
     ...
     * 预测需求版本号
     */
    @Excel(name = "ui.data.column.mpOrderPrediction.monthPlanVersion")
     ...
     * 预测排产计划版本
     */
    @Excel(name = "ui.data.column.mpOrderPrediction.productionVersion")
     ...
     * 产品结构
     */
    @Excel(name = "ui.data.column.mpOrderPrediction.structureName")
     ...
     * 规格
     */
    @Excel(name = "ui.data.column.mpOrderPrediction.specifications")
     ...
     * 花纹
     */
    @Excel(name = "ui.data.column.mpOrderPrediction.pattern")
     ...
     * 主花纹
     */
    @Excel(name = "ui.data.column.mpOrderPrediction.mainPattern")
     ...
     * 主物料
     */
    @Excel(name = "ui.data.column.mpOrderPrediction.mainMaterialDesc")
     ...
     * 模具数量(同主花纹的模具数量)
     */
    @Excel(name = "ui.data.column.mpOrderPrediction.mouldQty")
     ...
     * 活块数量(同主花纹的物料模具数量)
     */
    @Excel(name = "ui.data.column.mpOrderPrediction.typeBlockQty")
     ...
     * 净需求
     */
    @Excel(name = "ui.data.column.mpOrderPrediction.netQty")
     ...
     * 高优先级数量
     */
    @Excel(name = "ui.data.column.mpOrderPrediction.hightQty")
     ...
     * 排产总量
     */
    @Excel(name = "ui.data.column.mpOrderPrediction.productionQty")
     ...
     * 计划类型
     */
    @Excel(name = "ui.data.column.mpOrderPrediction.planType")
