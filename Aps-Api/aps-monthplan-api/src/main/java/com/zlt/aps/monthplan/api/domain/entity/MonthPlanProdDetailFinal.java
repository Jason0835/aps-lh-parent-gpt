 ...
 * 文件名称：MonthPlanProdDetailFinal.java
 * 描    述：分厂月生产计划排产结果-生产计划排产结果对象 t_mp_month_plan_prod_detail_final
 *
 * @author zlt
 * @version 1.0
 * <p>
...
@Data
@TableName(value = "T_MP_MONTH_PLAN_PROD_DETAIL_FINAL")
@ApiModel(value = "分厂月生产计划排产结果-生产计划排产结果对象", description = "分厂月生产计划排产结果-生产计划排产结果对象 ")
public class MonthPlanProdDetailFinal extends BaseEntity {
     ...
     * 生产分厂编号
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.factoryCode")
     ...
     * 年份
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.year")
     ...
     * 月份
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.month")
     ...
     * 年月:YYYYMM
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.yearMonth")
     ...
     * 销售生产需求计划版本
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.monthPlanVersion")
     ...
     * 分厂版本
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.productionVersion")
     ...
     * 生产物料编号
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.productCode")
     ...
     * 生产规格描述
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.productDesc")
     ...
     * 库位类别
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.locationType")
     ...
     * 渠道
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.channel")
     ...
     * 品牌
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.brand")
     ...
     * 规格
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.specifications")
     ...
     * 花纹
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.pattern")
     ...
     * 层级
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.hierarchy")
     ...
     * 寸口
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.proSize")
     ...
     * 品名编码
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.productTypeCode")
     ...
     * 品名
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.productTypeName")
     ...
     * 等级码
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.levelCode")
     ...
     * 等级名称
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.levelName")
     ...
     * 是否重要客户 0 不重要 1 重要
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.isImportantCustom")
     ...
     * 是否必保计划 0 不必保 1 必保
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.isEnsurePlan")
     ...
     * 是否紧急订单 0 不紧急 1 紧急
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.isEmergency")
     ...
     * 是否欠产（0：默认不是，1：是）
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.isDebitPlan", readConverterExp = "0=：默认不是，1：是")
     ...
     * 是否备货 0 不是 1 是
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.isStockUp")
    ...
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.deliveryDateDue", width = 30, dateFormat = "yyyy-MM-dd")
     ...
     * 利润等级
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.profitGrade")
     ...
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.isImport", readConverterExp = "0=：默认不是，1：是")
     ...
     * 模具
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.mouldNo")
     ...
     * 模具号
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.mouldCode")
     ...
     * 规格代号
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.specCode")
     ...
     * 生胎代码
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.embryoCode")
     ...
     * 排产顺序
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.productionSequence")
     ...
     * 单条硫化时间(包含增加间隔)
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.curingTime")
    @ApiModelProperty(value = "单条硫化时间(包含增加间隔)", name = "curingTime")
     ...
     * 生产需求计划
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.prodReqPlan")
     ...
     * 实际生产需求(含损耗)
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.factProdReqQty")
     ...
     * 生产实际排产量
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.totalQty")
     ...
     * 差异量(未排产数量)
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.differenceQty")
     ...
     * 未排产原因
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.reason")
     ...
     * 模数
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.mouldQty")
     ...
     * 开始日期
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.beginDate")
     ...
     * 结束日期
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.endDay")
     ...
     * PRE_DAY_1
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.preDay1")
     ...
     * PRE_DAY_2
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.preDay2")
     ...
     * PRE_DAY_3
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.preDay3")
     ...
     * PRE_DAY_4
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.preDay4")
     ...
     * PRE_DAY_5
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.preDay5")
     ...
     * PRE_DAY_6
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.preDay6")
     ...
     * PRE_DAY_7
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.preDay7")
     ...
     * DAY_1
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.day1")
     ...
     * DAY_2
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.day2")
     ...
     * DAY_3
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.day3")
     ...
     * DAY_4
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.day4")
     ...
     * DAY_5
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.day5")
     ...
     * DAY_6
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.day6")
     ...
     * DAY_7
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.day7")
     ...
     * DAY_8
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.day8")
     ...
     * DAY_9
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.day9")
     ...
     * DAY_10
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.day10")
     ...
     * DAY_11
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.day11")
     ...
     * DAY_12
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.day12")
     ...
     * DAY_13
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.day13")
     ...
     * DAY_14
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.day14")
     ...
     * DAY_15
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.day15")
     ...
     * DAY_16
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.day16")
     ...
     * DAY_17
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.day17")
     ...
     * DAY_18
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.day18")
     ...
     * DAY_19
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.day19")
     ...
     * DAY_20
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.day20")
     ...
     * DAY_21
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.day21")
     ...
     * DAY_22
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.day22")
     ...
     * DAY_23
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.day23")
     ...
     * DAY_24
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.day24")
     ...
     * DAY_25
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.day25")
     ...
     * DAY_26
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.day26")
     ...
     * DAY_27
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.day27")
     ...
     * DAY_28
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.day28")
     ...
     * DAY_29
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.day29")
     ...
     * DAY_30
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.day30")
     ...
     * DAY_31
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.day31")
     ...
     * 硫化总工时
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.totalVulcanizationMinutes")
     ...
     * 显示顺序
     */
    @Excel(name = "ui.data.column.monthPlanProdDetailFinal.displaySeq")
