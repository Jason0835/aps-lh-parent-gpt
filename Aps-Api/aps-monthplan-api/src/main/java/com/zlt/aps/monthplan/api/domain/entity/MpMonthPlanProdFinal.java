 ...
 * 文件名称：MpMonthPlanProdFinal.java
...
public class MpMonthPlanProdFinal extends BaseEntity{

    private static final long serialVersionUID = 1L;

     /** 工单号(MP两位年两位月两位日两位批次号5位流水) */
    @Excel(name = "ui.data.column.mpMonthPlanProdFinal.productionNo")
    @ApiModelProperty(value = "工单号(MP两位年两位月两位日两位批次号5位流水)", name = "productionNo")
    @TableField(value = "PRODUCTION_NO")
    private String productionNo;

    /** 工厂编码 */
    @Excel(name = "ui.data.column.mpMonthPlanProdFinal.factoryCode", dictType = "biz_factory_name")
    ...
    /** 年份 */
    @Excel(name = "ui.data.column.mpMonthPlanProdFinal.year")
    @ApiModelProperty(value = "年份", name = "year")
    @TableField(value = "YEAR")
    private Integer year;

    /** 月份 */
    @Excel(name = "ui.data.column.mpMonthPlanProdFinal.month")
    @ApiModelProperty(value = "月份", name = "month")
    @TableField(value = "MONTH")
    private Integer month;

    /** 年月:YYYYMM */
    @Excel(name = "ui.data.column.mpMonthPlanProdFinal.yearMonth")
    @ApiModelProperty(value = "年月:YYYYMM", name = "yearMonth")
    @TableField(value = "YEAR_MONTH")
    private Integer yearMonth;

    /** 销售生产需求计划版本 */
    @Excel(name = "ui.data.column.mpMonthPlanProdFinal.monthPlanVersion")
    @ApiModelProperty(value = "销售生产需求计划版本", name = "monthPlanVersion")
    @TableField(value = "MONTH_PLAN_VERSION")
    private String monthPlanVersion;

    /** 排产计划版本 */
    @Excel(name = "ui.data.column.mpMonthPlanProdFinal.productionVersion")
    @ApiModelProperty(value = "排产计划版本", name = "productionVersion")
    @TableField(value = "PRODUCTION_VERSION")
    private String productionVersion;

    /** 产品品类 数据字典：biz_product_type TBR 全钢 PCR 半钢 */
    @Excel(name = "ui.data.column.mpMonthPlanProdFinal.productTypeCode")
    @ApiModelProperty(value = "产品品类 数据字典：biz_product_type TBR 全钢 PCR 半钢", name = "productTypeCode")
    @TableField(value = "PRODUCT_TYPE_CODE")
    private String productTypeCode;

    /** 产品状态 */
    @Excel(name = "ui.data.column.mpMonthPlanProdFinal.productStatus")
    @ApiModelProperty(value = "产品状态", name = "productStatus")
    @TableField(value = "PRODUCT_STATUS")
    private String productStatus;

    /** 产品结构 */
    @Excel(name = "ui.data.column.mpMonthPlanProdFinal.structureName")
    @ApiModelProperty(value = "产品结构", name = "structureName")
    @TableField(value = "STRUCTURE_NAME")
    private String structureName;

    /** 主物料(胎胚号) */
    @Excel(name = "ui.data.column.mpMonthPlanProdFinal.mainMaterialDesc")
    @ApiModelProperty(value = "主物料(胎胚号)", name = "mainMaterialDesc")
    @TableField(value = "MAIN_MATERIAL_DESC")
    private String mainMaterialDesc;

    /** MES物料编码 */
    @Excel(name = "ui.data.column.mpMonthPlanProdFinal.mesMaterialCode")
    @ApiModelProperty(value = "MES物料编码", name = "mesMaterialCode")
    @TableField(value = "MES_MATERIAL_CODE")
    private String mesMaterialCode;

    /** 物料编码 */
    @Excel(name = "ui.data.column.mpMonthPlanProdFinal.materialCode")
    @ApiModelProperty(value = "物料编码", name = "materialCode")
    @TableField(value = "MATERIAL_CODE")
    private String materialCode;

    /** 物料描述 */
    @Excel(name = "ui.data.column.mpMonthPlanProdFinal.materialDesc")
    @ApiModelProperty(value = "物料描述", name = "materialDesc")
    @TableField(value = "MATERIAL_DESC")
    private String materialDesc;

    /** 英寸 */
    @Excel(name = "ui.data.column.mpMonthPlanProdFinal.proSize")
    @ApiModelProperty(value = "英寸", name = "proSize")
    @TableField(value = "PRO_SIZE")
    private String proSize;

    /** 施工阶段 0 无工艺 1 试制 2 量试 3 正式 */
    @Excel(name = "ui.data.column.mpMonthPlanProdFinal.constructionStage")
    @ApiModelProperty(value = "施工阶段 0 无工艺 1 试制 2 量试 3 正式", name = "constructionStage")
    @TableField(value = "CONSTRUCTION_STAGE")
    private String constructionStage;

    /** 品牌 */
    @Excel(name = "ui.data.column.mpMonthPlanProdFinal.brand")
    @ApiModelProperty(value = "品牌", name = "brand")
    @TableField(value = "BRAND")
    private String brand;

    /** 规格 */
    @Excel(name = "ui.data.column.mpMonthPlanProdFinal.specifications")
    @ApiModelProperty(value = "规格", name = "specifications")
    @TableField(value = "SPECIFICATIONS")
    private String specifications;

    /** 主花纹 */
    @Excel(name = "ui.data.column.mpMonthPlanProdFinal.mainPattern")
    @ApiModelProperty(value = "主花纹", name = "mainPattern")
    @TableField(value = "MAIN_PATTERN")
    private String mainPattern;

    /** 花纹 */
    @Excel(name = "ui.data.column.mpMonthPlanProdFinal.pattern")
    @ApiModelProperty(value = "花纹", name = "pattern")
    @TableField(value = "PATTERN")
    private String pattern;

    /** 年周号 */
    @Excel(name = "ui.data.column.mpMonthPlanProdFinal.yearWeek")
    @ApiModelProperty(value = "年周号", name = "yearWeek")
    @TableField(value = "YEAR_WEEK")
    private String yearWeek;

    /** 成型机编码 */
    @Excel(name = "ui.data.column.mpMonthPlanProdFinal.cxMachineCode")
    @ApiModelProperty(value = "成型机编码", name = "cxMachineCode")
    @TableField(value = "CX_MACHINE_CODE")
    private String cxMachineCode;

    /** 型腔数量(同主花纹的模具数量) */
    @Excel(name = "ui.data.column.mpMonthPlanProdFinal.mouldCavityQty")
    @ApiModelProperty(value = "型腔数量(同主花纹的模具数量)", name = "mouldCavityQty")
    @TableField(value = "MOULD_CAVITY_QTY")
    private Integer mouldCavityQty;

    /** 活块数量(同主花纹的物料模具数量) */
    @Excel(name = "ui.data.column.mpMonthPlanProdFinal.typeBlockQty")
    @ApiModelProperty(value = "活块数量(同主花纹的物料模具数量)", name = "typeBlockQty")
    @TableField(value = "TYPE_BLOCK_QTY")
    private Integer typeBlockQty;

    /** 高优先级数量 */
    @Excel(name = "ui.data.column.mpMonthPlanProdFinal.hightQty")
    @ApiModelProperty(value = "高优先级数量", name = "hightQty")
    @TableField(value = "HIGHT_QTY")
    private Integer hightQty;

    /** 月均销量 */
    @Excel(name = "ui.data.column.mpMonthPlanProdFinal.averageQty")
    @ApiModelProperty(value = "月均销量", name = "averageQty")
    @TableField(value = "AVERAGE_QTY")
    private Integer averageQty;

    /** 库销比 */
    @Excel(name = "ui.data.column.mpMonthPlanProdFinal.inventorySalesRatio")
    ...
    /** 日硫化量 */
    @Excel(name = "ui.data.column.mpMonthPlanProdFinal.dayVulcanizationQty")
    ...
    /** 动平衡数量 */
    @Excel(name = "ui.data.column.mpMonthPlanProdFinal.dynamicBalanceQty")
    @ApiModelProperty(value = "动平衡数量", name = "dynamicBalanceQty")
    @TableField(value = "DYNAMIC_BALANCE_QTY")
    private String dynamicBalanceQty;

    /** 均匀性数量 */
    @Excel(name = "ui.data.column.mpMonthPlanProdFinal.uniformityQty")
    ...
    @Excel(name = "ui.data.column.mpMonthPlanProdFinal.isImport", readConverterExp = "0=：默认不是，1：是")
    @ApiModelProperty(value = "是否EXCEL导入", name = "isImport")
    @TableField(value = "IS_IMPORT")
    private String isImport;

    /** 排产顺序 */
    @Excel(name = "ui.data.column.mpMonthPlanProdFinal.productionSequence")
    ...
    /** 单条硫化时间(包含增加间隔)-调整时使用 */
    @Excel(name = "ui.data.column.mpMonthPlanProdFinal.curingTime")
    @ApiModelProperty(value = "单条硫化时间(包含增加间隔)-调整时使用", name = "curingTime")
    @TableField(value = "CURING_TIME")
    private Integer curingTime;

    /** 生产需求计划 */
    @Excel(name = "ui.data.column.mpMonthPlanProdFinal.prodReqPlan")
    @ApiModelProperty(value = "生产需求计划", name = "prodReqPlan")
    @TableField(value = "PROD_REQ_PLAN")
    private Integer prodReqPlan;

    /** 实际生产需求(含损耗) */
    @Excel(name = "ui.data.column.mpMonthPlanProdFinal.factProdReqQty")
    @ApiModelProperty(value = "实际生产需求(含损耗)", name = "factProdReqQty")
    @TableField(value = "FACT_PROD_REQ_QTY")
    private Integer factProdReqQty;

    /** 生产实际排产量 */
    @Excel(name = "ui.data.column.mpMonthPlanProdFinal.totalQty")
    @ApiModelProperty(value = "生产实际排产量", name = "totalQty")
    @TableField(value = "TOTAL_QTY")
    private Integer totalQty;

    /** 高优先级排产数量 */
    @Excel(name = "ui.data.column.mpMonthPlanProdFinal.hightProductionQty")
    @ApiModelProperty(value = "高优先级排产数量", name = "hightProductionQty")
    @TableField(value = "HIGHT_PRODUCTION_QTY")
    private Integer hightProductionQty;

    /** 中优先级排产数量 */
    @Excel(name = "ui.data.column.mpMonthPlanProdFinal.midProductionQty")
    @ApiModelProperty(value = "中优先级排产数量", name = "midProductionQty")
    @TableField(value = "MID_PRODUCTION_QTY")
    private Integer midProductionQty;

    /** 周期排产储备排产数量 */
    @Excel(name = "ui.data.column.mpMonthPlanProdFinal.cycleProductionQty")
    ...
    /** 常规储备排产数量 */
    @Excel(name = "ui.data.column.mpMonthPlanProdFinal.conventionProductionQty")
    ...
    /** 暂缓订单排产数量 */
    @Excel(name = "ui.data.column.mpMonthPlanProdFinal.postponeProductionQty")
    ...
    /** 显示顺序 */
    @Excel(name = "ui.data.column.mpMonthPlanProdFinal.displaySeq")
