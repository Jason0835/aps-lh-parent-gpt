...
public class MdmAreaCapaAllocation extends BaseEntity {
     ...
     */
    @ImportExcelValidated(required = true)
    @Excel(name = "ui.data.column.mdmAreaCapaAllocation.areaCode", type = Excel.Type.IMPORT)
     ...
     * 区域名称国际化
     */
    @Excel(name = "ui.data.column.mdmAreaCapaAllocation.areaCode", type = Excel.Type.EXPORT)
