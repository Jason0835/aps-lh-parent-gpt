 ...
 */
@Data
public class TcDayFinishQty extends BaseEntity implements IFinishQtyImport {
     ...
     */
    @ImportExcelValidated(required = true)
    @Excel(name = "ui.data.column.dayFinishQty.tc.code")
    @ApiModelProperty(value = "胎侧代码", name = "sidewallCode")
