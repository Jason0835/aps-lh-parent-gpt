...
/**
 * 胎侧外协排程结果对象 t_tc_assist_schedule
 * 
 * @author chen
 * @date 2022-02-15
 */
@ApiModel(value = "胎侧外协排程结果对象", description = "胎侧外协排程结果对象 ")
@Data
public class TcAssistSchedule extends ApsBaseEntity{
