...
public class TcGlueMachineReal extends BaseEntity {
    ...
    @Excel(name = "ui.data.column.tc.glueMachineReal.factoryCode", dictType = "biz_factory_name")
    @ImportValidated(required = true, isCode = true, maxLength = 50)
    @ApiModelProperty(value = "工厂编号", name = "factoryCode")
    @TableField(value = "FACTORY_CODE")
    private String factoryCode;

    @Excel(name = "ui.data.column.tc.glueMachineReal.glueCode")
    ...
    @Excel(name = "ui.data.column.tc.glueMachineReal.baseGlueCode")
    ...
    @Excel(name = "ui.data.column.tc.glueMachineReal.machineCode")
    @ImportValidated(required = true, isCode = true, maxLength = 50)
    @ApiModelProperty(value = "机台编码", name = "machineCode")
    @TableField(value = "MACHINE_CODE")
    private String machineCode;

    @Excel(name = "ui.data.column.tc.glueMachineReal.shiftCode", dictType = "class_num_three_plan")
    @ImportValidated(maxLength = 10)
    @ApiModelProperty(value = "机台班次编码", name = "shiftCode")
    @TableField(value = "SHIFT_CODE")
    private String shiftCode;

    @Excel(name = "ui.data.column.tc.glueMachineReal.priority")
    @ImportValidated(digits = true, min = 0, max = 999)
    @ApiModelProperty(value = "优先级", name = "priority")
    @TableField(value = "PRIORITY")
    private Integer priority;

    @Excel(name = "ui.data.column.tc.glueMachineReal.allowFlag", dictType = "biz_yes_no")
    ...
    @Excel(name = "ui.data.column.tc.glueMachineReal.enableStatus", dictType = "biz_yes_no")
    @ImportValidated(required = true, dictType = "biz_yes_no", maxLength = 1)
