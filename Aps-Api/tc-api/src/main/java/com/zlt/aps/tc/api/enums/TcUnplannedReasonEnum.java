 ...
 */
public enum TcUnplannedReasonEnum {
    ...
    /** 胎侧停产且无可分配班次 */
    TC_SHUTDOWN_NO_AVAILABLE_SHIFT("TC_SHUTDOWN_NO_AVAILABLE_SHIFT", "胎侧停产且无可分配班次，成型需求无法重分配"),
    ...
    TcUnplannedReasonEnum(String code, String desc) {
        this.code = code;
        this.desc = desc;
    }
