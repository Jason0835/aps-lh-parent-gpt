...
public class TcParams extends BaseEntity {
    ...
    @Excel(name = "ui.data.column.tc.params.paramGroup", dictType = "biz_param_group")
    @ImportExcelValidated(maxLength = 50, dictType = "biz_param_group")
    @ApiModelProperty(value = "参数分组", name = "paramGroup")
    @TableField(value = "PARAM_GROUP")
    private String paramGroup;

    @Excel(name = "ui.data.column.tc.params.valueType", dictType = "biz_param_value_type")
    @ImportExcelValidated(maxLength = 50, dictType = "biz_param_value_type")
