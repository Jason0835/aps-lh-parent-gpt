...
public class TcSpecifyMachineDto extends ApsBaseDto implements Serializable {
    ...
    @ImportValidated(name = "ui.tc.specifyMachine.column.sidewallCode",required = true,isCode = true,maxLength = 20)
