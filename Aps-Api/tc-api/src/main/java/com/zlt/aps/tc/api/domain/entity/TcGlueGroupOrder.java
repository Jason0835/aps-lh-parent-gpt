...
@ApiModel(value = "胎侧胶料组顺序对象", description = "胎侧胶料组顺序对象")
@Data
@TableName(value = "T_TC_GLUE_GROUP_ORDER")
public class TcGlueGroupOrder extends BaseEntity {

    private static final long serialVersionUID = 1L;

    @Excel(name = "ui.data.column.tc.glueGroupOrder.factoryCode", dictType = "biz_factory_name")
    @ImportValidated(required = true, isCode = true, maxLength = 50)
    @ApiModelProperty(value = "工厂编号", name = "factoryCode")
    @TableField(value = "FACTORY_CODE")
    private String factoryCode;

    @Excel(name = "ui.data.column.tc.glueGroupOrder.glueGroupCode")
    ...
    @Excel(name = "ui.data.column.tc.glueGroupOrder.glueGroupName")
    ...
    @Excel(name = "ui.data.column.tc.glueGroupOrder.orderNum")
