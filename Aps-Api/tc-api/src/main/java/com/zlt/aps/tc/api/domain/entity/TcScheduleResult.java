 ...
 * 胎侧排程结果表 实体类
 */
@ApiModel(value = "胎侧排程结果表对象", description = "胎侧排程结果表对象")
@Data
@TableName(value = "T_TC_SCHEDULE_RESULT")
public class TcScheduleResult extends BaseEntity {

    private static final long serialVersionUID = 1L;

    /** 工厂编号 */
    @Excel(name = "ui.tc.schedule.scheduleResult.factoryCode", dictType = "biz_factory_name")
    @ApiModelProperty(value = "工厂编号", name = "factoryCode")
    @TableField(value = "FACTORY_CODE")
    private String factoryCode;

    /** 批次号 */
    @Excel(name = "ui.tc.schedule.scheduleResult.batchNo")
    @ApiModelProperty(value = "批次号", name = "batchNo")
    @TableField(value = "BATCH_NO")
    private String batchNo;

    /** 工单号 */
    @Excel(name = "ui.tc.schedule.scheduleResult.orderNo")
    @ApiModelProperty(value = "工单号", name = "orderNo")
    @TableField(value = "ORDER_NO")
    private String orderNo;

    /** 排程日期 */
    @Excel(name = "ui.tc.schedule.scheduleResult.scheduleDate")
    ...
    /** 1班预计结束时间 */
    @Excel(name = "ui.tc.schedule.scheduleResult.class1EndTime", width = 30, dateFormat = "yyyy-MM-dd HH:mm:ss")
    ...
    /** 2班预计结束时间 */
    @Excel(name = "ui.tc.schedule.scheduleResult.class2EndTime", width = 30, dateFormat = "yyyy-MM-dd HH:mm:ss")
    ...
    /** 3班预计结束时间 */
    @Excel(name = "ui.tc.schedule.scheduleResult.class3EndTime", width = 30, dateFormat = "yyyy-MM-dd HH:mm:ss")
    ...
    /** 4班预计结束时间 */
    @Excel(name = "ui.tc.schedule.scheduleResult.class4EndTime", width = 30, dateFormat = "yyyy-MM-dd HH:mm:ss")
    ...
    /** 5班预计结束时间 */
    @Excel(name = "ui.tc.schedule.scheduleResult.class5EndTime", width = 30, dateFormat = "yyyy-MM-dd HH:mm:ss")
    ...
    /** 6班预计结束时间 */
    @Excel(name = "ui.tc.schedule.scheduleResult.class6EndTime", width = 30, dateFormat = "yyyy-MM-dd HH:mm:ss")
    ...
    /** 月计划剩余量快照，单位米 */
    @Excel(name = "ui.tc.schedule.result.monthSurplusQty")
    @ApiModelProperty(value = "月计划剩余量", name = "monthSurplusQty")
    @TableField(value = "MONTH_SURPLUS_QTY")
    private BigDecimal monthSurplusQty;

    /** 排程日六点库存快照，单位米 */
    @Excel(name = "ui.tc.schedule.result.stockQty")
    @ApiModelProperty(value = "六点库存", name = "stockQty")
