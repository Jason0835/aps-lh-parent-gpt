...
@ApiModel(value = "胎侧机台生产速度管理对象", description = "胎侧机台生产速度管理对象")
@Data
@TableName(value = "T_TC_MACHINE_SPEED")
public class TcMachineSpeed extends BaseEntity {

    private static final long serialVersionUID = 1L;

    @Excel(name = "ui.data.column.tc.machineSpeed.factoryCode", dictType = "biz_factory_name")
    @ImportValidated(required = true, isCode = true, maxLength = 50)
    @ApiModelProperty(value = "工厂编号", name = "factoryCode")
    @TableField(value = "FACTORY_CODE")
    private String factoryCode;

    @Excel(name = "ui.data.column.tc.machineSpeed.machineCode")
    @ImportValidated(required = true, isCode = true, maxLength = 50)
    @ApiModelProperty(value = "机台编码", name = "machineCode")
    @TableField(value = "MACHINE_CODE")
    private String machineCode;

    @Excel(name = "ui.data.column.tc.machineSpeed.sidewallCode")
    ...
    @Excel(name = "ui.data.column.tc.machineSpeed.productSpeed")
