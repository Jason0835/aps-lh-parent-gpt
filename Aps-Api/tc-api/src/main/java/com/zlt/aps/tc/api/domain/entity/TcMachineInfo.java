...
/**
 * 胎侧机台信息对象 t_tm_machine_info
 *
 * @author zlt
 * @date 2021-05-28
 */
@Data
@ApiModel(value = "胎侧机台信息对象", description = "胎侧机台信息对象 ")
public class TcMachineInfo extends ApsBaseEntity {
    ...
    @ImportValidated(name = "ui.data.column.machine.classShift", maxLength = 10,required = true)
    ...
    @ImportValidated(name = "ui.data.column.machine.openMachineClass", maxLength = 15)
    ...
    /**
     * 支持一次法规格，0--支持，1--不支持。对应数据字典IS_SUPPORTED
     */
    @ApiModelProperty(value = "支持一次法规格，0--支持，1--不支持", position = 110)
    @Excel(name = "ui.data.column.machine.supportsVmiFlag", dictType = "IS_SUPPORTED")
    @ImportValidated(maxLength = 10, required = true)
    private String supportsVmiFlag;
