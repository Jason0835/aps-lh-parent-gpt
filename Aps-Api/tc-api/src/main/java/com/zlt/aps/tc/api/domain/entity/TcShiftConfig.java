...
public class TcShiftConfig extends BaseEntity {
    ...
    @ImportExcelValidated(required = true, digits = true, min = 0, max = 99)
    ...
    @ImportExcelValidated(required = true, maxLength = 8)
    ...
    @ImportExcelValidated(digits = true, min = 0, max = 24)
