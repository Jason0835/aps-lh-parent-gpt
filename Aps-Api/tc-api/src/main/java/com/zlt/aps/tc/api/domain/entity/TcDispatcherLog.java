...
@Data
@TableName("t_tc_dispatcher_log")
@EqualsAndHashCode(callSuper = false)
@KeySequence(value = "SEQ_T_TC_DISPATCHER_LOG",dbType = DbType.ORACLE)
public class TcDispatcherLog extends ApsBaseEntity{

    private static final long serialVersionUID = 1L;

    /** 主键ID，对应自增序列为：SEQ_T_TC_DISPATCHER_LOG */
    ...
    @Excel(name = "ui.data.column.tc.dispatcherlog.operType")
    ...
    /** 胎侧代码 */
    @Excel(name = "ui.data.column.tc.dispatcherlog.materialCode")
    @ApiModelProperty(value = "胎侧代码")
    private String materialCode;

    /** 操作前机台ID,多个逗号分割 */
    @Excel(name = "ui.data.column.tc.dispatcherlog.beforeMachineId")
    @ApiModelProperty(value = "操作前机台ID,多个逗号分割")
    private String beforeMachineId;

    /** 操作前中班计划量 */
    @Excel(name = "ui.data.column.tc.dispatcherlog.beforeDayPlan")
    @ApiModelProperty(value = "操作前中班计划量")
    private Double beforeDayPlan;

    /** 操作前夜班计划量 */
    @Excel(name = "ui.data.column.tc.dispatcherlog.beforeNightPlan")
    @ApiModelProperty(value = "操作前夜班计划量")
    private Double beforeNightPlan;

    /** 操作后机台ID,多个逗号分割 */
    @Excel(name = "ui.data.column.tc.dispatcherlog.afterMachineId")
    @ApiModelProperty(value = "操作后机台ID,多个逗号分割")
    private String afterMachineId;

    /** 操作后中班计划量 */
    @Excel(name = "ui.data.column.tc.dispatcherlog.afterDayPlan")
    @ApiModelProperty(value = "操作后中班计划量")
    private Double afterDayPlan;

    /** 操作后夜班计划量 */
    @Excel(name = "ui.data.column.tc.dispatcherlog.afterNightPlan")
