 ...
 * 90度裁断排程计划每日各班完成量
 * @author Chen
 * @TableName T_CD90_DAY_FINISH_QTY
 */
@Data
public class Cd90DayFinishQty extends BaseEntity implements IFinishQtyImport {
    /**
     * 主键ID
     */
    private Long id;
     ...
     */
    @ImportExcelValidated(required = true)
    @Excel(name = "ui.data.column.dayFinishQty.cd90.code")
    @ApiModelProperty(value = "帘布大卷编号", name = "clothCode")
