...
/**
 * 90度裁断外协排程结果对象 t_cd90_assist_schedule
 *
 * @author zlt
 * @date 2021-07-06
 */
@ApiModel(value = "90度裁断外协排程结果对象", description = "90度裁断外协排程结果对象 ")
@Data
public class Cd90ScheduleAssist extends ApsBaseEntity {
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE)
                ...
                .append("unitConsume", getUnitConsume())
                .append("machineId", getMachineId())
                .append("stockQty", getStockQty())
                .append("supplyTime", getSupplyTime())
                .append("dayPlanQty", getDayPlanQty())
                .append("dayFinishQty", getDayFinishQty())
                .append("dayProduceOrder", getDayProduceOrder())
                .append("dayFinishRate", getDayFinishRate())
                .append("daySysAnalysis", getDaySysAnalysis())
                .append("dayHandAnalysis", getDayHandAnalysis())
                .append("nightPlanQty", getNightPlanQty())
                .append("nightFinishQty", getNightFinishQty())
                .append("nightProduceOrder", getNightProduceOrder())
                .append("nightFinishRate", getNightFinishRate())
                .append("nightSysAnalysis", getNightSysAnalysis())
                .append("nightHandAnalysis", getNightHandAnalysis())
