...
public interface IXwyyBigRollRubberCarRelationService {
    ...
    @PostMapping("/xwyy/bigRollRubberCarRelation/list")
    ...
    */
    ...
    @PostMapping("/xwyy/bigRollRubberCarRelation/add")
    ...
    @PostMapping("/xwyy/bigRollRubberCarRelation/edit")
    ...
    @DeleteMapping("/xwyy/bigRollRubberCarRelation/{ids}")
    ...
    @GetMapping(value = "/xwyy/bigRollRubberCarRelation/{id}")
    ...
    @PostMapping("/xwyy/bigRollRubberCarRelation/checkXwyyBigRollRubberCarRelationUnique")
    ...
    @PostMapping("/xwyy/bigRollRubberCarRelation/getList")
    ...
    @PostMapping("/xwyy/bigRollRubberCarRelation/importData")
    ...
    @PostMapping("/xwyy/bigRollRubberCarRelation/selectByBigRollCode")
