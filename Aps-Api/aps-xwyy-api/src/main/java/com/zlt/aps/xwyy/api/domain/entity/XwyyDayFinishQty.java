 ...
 * 纤维压延排程计划每日各班完成量
 * @author Chen
 * @TableName T_XWYY_DAY_FINISH_QTY
 */
@Data
public class XwyyDayFinishQty extends BaseEntity implements IFinishQtyImport {
    /**
     * 主键ID
     */
    private Long id;
     ...
     */
    @ImportExcelValidated(required = true)
    @Excel(name = "ui.data.column.dayFinishQty.xwyy.code")
    @ApiModelProperty(value = "帘布大卷编号", name = "bigRollCode")
