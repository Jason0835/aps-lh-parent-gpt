...
public class GdyyScheduleResultDto extends ApsBaseDto {
    ...
    @Excel(name = "ui.data.column.gdyy.scheduleResult.bigRollCode")
...
//    @Excel(name = "ui.data.column.scheduleResult.produceLine")
    ...
    @Excel(name = "ui.data.column.gdyy.scheduleResult.class1Plan.meter")
    ...
    @Excel(name = "ui.data.column.gdyy.scheduleResult.class1Plan.noStock.meter")
     ...
     */
    @ImportValidated(number = true, min = 0, max = 99999999,isInteger = true)
    @Excel(name = "ui.data.column.gdyy.scheduleResult.class1Finish.meter")
    ...
    @Excel(name = "ui.data.column.gdyy.scheduleResult.class1Remark")
     ...
     */
    @ImportValidated(number = true, min = 0, max = 99999999,isInteger = true)
    @Excel(name = "ui.data.column.gdyy.scheduleResult.class2Plan.meter")
    ...
    /** 夜班（二班0点-8点）无库存计划量*/
    @ImportValidated(number = true,max = 9999999,min = 0,isInteger = true)
    @Excel(name = "ui.data.column.gdyy.scheduleResult.class2Plan.noStock.meter")
     ...
     */
    @ImportValidated(number = true, min = 0, max = 99999999,isInteger = true)
    @Excel(name = "ui.data.column.gdyy.scheduleResult.class2Finish.meter")
     ...
     */
    @ImportValidated(maxLength = 300)
    @Excel(name = "ui.data.column.gdyy.scheduleResult.class2Remark")
     ...
     */
    @ImportValidated(number = true, min = 0, max = 99999999,isInteger = true)
    @Excel(name = "ui.data.column.gdyy.scheduleResult.class3Plan.noStock.meter")
    @ApiModelProperty(value = "白班计划量")
     ...
     */
    @ImportValidated(number = true, min = 0, max = 99999999,isInteger = true)
    @Excel(name = "ui.data.column.gdyy.scheduleResult.class3Finish.meter")
     ...
     */
    @ImportValidated(maxLength = 300)
    @Excel(name = "ui.data.column.gdyy.scheduleResult.class3Remark")
