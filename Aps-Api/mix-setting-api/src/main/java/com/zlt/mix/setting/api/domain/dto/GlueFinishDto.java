...
/**
 * 胶料完成量信息对象 t_glue_finish 仅作为导出模板
 *
 * @author Gim
 * @date 2022-03-29
 */
...
public class GlueFinishDto extends ZltBaseEntity {
    ...
    @ImportValidated(name = "setting.glueFinish.mixArea", maxLength = 10)
    ...
    @ImportValidated(name = "setting.glueFinish.glue", maxLength = 30)
    ...
    @ImportValidated(name = "setting.glueFinish.machineCode", maxLength = 30)
    ...
    @ImportValidated(name = "setting.glueFinish.nightFinishQty", isInteger = true, min = 0, max = 9999999)
    ...
    @ImportValidated(name = "setting.glueFinish.dayFinishQty", isInteger = true, min = 0, max = 9999999)
