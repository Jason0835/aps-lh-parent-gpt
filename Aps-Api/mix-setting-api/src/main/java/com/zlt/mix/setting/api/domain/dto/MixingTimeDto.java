...
/**
 * 炼胶时间信息对象dto t_mixing_time
 *
 * @author Liam
 * @date 2022-04-11
 */
@ApiModel(value = "炼胶时间信息对象dto", description = "炼胶时间信息对象dto")
@Data
@EqualsAndHashCode(callSuper = true)
public class MixingTimeDto extends ZltBaseEntity {
     ...
     * 机台名称
     */
    @Excel(name = "setting.mixingTime.machineName")
    @ImportValidated(name = "setting.mixingTime.machineName", maxLength = 40)
    @ApiModelProperty(value = "机台名称", position = 45)
