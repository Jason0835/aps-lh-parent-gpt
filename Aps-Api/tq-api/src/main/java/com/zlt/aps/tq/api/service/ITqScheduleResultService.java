...
public interface ITqScheduleResultService {
     ...
     * @return 结果
     */
    @PostMapping("/tq/scheduleResult/importFinishQty")
    @ApiOperation("导入完成量")
    AjaxResult importFinishQty(@RequestBody List<TqDayFinishQty> list, @RequestParam("importLogId") Long importLogId);
