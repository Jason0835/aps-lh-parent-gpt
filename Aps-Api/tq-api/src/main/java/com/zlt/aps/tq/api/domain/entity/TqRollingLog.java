 ...
 * @since 2026-06-18
 */
@ApiModel(value = "胎圈排程滚动更新日志", description = "胎圈排程滚动更新日志主表")
@Data
@EqualsAndHashCode(callSuper = true)
@TableName("T_TQ_ROLLING_LOG")
public class TqRollingLog extends BaseEntity implements Serializable {

    private static final long serialVersionUID = 1L;

    /** 滚动批次号（每次滚动唯一） */
    @Excel(name = "ui.data.column.tqRollingLog.batchNo")
    @ApiModelProperty(value = "滚动批次号", name = "batchNo")
    @TableField(value = "BATCH_NO")
    private String batchNo;

    /** 触发类型：0-自动定时，1-插单，2-转机台，3-调量，4-删除 */
    @Excel(name = "ui.data.column.tqRollingLog.triggerType", dictType = "TQ_ROLLING_TRIGGER_TYPE")
    ...
    @Excel(name = "ui.data.column.tqRollingLog.scheduleDate", width = 30, dateFormat = "yyyy-MM-dd")
    @ApiModelProperty(value = "排程日期", name = "scheduleDate")
    @TableField(value = "SCHEDULE_DATE")
    private Date scheduleDate;

    /** 触发班次索引（1~6） */
    @Excel(name = "ui.data.column.tqRollingLog.shiftIndex")
    @ApiModelProperty(value = "触发班次索引（1~6）", name = "shiftIndex")
    @TableField(value = "SHIFT_INDEX")
    private Integer shiftIndex;

    /** 触发机台编号 */
    @Excel(name = "ui.data.column.tqRollingLog.machineCode")
    @ApiModelProperty(value = "触发机台编号", name = "machineCode")
    @TableField(value = "MACHINE_CODE")
    private String machineCode;

    /** 触发胎圈代码 */
    @Excel(name = "ui.data.column.tqRollingLog.beadCode")
    @ApiModelProperty(value = "触发胎圈代码", name = "beadCode")
    @TableField(value = "BEAD_CODE")
    private String beadCode;

    /** 滚动前预计库存 */
    @Excel(name = "ui.data.column.tqRollingLog.beforeStockQty")
    @ApiModelProperty(value = "滚动前预计库存", name = "beforeStockQty")
    @TableField(value = "BEFORE_STOCK_QTY")
    private BigDecimal beforeStockQty;

    /** 滚动后预计库存 */
    @Excel(name = "ui.data.column.tqRollingLog.afterStockQty")
    ...
    /** 厂别 */
    @Excel(name = "ui.data.column.tqRollingLog.factoryCode")
