 ...
 */
@Data
@ApiModel(value = "胎圈人工插单请求")
public class TqInsertTaskRequestVo implements Serializable {
    ...
    @ApiModelProperty(value = "胎圈编码", required = true)
    private String beadCode;

    @ApiModelProperty(value = "三角胶口型板编码")
