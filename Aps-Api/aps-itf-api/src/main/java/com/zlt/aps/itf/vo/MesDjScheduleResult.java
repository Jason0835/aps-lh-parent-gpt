...
/**
 * MES垫胶排程结果中间表实体
 * 对应表：MES_DJ_SCHEDULE_RESULT
 *
 * @author APS
 */
@Data
@TableName(value = "MES_PAD_SCHEDULE_RESULT")
@ApiModel(value = "MES垫胶排程结果中间表实体", description = "MES垫胶排程结果中间表")
public class MesDjScheduleResult implements Serializable {
    ...
    /** 垫胶批次号 */
    @ApiModelProperty(value = "垫胶批次号", name = "batchNo")
    ...
    /** 垫胶代码 */
    @ApiModelProperty(value = "垫胶代码", name = "treadCode")
    ...
    private BigDecimal nextMidPlanQty;
