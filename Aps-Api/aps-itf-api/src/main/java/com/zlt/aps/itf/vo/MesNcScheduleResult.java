...
/**
 * MES内衬排程结果中间表实体
 * 对应表：MES_LJ_SCHEDULE_RESULT
 *
 * @author APS
 */
@Data
@TableName(value = "MES_NC_SCHEDULE_RESULT")
@ApiModel(value = "MES内衬排程结果中间表实体", description = "MES内衬排程结果中间表")
public class MesNcScheduleResult implements Serializable {
    ...
    /** 内衬批次号 */
    @ApiModelProperty(value = "内衬批次号", name = "batchNo")
    ...
    /** 内衬代码 */
    @ApiModelProperty(value = "内衬代码", name = "treadCode")
