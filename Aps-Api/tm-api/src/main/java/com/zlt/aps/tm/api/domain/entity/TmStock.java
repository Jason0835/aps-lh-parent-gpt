...
public class TmStock extends ApsBaseEntity {
    private static final long serialVersionUID = 1L;

    /**
     * 主键ID，对应自增序列为：SEQ_TM_STOCK
     */
    @ApiModelProperty(value = "主键ID，对应自增序列为：SEQ_TM_STOCK", position = 10)
    private Long id;
    ...
    @ImportValidated(name = "ui.data.column.stock.stockDate", date = true,required = true)
