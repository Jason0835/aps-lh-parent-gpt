 ...
 */
@Data
@ApiModel(value = "胎面发布MES反馈请求", description = "按数据版本回传的幂等发布结果")
public class TmReleaseFeedbackVo implements Serializable {
    ...
    private List<TmReleaseFeedbackItemVo> items = new ArrayList<>();
}
