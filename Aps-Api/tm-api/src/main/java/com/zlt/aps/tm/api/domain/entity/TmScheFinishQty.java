 ...
 * @author APS Team
 */
@ApiModel(value = "APS胎面排程完成量回报接口", description = "APS胎面排程完成量回报接口")
@Data
@EqualsAndHashCode(callSuper = true)
@TableName("T_TM_SCHE_FINISH_QTY")
public class TmScheFinishQty extends BaseEntity implements Serializable {
