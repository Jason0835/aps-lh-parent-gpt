...
public class TmLossSetting extends BaseEntity {
    ...
    @Excel(name = "ui.data.column.tm.lossSetting.factoryCode", dictType = "biz_factory_name")
    ...
    @ImportExcelValidated(isCode = true, maxLength = 50)
    @ApiModelProperty(value = "机台编码", name = "machineCode")
    @TableField(value = "MACHINE_CODE")
    private String machineCode;

    @Excel(name = "ui.data.column.tm.lossSetting.lossRate")
    @ImportExcelValidated(required = true, number = true, min = 0, max = 99.99)
