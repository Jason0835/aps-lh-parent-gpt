...
public class MpRollAdjustContextDTO implements Serializable {
    ...
    @ApiModelProperty(value = "首日不减机台")
    private Boolean bFirstDayNotDecMachines;
    ...
    @ApiModelProperty(value = "需要保存的调整过程日志")
    private List<FactoryMonthPlanFinalAdjustVo> saveAdjustProcLogList;
