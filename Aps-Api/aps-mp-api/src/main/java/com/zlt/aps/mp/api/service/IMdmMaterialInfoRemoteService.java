 ...
 * @date 2021-08-24
 */
@FeignClient(contextId = "IMdmMaterialInfoRemoteService", value = ServiceNameConstants.GATEWAY_SERVICE, path = "${api.path.monthplan:/monthplan}")
public interface IMdmMaterialInfoRemoteService {
    /**
     * 查询物料信息表列表
     *
     * @param productInfo
