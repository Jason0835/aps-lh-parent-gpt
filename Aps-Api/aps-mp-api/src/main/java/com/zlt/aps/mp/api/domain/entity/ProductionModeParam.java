 ...
 * 文件名称：ProductionModeParam.java
 * 描    述：排产模式参数配置项对象 T_MP_PRODUCTION_MODE_PARAM
 *
 * @author ZLT
 * @version 1.0
 * <p>
 ...
 */
@Data
@TableName(value = "T_MP_PRODUCTION_MODE_PARAM")
@ApiModel(value = "工厂月计划-排产模式参数配置项对象", description = "工厂月计划-排产模式参数配置项对象")
public class ProductionModeParam extends BaseEntity {
     ...
     * 排产模式 1 交付优先 2 效率优先
     */
    @ApiModelProperty(value = "排产模式 1 交付优先 2 效率优先", name = "productionMode")
