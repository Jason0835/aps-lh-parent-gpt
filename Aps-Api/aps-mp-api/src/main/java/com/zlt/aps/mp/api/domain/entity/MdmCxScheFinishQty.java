 ...
 * @since 2026/03/26
 */
@ApiModel(value = "APS成型排程完成量回报接口", description = "APS成型排程完成量回报接口")
@Data
@EqualsAndHashCode(callSuper = true)
@TableName("T_MDM_CX_SCHE_FINISH_QTY")
public class MdmCxScheFinishQty extends BaseEntity implements Serializable {
    ...
    @ApiModelProperty(value = "成型胎胚物料编码")
