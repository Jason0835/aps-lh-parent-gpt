...
public interface IXwyyBigRollRemindService {
    ...
    @PostMapping("/bigRollRemind/list")
    ...
    */
    ...
    @PostMapping("/bigRollRemind/edit")
    ...
    @DeleteMapping("/bigRollRemind/{ids}")
    ...
    @GetMapping(value = "/bigRollRemind/{id}")
    ...
    @PostMapping("/bigRollRemind/checkXwyyBigRollRemindUnique")
    ...
    @PostMapping("/bigRollRemind/getList")
    ...
    @PostMapping("/bigRollRemind/importData")
