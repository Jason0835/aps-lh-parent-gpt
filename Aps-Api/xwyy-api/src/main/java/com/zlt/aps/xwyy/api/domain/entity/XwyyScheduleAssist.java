...
/**
 * 纤维压延排程结果对象 t_xwyy_assist_schedule
 *
 * @author zlt
 * @date 2022-02-14
 */
@Data
@ApiModel(value = "纤维压延外协排程结果对象", description = "纤维压延外协排程结果对象 ")
public class XwyyScheduleAssist extends ApsBaseDto {
     ...
     */
    @ImportValidated(number = true, min = 0, max = 9999999,isInteger = true)
    @Excel(name = "ui.data.column.scheduleResult.fac2Class1Plan.meter")
     ...
     */
    @ImportValidated(number = true, min = 0, max = 9999999,isInteger = true)
    @Excel(name = "ui.data.column.scheduleResult.fac2Class2Plan.meter")
     ...
     */
    @ImportValidated(number = true, min = 0, max = 9999999,isInteger = true)
    @Excel(name = "ui.data.column.scheduleResult.fac2Class3Plan.meter")
     ...
     */
    @ImportValidated(number = true, min = 0, max = 9999999,isInteger = true)
    @Excel(name = "ui.data.column.scheduleResult.fac5Class1Plan.meter")
     ...
     */
    @ImportValidated(number = true, min = 0, max = 9999999,isInteger = true)
    @Excel(name = "ui.data.column.scheduleResult.fac5Class2Plan.meter")
     ...
     */
    @ImportValidated(number = true, min = 0, max = 9999999,isInteger = true)
    @Excel(name = "ui.data.column.scheduleResult.fac5Class3Plan.meter")
