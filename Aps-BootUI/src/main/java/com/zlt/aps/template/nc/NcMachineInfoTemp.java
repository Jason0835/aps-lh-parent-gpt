...
public class NcMachineInfoTemp extends ApsBaseEntity {
    ...
    @ImportValidated(name = "ui.data.column.machine.classShift", maxLength = 9)
    ...
    @ImportValidated(name = "ui.data.column.machine.status", maxLength = 6)
