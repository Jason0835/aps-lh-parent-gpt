...
public class TcSpecifyMachineTemp extends ApsBaseEntity implements Serializable {

    private static final long serialVersionUID = 1L;

    @ApiModelProperty(value = "胎侧代码")
    @Excel(name="ui.tc.specifyMachine.column.sidewallCode")
    @ImportValidated(name = "ui.tc.specifyMachine.column.sidewallCode",required = true,isCode = true,maxLength = 30)
