...
public class TcMachineInfoTemp extends ApsBaseEntity {
    ...
    @ImportValidated(name = "ui.data.column.machine.classShift", maxLength = 10)
    ...
    @ImportValidated(name = "ui.data.column.machine.quata", maxLength = 10)
