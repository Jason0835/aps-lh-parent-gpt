...
public class CxQuotaSettingTemp extends ApsBaseDto {
     ...
     * 外胎规格尺寸信息
     */
    @ImportValidated(required = true, min = 0, max = 9999999)
     ...
     * 断面宽(下限)
     */
    @ImportValidated(required = true, min = 0, max = 9999999, digits = true)
     ...
     * 2人定额
     */
    @ImportValidated(min = 0, max = 9999999, digits = true)
