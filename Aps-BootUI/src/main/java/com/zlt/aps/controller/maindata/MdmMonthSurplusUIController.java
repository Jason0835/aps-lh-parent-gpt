...
import com.zlt.aps.mp.api.service.IMdmMonthSurplusRemoteService;
...
public class MdmMonthSurplusUIController extends BaseUIController<MdmMonthSurplus> {
    ...
    @ResponseBody
    public AjaxResult listRequireVersions(MdmMonthSurplus monthSurplus) {
        return iMdmMonthSurplusService.listRequireVersions(monthSurplus);
    }
}
