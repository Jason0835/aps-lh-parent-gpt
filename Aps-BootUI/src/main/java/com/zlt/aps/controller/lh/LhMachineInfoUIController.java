...
public class LhMachineInfoUIController extends BaseUIController<LhMachineInfo> {
    ...
    private final String prefix = "aps/lh/info";

    /**
     * 跳转至主页面
     */
    @RequiresPermissions("lh:info:view")
    @GetMapping()
    ...
    @RequiresPermissions("lh:info:list")
    @PostMapping("/list")
    @ResponseBody
     ...
     */
    @ApiOperation("修改或新增")
    @RequiresPermissions("lh:info:edit")
    @PostMapping("/save")
    @ResponseBody
    ...
    @RequiresPermissions("lh:info:remove")
    @PostMapping("/remove")
    @ResponseBody
