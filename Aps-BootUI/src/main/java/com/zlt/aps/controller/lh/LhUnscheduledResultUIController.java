...
public class LhUnscheduledResultUIController extends BaseUIController<LhUnscheduledResult> {
     ...
     * 跳转至主页面
     */
    @RequiresPermissions("lh:lhUnscheduledResult:view")
    @GetMapping()
    public String toIndex() {
        return prefix + "/lhUnscheduledResult";
    }
    ...
    public String add(ModelMap mmap) {
        mmap.put("lhUnscheduledResult", new LhUnscheduledResult());
        return prefix + "/add";
    }
    ...
    public String edit(@PathVariable("id") Long id, ModelMap mmap) {
        mmap.put("lhUnscheduledResult", iLhUnscheduledResultService.getInfo(id));
        return prefix + "/edit";
    }
    ...
    public AjaxResult importTemplate(HttpServletResponse response) throws IOException {
        ...
        ExcelUtil<LhUnscheduledResult> util = new ExcelUtil<>(LhUnscheduledResult.class);
