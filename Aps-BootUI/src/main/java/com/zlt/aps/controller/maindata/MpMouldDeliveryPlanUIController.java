...
import com.zlt.aps.mp.api.service.IMpMouldDeliveryPlanRemoteService;
...
public class MpMouldDeliveryPlanUIController extends BaseUIController<MpMouldDeliveryPlan> {
    ...
    public AjaxResult importData(@RequestPart("file") MultipartFile file, boolean updateSupport) throws Exception {
        ...
        AjaxResult ajaxResult = iMpMouldDeliveryPlanService.importData(context, updateSupport);
        return ajaxResult;
    }
     ...
     * @return 结果
     */
    @RequiresPermissions("monthplan:mpMouldDeliveryPlan:updateMainPattern")
    ...
    public AjaxResult updateMainPatternToMaterial(MpMouldDeliveryPlan queryVO) {
        return iMpMouldDeliveryPlanService.updateMainPatternToMaterial(queryVO);
    }
}
