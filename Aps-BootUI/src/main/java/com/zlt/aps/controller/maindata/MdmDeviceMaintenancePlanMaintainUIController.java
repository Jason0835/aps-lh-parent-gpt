...
import com.zlt.aps.monthplan.api.service.IMdmDeviceMaintenancePlanRemoteService;
 ...
 */
@Api(tags = "基础数据-设备保养计划")
@Controller
@RequestMapping("/fac/docDeviceMaintenancePlan/maintain")
public class MdmDeviceMaintenancePlanMaintainUIController extends BaseUIController<MdmDeviceMaintenancePlanVo> {
    ...
    @RequiresPermissions("maindata:deviceMaintenancePlan:list")
    @PostMapping("/list")
    @ResponseBody
    public TableDataInfo list(MdmDeviceMaintenancePlanVo entity) {
        entity.setPlanType(MaintenancePlanTypeEnum.MAINTENANCE.getCode());
    ...
    @RequiresPermissions(value = {"maindata:deviceMaintenancePlan:edit", "maindata:deviceMaintenancePlan:add"}, logical = Logical.OR)
    @PostMapping("/edit")
    @ResponseBody
    public AjaxResult editSave(MdmDeviceMaintenancePlan docDeviceMaintenancePlan) {
        ...
        docDeviceMaintenancePlan.setPlanType(MaintenancePlanTypeEnum.MAINTENANCE.getCode());
    ...
    @RequiresPermissions("maindata:deviceMaintenancePlan:remove")
    @PostMapping("/remove")
    @ResponseBody
    ...
    //             vo.setPlanType(MaintenancePlanTypeEnum.MAINTENANCE.getCode());
    //         }
    //     }
    //     return iMdmDeviceMaintenancePlanRemoteService.importData(list, updateSupport, importLogId);
    // }

    @Override
    public String getExportTemplateFileName() {
        return I18nUtil.getMessage("ui.data.column.docDeviceMaintenancePlan.maintainModelName");
    }

    @Override
    public String getExportTemplateFileNameForce() {
        return I18nUtil.getMessage("ui.data.column.docDeviceMaintenancePlan.maintainModelName", Locale.SIMPLIFIED_CHINESE);
    }
    ...
    @RequiresPermissions("maindata:deviceMaintenancePlan:export")
    @ApiOperation("数据导出")
    @GetMapping({"/export"})
    @ResponseBody
    @Override
    ...
    @RequiresPermissions("maindata:deviceMaintenancePlan:import")
    ...
    public AjaxResult importData(@RequestPart("file") MultipartFile file, boolean updateSupport) throws Exception {
        ...
        return iMdmDeviceMaintenancePlanRemoteService.importData(context, true, 1);
    }
}
