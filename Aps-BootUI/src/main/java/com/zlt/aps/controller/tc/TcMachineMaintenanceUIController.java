 ...
 * 文件名称：TcMachineMaintenanceUIController.java
 * 描    述：胎侧机台维修计划 UI控制层类：....
 *
 * @author zlt
 * @version 1.0
...
public class TcMachineMaintenanceUIController extends BaseUIController<TcMachineMaintenance> {
    ...
    private final String prefix = "aps/tc/tcMachineMaintenance";
    @Autowired
    ...
    public String toIndex() {
        return prefix + "/tcMachineMaintenance";
    }
    ...
    @PostMapping("/list")
    @ResponseBody
    public TableDataInfo list(TcMachineMaintenance tcMachineMaintenance) {
        return iTcMachineMaintenanceService.list(tcMachineMaintenance);
    }
    ...
    public AjaxResult save(TcMachineMaintenance tcMachineMaintenance) {
        if (UserConstants.NOT_UNIQUE.equals(iTcMachineMaintenanceService.checkUnique(tcMachineMaintenance))) {
            return AjaxResult.error(I18nUtil.getMessage("ui.data.column.tcMachineMaintenance.checkUnique"));
        }
    ...
    @ResponseBody
    public String checkUnique(TcMachineMaintenance tcMachineMaintenance) {
        return iTcMachineMaintenanceService.checkUnique(tcMachineMaintenance);
    }
    ...
    public String getFunctionName() {
        return I18nUtil.getMessage("ui.data.column.tcMachineMaintenance.modelName");
    }
    ...
    public AjaxResult importData(@RequestPart("file") MultipartFile file, boolean updateSupport) throws Exception {
        ...
        AjaxResult ajaxResult = iTcMachineMaintenanceService.importData(context, false);
        return ajaxResult;
    }
}
