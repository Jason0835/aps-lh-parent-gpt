...
public class Cd90StockUIController extends BaseUIController<Cd90Stock> {
    ...
    public AjaxResult add(@RequestBody Cd90Stock e) { if (UserConstants.NOT_UNIQUE.equals(remote.checkUnique(e))) return AjaxResult.error(I18nUtil.getMessage("ui.data.column.cd90Stock.checkUnique")); return remote.add(e); }
    @ApiOperation("编辑") @RequiresPermissions("cd90:stock:edit") @PostMapping("/edit") @ResponseBody
    public AjaxResult edit(@RequestBody Cd90Stock e) { if (UserConstants.NOT_UNIQUE.equals(remote.checkUnique(e))) return AjaxResult.error(I18nUtil.getMessage("ui.data.column.cd90Stock.checkUnique")); return remote.edit(e); }
    ...
    @Override public String getFunctionName() { return I18nUtil.getMessage("ui.data.column.cd90Stock.modelName"); }
