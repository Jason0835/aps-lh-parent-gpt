...
import com.zlt.aps.nc.api.service.INcMouthPlateRemoteService;
...
@Api(tags = {"内衬口型板信息接口"})
public class NcMouthPlateUIController extends BaseController {

    private final String prefix = "nc/mouthPlate";

    @Autowired
    private INcMouthPlateRemoteService iNcMouthPlateService;
