...
import com.zlt.aps.nc.api.service.INcDispatcherLogRemoteService;
...
public class NcDispatcherLogUIController extends BaseController<NcDispatcherLog> {

    @Autowired
    private INcDispatcherLogRemoteService dispatcherLogService;
    ...
    public void export(HttpServletResponse response, NcDispatcherLog dispatcherLog) throws IOException {
        ...
        String fileName = I18nUtil.getMessage("ui.nc.dispatcherlog.modelName");
