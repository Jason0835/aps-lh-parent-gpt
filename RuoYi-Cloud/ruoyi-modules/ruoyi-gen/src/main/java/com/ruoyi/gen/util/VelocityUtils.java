...
public class VelocityUtils
{
    ...
    /** 国际化配置properties路径 */
    private static final String PROPERTIES_PATH = "main/resources";
    ...
    public static List<String> getTemplateList(String tplCategory)
    {
        ...
        templates.add("vm/java/service1.java.vm");
        templates.add("vm/java/serviceImpl.java.vm");
        templates.add("vm/java/controller.java.vm");
        templates.add("vm/java/controller1.java.vm");
        ...
        templates.add("vm/properties/I18n.properties.vm");
    ...
    public static String getFileName(String template, GenTable genTable)
    {
        ...
        else if (template.contains("service1.java.vm"))
        {
        ...
        }else if (template.contains("controller1.java.vm"))
        {
            fileName = StringUtils.format("{}/controller/{}Controller1.java", javaPath, className);
        }
        ...
        else if (template.contains("I18n.properties.vm"))
        {
            fileName = StringUtils.format("{}/{}_I18n.properties", PROPERTIES_PATH, businessName);
        }
        return fileName;
    }
