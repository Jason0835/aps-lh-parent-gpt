...
public class SysNoticeController extends BaseController
{
    ...
    @Log(title = "system.title.sysnotice", businessType = BusinessType.INSERT)
    @PostMapping
    ...
    @Log(title = "system.title.sysnotice", businessType = BusinessType.UPDATE)
    @PutMapping
    ...
    @Log(title = "system.title.sysnotice", businessType = BusinessType.DELETE)
