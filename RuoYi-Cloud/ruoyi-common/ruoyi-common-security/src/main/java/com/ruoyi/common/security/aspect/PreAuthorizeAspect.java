...
public class PreAuthorizeAspect
{
    ...
    public boolean hasPermi(String permission)
    {
        ...
        return hasPermissions(userInfo.getSystemPermissions(applicationSecurityConfig.CurrentCode()), permission);
    }
    ...
    public boolean hasAnyPermi(String[] permissions)
    {
        ...
        Collection<String> authorities = userInfo.getSystemPermissions(applicationSecurityConfig.CurrentCode());
    ...
    public boolean hasRole(String role)
    {
        ...
        for (String roleKey : userInfo.getSystemRoles(applicationSecurityConfig.CurrentCode())) {
