...
<template>
  <basic-container>
    ...
    >
      <template slot="header">
        ...
        <!-- <el-button
          type="primary"
          plain
          v-hasPermi="['cd90:stock:stockRevise']"
          :disabled="selection.length !== 1"
        ...
        <el-button
          type="danger"
          plain
          v-hasPermi="['cd90:stock:remove']"
          @click="handleBatchDelete"
          >{{ $t("ui.frame.btn.delete") }}</el-button
        >
        <el-button
          v-hasPermi="['cd90:stock:import']"
          @click="$refs.tltUpload.handleImport()"
          >{{ $t("ui.frame.btn.import") }}</el-button
        >
        <el-button @click="handleExport" v-hasPermi="['cd90:stock:export']">{{
    ...
    <tlt-upload
      ref="tltUpload"
      downloadUrl="/cd90/stock/importTemplate"
      uploadUrl="/cd90/stock/importData"
...
//interface
import { listStock, removeStock, releaseStock } from "@/api/cd90/stock";
//components
