...
import { editMachine, checkMachineCodeUnique } from "@/api/cd90/machine";
export default {
  components: { infoForm },
  inject: ["parentDict"],
  data() {
    ...
    columns() {
      return [
        ...
        },
        {
          ...
          prop: "isStickFilm",
          type: "select", // IS_SUPPORTED
          dictData: this.parentDict.type.IS_SUPPORTED
        },
        {
  ...
  methods: {
    ...
    show(data) {
      ...
      if (data) {
        ...
        this.form = {
          ...data,
          clothWithMax: this.numberEmpty(data.clothWithMax),
          clothWithMin: this.numberEmpty(data.clothWithMin),
