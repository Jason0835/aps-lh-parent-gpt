...
<template>
  <basic-container>
    <page-table
      tableRef="fiberPressMachineMainTable"
      :calcHeight="true"
      v-loading="loading"
      :columns="columns"
    ...
    >
      <template slot="header">
        ...
        > -->
        <el-button
          v-hasPermi="['xwyy:machine:import']"
          @click="() => $refs.tltUploadForm.handleImport(importDefaultValue)"
          >{{ $t("ui.frame.btn.import") }}</el-button
        >
        <el-button v-hasPermi="['xwyy:machine:export']" @click="handleExport">{{
    ...
    <tlt-upload-form
      ref="tltUploadForm"
      title="导入机台信息数据"
      downloadUrl="/xwyy/machine/importTemplate"
      uploadUrl="/xwyy/machine/importData"
...
} from "@/api/xwyy/machine";
import InfoDialog from "./components/infoDialog.vue";
import TltUploadForm from "@/views/components/tltUploadForm.vue";

export default {
 name: "FiberPressMachine",
