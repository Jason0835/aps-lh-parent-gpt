...
<template>
  <basic-container>
    <page-table
      tableRef="fiberPressStockMainTable"
      :calcHeight="true"
      v-loading="loading"
      :columns="columns"
    ...
    >
      <template slot="header">
        ...
        <el-button
          type="primary"
          plain
          v-hasPermi="['xwyy:stock:edit']"
          @click="handleEdit(selection[0])"
          >{{ $t("ui.frame.btn.modify") }}</el-button
        >
        <!-- <el-button
          type="warning"
          v-hasPermi="['xwyy:stock:stockRevise']"
        ...
        <el-button
          type="danger"
          plain
          v-hasPermi="['xwyy:stock:remove']"
          @click="handleBatchDelete"
          >{{ $t("ui.frame.btn.delete") }}</el-button
        >
        <el-button
          v-hasPermi="['xwyy:stock:import']"
          @click="$refs.tltUpload.handleImport()"
          >{{ $t("ui.frame.btn.import") }}</el-button
        >
        <el-button @click="handleExport" v-hasPermi="['xwyy:stock:export']">{{
    ...
    <tlt-upload
      ref="tltUpload"
      downloadUrl="/xwyy/stock/importTemplate"
      uploadUrl="/xwyy/stock/importData"
...
export default {
  ...
  data() {
    return {
      searchColumns: [
        ...
        {
          label: this.$t("ui.data.column.loss.xwyy.bigRollCode"),
          prop: "materialCode",
        },
      ],
      loading: false,
  ...
  methods: {
    ...
    handleExport() {
      downloadLink("/xwyy/stock/export", this.formatParams(false));
    },
