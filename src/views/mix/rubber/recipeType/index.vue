  ...
  <basic-container>
    ...
    >
      <template slot="header">
        <el-button v-hasPermi="['setting:type:add']" @click="handleAdd">{{
          $t("ui.frame.btn.add")
        }}</el-button>
        <!-- <el-button
          v-hasPermi="['setting:type:edit']"
    ...
    <tlt-upload-form
      ref="tltUploadForm"
      title="导入信息数据"
      downloadUrl="/setting/type/importTemplate"
      uploadUrl="/setting/type/importData"
...
export default {
  ...
  methods: {
    ...
    handleExport() {
      downloadLink("/setting/type/export", this.formatParams(false))
    },
    handleQuery() {},
    handleHistoryQuery() {},
    ...
    async getList() {
      try {
        this.loading = true;
        const data = await listType(this.formatParams());
