...
<template>
  <basic-container>
    ...
    <tlt-upload-form
      ref="tltUploadForm"
      title="导入信息数据"
      downloadUrl="/setting/fhstock/importTemplate"
      uploadUrl="/setting/fhstock/importData"
...
import {
  ...
  removeReturnedStock,
  exportData,
} from "@/api/setting/fhstock";
import InfoDialog from "./components/infoDialog.vue";
import TltUploadForm from "@/views/components/tltUploadForm.vue";
export default {
  name: "RubberReturnedStock",
  ...
  computed: {
    searchColumns() {
      return [
        {
          label: this.$t("setting.fhstock.stockDate"),
          prop: "stockDate",
          type: "date",
          dateType: "date",
        ...
        {
          label: this.$t("setting.fhstock.mixArea"),
          prop: "mixArea",
          type: "select",
          dictData: this.dict.type.MIX_AREA,
        },
        {
          label: this.$t("setting.fhstock.glue"),
          prop: "glue",
        },
      ];
    },
    columns() {
      return [
        ...
        },
        {
          ...
          align: "center",
          minWidth: 100,
          label: this.$t("setting.fhstock.barCode"),
        },
        {
          prop: "validTime",
          // sortable: "custom",
          ...
          align: "center",
          minWidth: 180,
          label: this.$t("setting.fhstock.validTime"),
        },
        {
          prop: "mixArea",
          // sortable: "custom",
        ...
        },
        {
          ...
          halign: "center",
          align: "right",
          label: this.$t("setting.fhstock.stockNum"),
        },
        {
          prop: "stockWeight",
          // sortable: "custom",
          halign: "center",
          align: "right",
          label: this.$t("setting.fhstock.stockWeightNum"),
        },
        {
          prop: "returnWeight",
          // sortable: "custom",
          halign: "center",
          align: "right",
          label: this.$t("setting.fhstock.returnWeight"),
        },
        {
          prop: "remark",
          // sortable: "custom",
  ...
  methods: {
    ...
    handleDelete(row) {
      this.$confirm(this.$t("common.confirm.delete"), {
        ...
        const ids = row.id;
        removeReturnedStock({ ids }).then((data) => {
    ...
    async getList() {
      try {
        this.loading = true;
        const data = await listReturnedStock(this.formatParams());
