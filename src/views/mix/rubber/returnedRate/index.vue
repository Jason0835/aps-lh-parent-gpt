  ...
  <basic-container>
    ...
    >
      <template slot="header">
        <el-button v-hasPermi="['setting:fhGlueRate:add']" @click="handleAdd">{{
          $t("ui.frame.btn.add")
        }}</el-button>
        <el-button
          v-hasPermi="['setting:fhGlueRate:edit']"
        ...
        > -->
        <el-button
          v-hasPermi="['setting:fhGlueRate:import']"
          @click="() => $refs.tltUploadForm.handleImport(importDefaultValue)"
          >{{ $t("ui.frame.btn.import") }}</el-button
        >
        <el-button
          v-hasPermi="['setting:fhGlueRate:export']"
          @click="handleExport"
...
import {exportData, listReturnedRate, removeReturnedRate} from "@/api/setting/fhGlueRate";
import InfoDialog from "./components/infoDialog.vue";
import TltUploadForm from "@/views/components/tltUploadForm.vue";

export default {
  name: "RubberReturnedRate",
  ...
  methods: {
    ...
    handleDelete(row) {
      this.$confirm(this.$t("common.confirm.delete"), {
        ...
        const ids = row.id;
        removeReturnedRate({ ids }).then((data) => {
    ...
    async getList() {
      try {
        this.loading = true;
        const data = await listReturnedRate(this.formatParams());
