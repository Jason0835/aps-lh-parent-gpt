  ...
  <basic-container>
    ...
    >
      <template slot="header">
        <!-- <el-button v-hasPermi="['setting:lhflGlueStock:add']" @click="handleAdd">{{
          $t("ui.frame.btn.add")
        }}</el-button> -->
        <!-- <el-button
          v-hasPermi="['setting:lhflGlueStock:edit']"
        ...
        > -->
        <el-button
          v-hasPermi="['setting:lhflGlueStock:import']"
          @click="() => $refs.tltUploadForm.handleImport(importDefaultValue)"
          >{{ $t("ui.frame.btn.import") }}</el-button
        >
        <el-button
          v-hasPermi="['setting:lhflGlueStock:export']"
          @click="handleExport"
    ...
    <tlt-upload-form
      ref="tltUploadForm"
      title="导入信息数据"
      downloadUrl="/setting/lhflGlueStock/importTemplate"
      uploadUrl="/setting/lhflGlueStock/importData"
...
import {
  ...
  removeStock,
  exportData,
} from "@/api/setting/lhflGlueStock";
  ...
  data() {
    ...
    return {
      ...
      searchColumns: [
        ...
        {
          label: this.$t("setting.lhflGlueStock.mixArea"),
          prop: "mixArea",
        },
        {
