...
<template>
  <basic-container>
    <page-table
      tableRef="moldingUnScheduleResultMainTable"
      :calcHeight="true"
      v-loading="loading"
      :columns="columns"
...
import { listCxScheduleResult } from "@/api/cx/cxScheduleStopInfo";
  ...
  computed: {
    ...
    columns() {
      const columns = [
        ...
        {
          label: this.$t("ui.data.column.unscheduleResult.bomDataVersion"),
          prop: "bomDataVersion",
        },
        // {
