  ...
  <basic-container>
    ...
    >
      <template slot="header">
        ...
        > -->
        <!-- <el-button
          v-hasPermi="['monthplan:factoryMonthPlanProdResult:import']"
          @click="$refs.tltUpload.handleImport()"
          >{{ $t("ui.frame.btn.import") }}</el-button
        > -->
        <el-button
          @click="handleExport"
          v-hasPermi="['monthplan:factoryMonthPlanProdResult:export']"
    ...
    <tlt-upload
      ref="tltUpload"
      downloadUrl="/factory/monthPlanProdResult/importTemplate"
      uploadUrl="/factory/monthPlanProdResult/importData"
...
import {
  ...
  editMonthPlanProdResult,
  removeMonthPlanProdResult,
  statistics,
...
export default {
  ...
  methods: {
    ...
    handleExport() {
      downloadLink(
        "/factory/monthPlanProdResult/export",
