...
import {editEstimateExceedShort} from "@/api/mdm/estimateExceedShort";
    ...
    title: function () {
      return (
        (this.isEdit
          ...
          : this.$t("common.button.add")) + this.$t("ui.data.column.estimateExceedShort.modelName")
      );
    },
    columns() {
      return [
  ...
  methods: {
    ...
    async save(params) {
      try {
        ...
        const res = await editEstimateExceedShort(params);
