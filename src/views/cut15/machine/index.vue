...
<template>
  <basic-container>
    <page-table
      tableRef="cut15MachineMainTable"
      :calcHeight="true"
      v-loading="loading"
      :columns="columns"
    ...
    <tlt-upload-form
      ref="tltUploadForm"
      title="导入机台信息数据"
      downloadUrl="/cd15/machine/importTemplate"
      uploadUrl="/cd15/machine/importData"
    ...
    columns() {
      return [
        ...
        },
        {
          ...
          // sortable: "custom",
          render: ({ row }) => {
            let value = row.isOutTwo;
            return this.selectDictLabel(this.dict.type.IS_SUPPORTED, value);
          },
        },
        {
