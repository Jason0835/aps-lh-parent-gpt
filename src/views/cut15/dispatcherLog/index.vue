...
<template>
  <basic-container>
    <page-table
      tableRef="cut15DispatcherLogMainTable"
      :calcHeight="true"
      v-loading="loading"
      :columns="columns"
    ...
    >
      <template slot="header">
        <!-- <el-button
          type="primary"
          v-hasPermi="['cd15:dispatcherLog:add']"
          @click="handleAdd"
          >{{ $t("ui.frame.btn.add") }}</el-button
        > -->
        <!-- <el-button
          type="warning"
          v-hasPermi="['cd15:dispatcherLog:edit']"
          @click="handleEdit(selection[0])"
          >{{ $t("ui.frame.btn.modify") }}</el-button
        > -->
        <!-- <el-button
          v-hasPermi="['cd15:dispatcherLog:import']"
          @click="$refs.tltUpload.handleImport()"
          >{{ $t("ui.frame.btn.import") }}</el-button
        > -->
        <el-button
          @click="handleExport"
          v-hasPermi="['cd15:dispatcherLog:export']"
    ...
    <!-- <tlt-upload
      ref="tltUpload"
      downloadUrl="/cd15/dispatcherLog/importTemplate"
      uploadUrl="/cd15/dispatcherLog/importData"
...
//interface
import { listDispatcherLog } from "@/api/cd15/dispatcherLog";
//components
...
export default {
      ...
      let columns = [
        { type: "selection", fixed: "left" },
        {
          ...
          children: [
            ...
            {
              prop: "materialCode",
              label: this.$t("ui.data.column.cd15.dispatcherlog.materialCode"),
              valign: "middle",
              align: "center",
              halign: "center",
             //  sortable: "custom",
  ...
  methods: {
    ...
    handleExport() {
      downloadLink("/cd15/dispatcherLog/export", this.formatParams(false));
    },
