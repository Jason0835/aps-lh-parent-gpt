  ...
  <basic-container>
    ...
    >
      <template slot="header">
        ...
        <!-- <el-button
          type="warning"
          v-hasPermi="['cd15:stock:stockRevise']"
          :disabled="selection.length !== 1"
        ...
        <el-button
          type="danger"
          plain
          v-hasPermi="['cd15:stock:remove']"
          @click="handleBatchDelete"
          >{{ $t("ui.frame.btn.delete") }}</el-button
        >
        <el-button
          v-hasPermi="['cd15:stock:import']"
          @click="$refs.tltUpload.handleImport()"
          >{{ $t("ui.frame.btn.import") }}</el-button
        >
        <el-button @click="handleExport" v-hasPermi="['cd15:stock:export']">{{
    ...
    <tlt-upload
      ref="tltUpload"
      downloadUrl="/cd15/stock/importTemplate"
      uploadUrl="/cd15/stock/importData"
...
//interface
import { listStock, removeStock, releaseStock } from "@/api/cd15/stock";
//components
...
export default {
  ...
  data() {
    return {
      searchColumns: [
        ...
        {
          label: this.$t("ui.common.column.gy.steelStripCode"),
          prop: "materialCode",
        },
      ],
      loading: false,
  ...
  methods: {
    ...
    handleExport() {
      downloadLink("/cd15/stock/export", this.formatParams(false));
    },
