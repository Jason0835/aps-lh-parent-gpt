    ...
    >
      <template slot="header">
        <el-button
          type="primary"
          plain
          v-hasPermi="['monthplan:mpMouldDeliveryPlan:edit']"
          @click="handleAdd"
        ...
        > -->
        <el-button
          v-hasPermi="['monthplan:mpMouldDeliveryPlan:import']"
  ...
  methods: {
    ...
    handleDeleteAll() {
      ...
      this.$confirm(this.$t("common.confirm.delete"), {
        ...
        removeMpMouldShellInfo({ ids }).then((data) => {
    ...
    handleExport() {
      downloadLink("/monthplan/mpMouldDeliveryPlan/export", this.formatParams(false));
    },
    ...
    formatParams(hasPage = true) {
      ...
      if (params.createTime && params.createTime[0]) {
        params.shipmentDateStartTime = params.createTime[0];
        params.shipmentDateEndTime = params.createTime[1];
    ...
    async getList() {
      try {
        ...
        const data = await listMpMouldShellInfo(this.formatParams());
        this.data = data.rows;
