...
<template>
  <basic-container>
    ...
    >
      <template slot="header">
        <el-button
          type="primary"
          plain
          v-hasPermi="['maindata:rawSpecialMaterialRatio:add']"
          @click="handleAdd"
        ...
        >
        <el-button
          v-hasPermi="['maindata:rawSpecialMaterialRatio:import']"
          @click="$refs.tltUpload.handleImport()"
          >{{ $t("ui.frame.btn.import") }}</el-button
        >
        <el-button
          @click="handleExport"
          v-hasPermi="['maindata:rawSpecialMaterialRatio:export']"
    ...
    <tlt-upload
      ref="tltUpload"
      downloadUrl="/maindata/rawSpecialMaterialRatio/importTemplate"
      uploadUrl="/maindata/rawSpecialMaterialRatio/importData"
...
import {
  listSpecialMaterialInfo,
  removeSpecialMaterialInfo,
...
export default {
  ...
  dicts: ["LINE_TYPE", "biu_unit", "biz_factory_name"],
  provide() {
    return {
        ...
        },
        {
          ...
          render: ({ row }) => {
            return (
              <div>
                <el-button
                  v-hasPermi={["maindata:rawSpecialMaterialRatio:edit"]}
                  class="minus"
                  type="success"
  ...
  methods: {
    ...
    handleExport() {
      downloadLink("/maindata/rawSpecialMaterialRatio/export", this.formatParams(false));
    },
