...
<template>
  <basic-container>
    <page-table
      tableRef="steelPressMouthPlateMainTable"
      :calcHeight="true"
      v-loading="loading"
      :columns="columns"
    ...
    >
      <template slot="header">
        <el-button
          type="primary"
          plain
          v-hasPermi="['gdyy:mouthPlate:add']"
          @click="handleAdd"
          >{{ $t("ui.frame.btn.add") }}</el-button
        >
        <!-- <el-button
          type="warning"
          v-hasPermi="['gdyy:mouthPlate:edit']"
          @click="handleEdit(selection[0])"
          >{{ $t("ui.frame.btn.modify") }}</el-button
        > -->
        <el-button
          v-hasPermi="['gdyy:mouthPlate:import']"
          @click="$refs.tltUpload.handleImport()"
          >{{ $t("ui.frame.btn.import") }}</el-button
        >
        <el-button
          @click="handleExport"
          v-hasPermi="['gdyy:mouthPlate:export']"
    ...
    <tlt-upload
      ref="tltUpload"
      downloadUrl="/gdyy/mouthPlate/importTemplate"
      uploadUrl="/gdyy/mouthPlate/importData"
...
export default {
          ...
          render: ({ row }) => {
            return (
              <div>
                ...
                <el-button
                  v-hasPermi={["gdyy:mouthPlate:remove"]}
                  class="minus"
                  type="danger"
  ...
  methods: {
    ...
    handleExport() {
      downloadLink("/gdyy/mouthPlate/export", this.formatParams(false));
    },
