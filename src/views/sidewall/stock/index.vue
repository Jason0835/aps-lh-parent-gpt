...
<template>
  <basic-container>
    <page-table
      tableRef="sidewallStockMainTable"
      :calcHeight="true"
      v-loading="loading"
      :columns="columns"
    ...
    >
      <template slot="header">
        ...
        <!-- <el-button
          type="warning"
          plain
          v-hasPermi="['tc:stock:stockRevise']"
          :disabled="selection.length !== 1"
        ...
        <el-button
          type="danger"
          plain
          v-hasPermi="['tc:stock:remove']"
          @click="handleBatchDelete"
          >{{ $t("ui.frame.btn.delete") }}</el-button
        >
        <el-button
          v-hasPermi="['tc:stock:import']"
          @click="$refs.tltUpload.handleImport()"
          >{{ $t("ui.frame.btn.import") }}</el-button
        >
        <el-button @click="handleExport" v-hasPermi="['tc:stock:export']">{{
    ...
    <tlt-upload
      ref="tltUpload"
      downloadUrl="/tc/stock/importTemplate"
      uploadUrl="/tc/stock/importData"
...
//interface
import { listStock, removeStock, releaseStock } from "@/api/tc/stock";
//components
...
export default {
  ...
  methods: {
    ...
    handleExport() {
      downloadLink("/tc/stock/export", this.formatParams(false));
    },
