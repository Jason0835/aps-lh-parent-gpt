  ...
  computed: {
    columns() {
      let columns = [
        ...
        {
          prop: "companyCode",
          label: this.$t("ui.data.column.docVulcanizingLine.companyCode"),
        },
        {
          prop: "factoryCode",
          label: this.$t("ui.data.column.docVulcanizingLine.factoryCode"),
        },
        {
          prop: "lineCode",
          label: this.$t("ui.data.column.docVulcanizingLine.lineCode"),
        },
        {
          prop: "productrestriction",
          label: this.$t(
            "ui.data.column.docVulcanizingLine.productrestriction"
          ),
        },
        {
          prop: "remark",
          label: this.$t("ui.data.column.docVulcanizingLine.remark"),
          minWidth: 100,
        },
        {
          align: "center",
