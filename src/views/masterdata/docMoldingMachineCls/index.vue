...
<template>
  <basic-container>
    <page-table
      tableRef="DocMoldingMachineClsMainTable"
      :calcHeight="true"
      v-loading="loading"
      :columns="columns"
    ...
    >
      <template slot="header">
        <el-button
          type="warning"
          v-hasPermi="['fac:docMoldingMachineCls:add']"
          @click="handleAdd"
          >{{ $t("ui.frame.btn.add") }}</el-button
        >
        <!-- <el-button
          type="warning"
          v-hasPermi="['fac:docMoldingMachineCls:edit']"
        ...
        <el-button
          type="warning"
          v-hasPermi="['fac:docMoldingMachineCls:import']"
        ...
        <el-button
          type="primary"
          @click="handleExport"
          v-hasPermi="['fac:docMoldingMachineCls:export']"
    ...
    <tlt-upload
      ref="tltUpload"
      downloadUrl="/fac/docMoldingMachineCls/importTemplate"
      uploadUrl="/fac/docMoldingMachineCls/importData"
...
export default {
 name: "DocMoldingMachineCls",
    ...
    columns() {
      let columns = [
        { type: "selection", fixed: "left" },
        {
          ...
          label: this.$t(
            "ui.data.column.docMoldingMachineCls.moldingMachineClassName"
          ),
        },
        {
          prop: "moldingMachineClassCode",
          label: this.$t(
            "ui.data.column.docMoldingMachineCls.moldingMachineClassCode"
          ),
        },
        {
          prop: "moldingMethod",
          ...
          formatter: (row, column, value, index) => {
            return this.selectDictLabel([], row.moldingMethod);
          },
        },
        {
          prop: "ratio",
          label: this.$t("ui.data.column.docMoldingMachineCls.ratio"),
          formatter: (row, column, value, index) => {
            return "1:" + value;
          },
        },
        // {
        //   prop: "companyCode",
        //   label: this.$t("ui.data.column.docMoldingMachineCls.companyCode"),
        // },
        // {
        //   prop: "factoryCode",
        //   label: this.$t("ui.data.column.facMonthPlan.productionFactoryCode"),
        // },

        {
          prop: "remark",
          label: this.$t("ui.data.column.docMoldingMachineCls.remark"),
          minWidth: 100,
        },
        {
          align: "center",
  ...
  methods: {
    ...
    handleExport() {
      downloadLink("/fac/docMoldingMachineCls/export", this.formatParams(false));
    },
